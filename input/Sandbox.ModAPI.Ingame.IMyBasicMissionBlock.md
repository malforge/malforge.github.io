...
|Member|Description|
|---|---|
|[SelectedMissionId](Sandbox.ModAPI.Ingame.IMyBasicMissionBlock@SelectedMissionId)|Gets or sets the selected mission id. Each id of the mission is unique. You can find ids of the missions on the EntityComponents.sbc.|
...
**Type Definitions:**  
* MyObjectBuilder_BasicMissionBlock/LargeBasicMission  
* MyObjectBuilder_BasicMissionBlock/SmallBasicMission
