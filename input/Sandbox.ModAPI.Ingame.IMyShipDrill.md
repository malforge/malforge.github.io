...
|Member|Description|
|---|---|
|[TerrainClearingMode](Sandbox.ModAPI.Ingame.IMyShipDrill@TerrainClearingMode)|Voxel removal mode for drilling via Enabled state (but not for mouse activation)|
...
|[IsActivated](Sandbox.ModAPI.Ingame.IMyShipToolBase@IsActivated)|True if the tool is activated by mouse click or toggling via terminal.<br /><br />_Inherited from [IMyShipToolBase](Sandbox.ModAPI.Ingame.IMyShipToolBase)_|
...
|[UseConveyorSystem](Sandbox.ModAPI.Ingame.IMyShipToolBase@UseConveyorSystem)|Gets or sets if block should push/pull items from conveyor system<br /><br />_Inherited from [IMyShipToolBase](Sandbox.ModAPI.Ingame.IMyShipToolBase)_|
...
* MyObjectBuilder_Drill/LargeBlockDrillReskin  
* MyObjectBuilder_Drill/LargeBlockPrototechDrill  
* MyObjectBuilder_Drill/SmallBlockDrill  
* MyObjectBuilder_Drill/SmallBlockDrillReskin
