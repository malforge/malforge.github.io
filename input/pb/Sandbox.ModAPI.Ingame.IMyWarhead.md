...
|Member|Description|
|---|---|
|[DetonationTime](Sandbox.ModAPI.Ingame.IMyWarhead@DetonationTime)|Gets actual detonation time [s]|
|[IsArmed](Sandbox.ModAPI.Ingame.IMyWarhead@IsArmed)|Gets or sets whether this warhead block is armed|
|[IsCountingDown](Sandbox.ModAPI.Ingame.IMyWarhead@IsCountingDown)|Gets whether this warhead block is counting down|
...
**Type Definitions:**  
* MyObjectBuilder_Warhead/LargeExplosiveBarrel  
* MyObjectBuilder_Warhead/LargeWarhead  
* MyObjectBuilder_Warhead/SmallExplosiveBarrel  
