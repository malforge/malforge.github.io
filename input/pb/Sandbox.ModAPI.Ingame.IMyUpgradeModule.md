...
|Member|Description|
|---|---|
|[FillUpgradeList(List<MyUpgradeModuleInfo>)](Sandbox.ModAPI.Ingame.IMyUpgradeModule@FillUpgradeList)|Gets list of upgrades from this block, see `MyUpgradeModuleInfo`<sub>prohibited</sub> for details|
