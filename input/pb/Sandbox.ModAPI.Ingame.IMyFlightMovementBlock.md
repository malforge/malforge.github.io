...
|Member|Description|
|---|---|
|[AlignToPGravity](Sandbox.ModAPI.Ingame.IMyFlightMovementBlock@AlignToPGravity)|Gets/sets bool if align to P gravity mode is on.|
|[CollisionAvoidance](Sandbox.ModAPI.Ingame.IMyFlightMovementBlock@CollisionAvoidance)|Gets/sets bool representing if collision avoidance is on.|
|[CurrentWaypoint](Sandbox.ModAPI.Ingame.IMyFlightMovementBlock@CurrentWaypoint)|Gets current waypoint|
|[FlightMode](Sandbox.ModAPI.Ingame.IMyFlightMovementBlock@FlightMode)|Gets/sets type of active flight mode|
|[IsAutoPilotEnabled](Sandbox.ModAPI.Ingame.IMyFlightMovementBlock@IsAutoPilotEnabled)|Determines whether the autopilot is currently enabled.|
|[LookAtPosition](Sandbox.ModAPI.Ingame.IMyFlightMovementBlock@LookAtPosition)|Gets/sets position where flight movement should look at|
|[MinimalAltitude](Sandbox.ModAPI.Ingame.IMyFlightMovementBlock@MinimalAltitude)|Gets/sets minimal altitude above the planet surface|
|[PrecisionMode](Sandbox.ModAPI.Ingame.IMyFlightMovementBlock@PrecisionMode)|Gets/sets bool if precision mode is on.|
|[SpeedLimit](Sandbox.ModAPI.Ingame.IMyFlightMovementBlock@SpeedLimit)|Gets/sets speed limit.|
...
|Member|Description|
|---|---|
|[GetWaypoints(List<IMyAutopilotWaypoint>)](Sandbox.ModAPI.Ingame.IMyFlightMovementBlock@GetWaypoints)|Gets current waypoints|
...
**Type Definitions:**  
* MyObjectBuilder_FlightMovementBlock/LargeFlightMovement  
* MyObjectBuilder_FlightMovementBlock/SmallFlightMovement
