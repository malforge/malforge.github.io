...
|[LastDetectedEntity](Sandbox.ModAPI.Ingame.IMySensorBlock@LastDetectedEntity)|Gets the last detected entity|
...
|Member|Description|
|---|---|
|[DetectedEntities(List<MyDetectedEntityInfo>)](Sandbox.ModAPI.Ingame.IMySensorBlock@DetectedEntities)|Gets the list of detected entities|
...
* MyObjectBuilder_SensorBlock/LargeBlockSensorReskin  
* MyObjectBuilder_SensorBlock/SmallBlockSensor  
* MyObjectBuilder_SensorBlock/SmallBlockSensorReskin
