...
|[NormalizedPosition](Sandbox.ModAPI.Ingame.IMyPistonBase@NormalizedPosition)|Gets the current position normalized between MinLimit and MaxLimit|
...
|[MoveToPosition(float, float)](Sandbox.ModAPI.Ingame.IMyPistonBase@MoveToPosition)|Sets velocity and limits to move the piston to the specified extent value|
