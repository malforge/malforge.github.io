...
|Member|Description|
|---|---|
|[CustomFleeCoordinates](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@CustomFleeCoordinates)|Gets or sets world position where it should flee. Has higher priority than [FleeBeaconEntityId](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@FleeBeaconEntityId) , [FleeGps](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@FleeGps) |
|[FleeBeaconEntityId](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@FleeBeaconEntityId)|Gets selected beacon entityId, used for flee coordinates|
|[FleeCoordinates](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@FleeCoordinates)|Gets flee coordinates|
|[FleeGps](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@FleeGps)|Gets gps, used for flee coordinates|
|[FleeTrigger](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@FleeTrigger)|On what event block should flee|
|[IsFleeing](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@IsFleeing)|Gets if block currently fleeing|
|[LockTarget](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@LockTarget)|Gets or sets if block can target lock enemies|
|[SearchEnemyComponent](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@SearchEnemyComponent)|Gets search enemy component|
|[WaypointZoneSize](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@WaypointZoneSize)|Gets or sets waypoint zone size (meters)|
...
|Member|Description|
|---|---|
|[Flee()](Sandbox.ModAPI.Ingame.IMyDefensiveCombatBlock@Flee)|Starts flee mechanic|
...
**Type Definitions:**  
* MyObjectBuilder_DefensiveCombatBlock/LargeDefensiveCombat  
* MyObjectBuilder_DefensiveCombatBlock/SmallDefensiveCombat
