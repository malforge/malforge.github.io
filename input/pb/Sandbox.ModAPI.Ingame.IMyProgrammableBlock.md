...
|Member|Description|
|---|---|
|[IsRunning](Sandbox.ModAPI.Ingame.IMyProgrammableBlock@IsRunning)|Get whether this programmable block is currently running its program.|
|[TerminalRunArgument](Sandbox.ModAPI.Ingame.IMyProgrammableBlock@TerminalRunArgument)|Get default terminal argument.|
