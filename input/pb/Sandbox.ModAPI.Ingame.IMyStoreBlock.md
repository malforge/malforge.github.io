...
|Member|Description|
|---|---|
|[Searchable](Sandbox.ModAPI.Ingame.IMyStoreBlock@Searchable)|When false, this store's listings are hidden from Item Search (Market Watch) results.|
...
|[GetPlayerStoreItems(List<MyStoreQueryItem>)](Sandbox.ModAPI.Ingame.IMyStoreBlock@GetPlayerStoreItems)|Returns player store items.|
