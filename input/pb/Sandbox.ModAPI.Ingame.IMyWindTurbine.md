...
|Member|Description|
|---|---|
|[Effectivity](Sandbox.ModAPI.Ingame.IMyWindTurbine@Effectivity)|Gets current total efficiency of wind turbine. Range of values: [0 - 1] (could be more than 1 during storms)|
|[PlacementEffectivity](Sandbox.ModAPI.Ingame.IMyWindTurbine@PlacementEffectivity)|Gets current efficiency of wind turbine based on nearby blocks. Range of values: [0 - 1]|
|[WindEffectivity](Sandbox.ModAPI.Ingame.IMyWindTurbine@WindEffectivity)|Gets wind efficiency multiplier. Range of values: 0 - is 0%, 1 - is 100%, could be more 100%|
...
* MyObjectBuilder_WindTurbine/LargeBlockWindTurbineReskin
