...
|[AutoDeploy](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute@AutoDeploy)|Gets or sets if the parachute should automatically deploy.|
|[AutoDeployHeight](SpaceEngineers.Game.ModAPI.Ingame.IMyParachute@AutoDeployHeight)|Gets or sets the altitude (in meters) that the parachute should auto deploy.|
