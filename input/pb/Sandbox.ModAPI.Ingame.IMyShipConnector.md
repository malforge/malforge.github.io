...
|[IsConnected](Sandbox.ModAPI.Ingame.IMyShipConnector@IsConnected)|Gets whether the connector is connected. For more precise state use Status.|
|[IsParkingEnabled](Sandbox.ModAPI.Ingame.IMyShipConnector@IsParkingEnabled)|Is this block triggered by the parking signal?|
|[OtherConnector](Sandbox.ModAPI.Ingame.IMyShipConnector@OtherConnector)|Gets the connector this one is connected to when [Status](Sandbox.ModAPI.Ingame.IMyShipConnector@Status) is [Connected](Sandbox.ModAPI.Ingame.MyShipConnectorStatus@Connected) .|
...
|[IsLocked](Sandbox.ModAPI.Ingame.IMyShipConnector@IsLocked)|_**Obsolete:** Use the Status property_<br /><br />Obsolete|
