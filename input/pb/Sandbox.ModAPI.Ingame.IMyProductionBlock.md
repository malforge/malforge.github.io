...
|[IsProducing](Sandbox.ModAPI.Ingame.IMyProductionBlock@IsProducing)|Gets whether block is currently producing.|
|[IsQueueEmpty](Sandbox.ModAPI.Ingame.IMyProductionBlock@IsQueueEmpty)|Gets whether production queue is empty.|
...
|[GetQueue(List<MyProductionItem>)](Sandbox.ModAPI.Ingame.IMyProductionBlock@GetQueue)|Gets the current production queue|
