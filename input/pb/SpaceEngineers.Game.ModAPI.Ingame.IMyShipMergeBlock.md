...
|Member|Description|
|---|---|
|[IsConnected](SpaceEngineers.Game.ModAPI.Ingame.IMyShipMergeBlock@IsConnected)|Gets if the merge block is locked to another one.|
|[State](SpaceEngineers.Game.ModAPI.Ingame.IMyShipMergeBlock@State)|State of the merge block|
