...
|Member|Description|
|---|---|
|[RotateToAngle(MyRotationDirection, float, float)](Sandbox.ModAPI.Ingame.IMyMotorStator@RotateToAngle)|Sets velocity and limits to rotate the rotor to the specified angle value|
