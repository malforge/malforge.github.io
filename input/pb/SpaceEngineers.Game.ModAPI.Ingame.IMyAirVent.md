...
|Member|Description|
|---|---|
|[CanPressurize](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent@CanPressurize)|Gets whether this vent can pressurize. If so room is airtight.|
|[Depressurize](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent@Depressurize)|Gets whether this vent is in depressurize state|
|[PressurizationEnabled](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent@PressurizationEnabled)|Gets whether this vent has pressurization enabled.|
|[Status](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent@Status)|Gets the current air vent status|
...
|[IsDepressurizing](SpaceEngineers.Game.ModAPI.Ingame.IMyAirVent@IsDepressurizing)|_**Obsolete:** IsDepressurizing is deprecated, please use Depressurize instead._<br /><br />Gets whether this vet is depressurizing|
...
* MyObjectBuilder_AirVent/AirVentFan  
* MyObjectBuilder_AirVent/AirVentFanFull  
* MyObjectBuilder_AirVent/AirVentFull  
* MyObjectBuilder_AirVent/SmallAirVent  
* MyObjectBuilder_AirVent/SmallAirVentFan  
* MyObjectBuilder_AirVent/SmallAirVentFanFull  
* MyObjectBuilder_AirVent/SmallAirVentFull
