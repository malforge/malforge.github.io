...
|Member|Description|
|---|---|
|[CurrentStoredPower](Sandbox.ModAPI.Ingame.IMyJumpDrive@CurrentStoredPower)|Gets block stored power|
|[JumpDistanceMeters](Sandbox.ModAPI.Ingame.IMyJumpDrive@JumpDistanceMeters)|Gets or sets jump drive distance in meters.|
|[JumpDistanceRatio](Sandbox.ModAPI.Ingame.IMyJumpDrive@JumpDistanceRatio)|Gets or sets jump drive distance ratio, value from 0 to 1.|
|[MaxJumpDistanceMeters](Sandbox.ModAPI.Ingame.IMyJumpDrive@MaxJumpDistanceMeters)|Gets maximum jump drive distance.|
|[MaxStoredPower](Sandbox.ModAPI.Ingame.IMyJumpDrive@MaxStoredPower)|Gets block max stored power|
|[MinJumpDistanceMeters](Sandbox.ModAPI.Ingame.IMyJumpDrive@MinJumpDistanceMeters)|Gets minimum jump drive distance.|
|[Recharge](Sandbox.ModAPI.Ingame.IMyJumpDrive@Recharge)|Turns on/off recharging|
|[Status](Sandbox.ModAPI.Ingame.IMyJumpDrive@Status)|Gets block status|
...
* MyObjectBuilder_JumpDrive/LargeJumpDriveReskin  
* MyObjectBuilder_JumpDrive/LargePrototechJumpDrive  
* MyObjectBuilder_JumpDrive/SmallPrototechJumpDrive
