...
|[Content](VRage.Game.ModAPI.Ingame.IMyInventoryItem@Content)|Gets or sets content of inventory item. Cast it to `MyObjectBuilder_PhysicalObject`<sub>prohibited</sub> |
