...
|Member|Description|
|---|---|
|[GyroOverride](Sandbox.ModAPI.Ingame.IMyGyro@GyroOverride)|Gets or set whether this gyro has enabled override|
|[GyroPower](Sandbox.ModAPI.Ingame.IMyGyro@GyroPower)|Get or set gyroscope power in|
|[Pitch](Sandbox.ModAPI.Ingame.IMyGyro@Pitch)|Gets or set the pitch angle|
|[Roll](Sandbox.ModAPI.Ingame.IMyGyro@Roll)|Gets or set the roll angle|
|[Yaw](Sandbox.ModAPI.Ingame.IMyGyro@Yaw)|Gets or sets the yaw angle|
...
* MyObjectBuilder_Gyro/LargeBlockPrototechGyro  
* MyObjectBuilder_Gyro/SmallBlockGyro  
* MyObjectBuilder_Gyro/SmallBlockPrototechGyro
