...
|Member|Description|
|---|---|
|[AllowSignalsFrom](SpaceEngineers.Game.ModAPI.Ingame.IMyTransponder@AllowSignalsFrom)|Gets or sets [MyTransponderRelationFilter](VRage.Game.ModAPI.Ingame.MyTransponderRelationFilter) which defines allowed relation between signal sender and signal receiver.|
|[Channel](SpaceEngineers.Game.ModAPI.Ingame.IMyTransponder@Channel)|Gets or sets channel number to be used for further signals. Setter does nothing if there is no IMySignalChannelProvider component accessible. Getter returns zero if there is no IMySignalChannelProvider component accessible.|
...
|Member|Description|
|---|---|
|[SendSignal(int?)](SpaceEngineers.Game.ModAPI.Ingame.IMyTransponder@SendSignal)|Sends a signal to the channel. If no channel number is provided, uses channel number from IMySignalChannelProvider component of the same container.|
...
**Type Definitions:**  
* MyObjectBuilder_TransponderBlock/LargeBlockTransponder  
* MyObjectBuilder_TransponderBlock/SmallBlockTransponder
