...
|Member|Description|
|---|---|
|[ChargeMode](Sandbox.ModAPI.Ingame.IMyBatteryBlock@ChargeMode)|Gets or sets charge mode|
|[CurrentInput](Sandbox.ModAPI.Ingame.IMyBatteryBlock@CurrentInput)|Gets current power input|
|[CurrentStoredPower](Sandbox.ModAPI.Ingame.IMyBatteryBlock@CurrentStoredPower)|Gets current stored power|
|[HasCapacityRemaining](Sandbox.ModAPI.Ingame.IMyBatteryBlock@HasCapacityRemaining)|Gets whether this battery block has any remaining capacity|
|[IsCharging](Sandbox.ModAPI.Ingame.IMyBatteryBlock@IsCharging)|Gets whether this battery block is charging|
|[MaxInput](Sandbox.ModAPI.Ingame.IMyBatteryBlock@MaxInput)|Gets current maximum power input|
|[MaxStoredPower](Sandbox.ModAPI.Ingame.IMyBatteryBlock@MaxStoredPower)|Gets maximum stored power|
...
|[OnlyDischarge](Sandbox.ModAPI.Ingame.IMyBatteryBlock@OnlyDischarge)|_**Obsolete:** Use ChargeMode instead_<br /><br />Obsolete|
|[OnlyRecharge](Sandbox.ModAPI.Ingame.IMyBatteryBlock@OnlyRecharge)|_**Obsolete:** Use ChargeMode instead_<br /><br />Obsolete|
|[SemiautoEnabled](Sandbox.ModAPI.Ingame.IMyBatteryBlock@SemiautoEnabled)|_**Obsolete:** Semi-auto is no longer a valid mode, if you want to check for Auto instead, use ChargeMode_<br /><br />Obsolete|
