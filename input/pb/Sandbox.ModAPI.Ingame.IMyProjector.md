...
|Member|Description|
|---|---|
|[BuildableBlocksCount](Sandbox.ModAPI.Ingame.IMyProjector@BuildableBlocksCount)|Get count of blocks which can be welded now|
|[IsProjecting](Sandbox.ModAPI.Ingame.IMyProjector@IsProjecting)|Checks if there is an active projection|
|[ProjectionOffset](Sandbox.ModAPI.Ingame.IMyProjector@ProjectionOffset)|Gets or sets projection offset|
|[ProjectionRotation](Sandbox.ModAPI.Ingame.IMyProjector@ProjectionRotation)|Get or sets projection rotation. These values are not in degrees. 1 = 90 degrees, 2 = 180 degrees|
|[RemainingArmorBlocks](Sandbox.ModAPI.Ingame.IMyProjector@RemainingArmorBlocks)|Get number of armor blocks left to be welded|
|[RemainingBlocks](Sandbox.ModAPI.Ingame.IMyProjector@RemainingBlocks)|Gets number of blocks left to be welded|
|[RemainingBlocksPerType](Sandbox.ModAPI.Ingame.IMyProjector@RemainingBlocksPerType)|Gets comprehensive list of blocks left to be welded|
|[ShowOnlyBuildable](Sandbox.ModAPI.Ingame.IMyProjector@ShowOnlyBuildable)|Gets or set should projection show only buildable blocks|
|[TotalBlocks](Sandbox.ModAPI.Ingame.IMyProjector@TotalBlocks)|Gets total number of blocks in the projection|
...
|[ProjectionOffsetX](Sandbox.ModAPI.Ingame.IMyProjector@ProjectionOffsetX)|_**Obsolete:** Use ProjectionOffset vector instead._<br /><br />Obsolete|
|[ProjectionOffsetY](Sandbox.ModAPI.Ingame.IMyProjector@ProjectionOffsetY)|_**Obsolete:** Use ProjectionOffset vector instead._<br /><br />Obsolete|
|[ProjectionOffsetZ](Sandbox.ModAPI.Ingame.IMyProjector@ProjectionOffsetZ)|_**Obsolete:** Use ProjectionOffset vector instead._<br /><br />Obsolete|
|[ProjectionRotX](Sandbox.ModAPI.Ingame.IMyProjector@ProjectionRotX)|_**Obsolete:** Use ProjectionRotation vector instead._<br /><br />Obsolete|
|[ProjectionRotY](Sandbox.ModAPI.Ingame.IMyProjector@ProjectionRotY)|_**Obsolete:** Use ProjectionRotation vector instead._<br /><br />Obsolete|
|[ProjectionRotZ](Sandbox.ModAPI.Ingame.IMyProjector@ProjectionRotZ)|_**Obsolete:** Use ProjectionRotation vector instead._<br /><br />Obsolete|
