...
|[GetWaypointInfo(List<MyWaypointInfo>)](Sandbox.ModAPI.Ingame.IMyRemoteControl@GetWaypointInfo)|Gets basic information about the currently configured waypoints.|
