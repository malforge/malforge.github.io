...
|Member|Description|
|---|---|
|[ContourHighlightColor](Sandbox.Definitions.MyEnvironmentDefinition@ContourHighlightColor)||
|[ContourHighlightColorAccessDenied](Sandbox.Definitions.MyEnvironmentDefinition@ContourHighlightColorAccessDenied)||
|[ContourHighlightThickness](Sandbox.Definitions.MyEnvironmentDefinition@ContourHighlightThickness)||
|[EnvironmentalParticles](Sandbox.Definitions.MyEnvironmentDefinition@EnvironmentalParticles)||
|[EnvironmentOrientation](Sandbox.Definitions.MyEnvironmentDefinition@EnvironmentOrientation)||
|[EnvironmentTexture](Sandbox.Definitions.MyEnvironmentDefinition@EnvironmentTexture)||
|[FloatingObjectLinearDampening](Sandbox.Definitions.MyEnvironmentDefinition@FloatingObjectLinearDampening)||
|[FloatingObjectLinearDampeningInSafezone](Sandbox.Definitions.MyEnvironmentDefinition@FloatingObjectLinearDampeningInSafezone)||
|[FogProperties](Sandbox.Definitions.MyEnvironmentDefinition@FogProperties)||
|[HBAOSettings](Sandbox.Definitions.MyEnvironmentDefinition@HBAOSettings)||
|[HighlightPulseInSeconds](Sandbox.Definitions.MyEnvironmentDefinition@HighlightPulseInSeconds)||
|[LargeShipMaxSpeed](Sandbox.Definitions.MyEnvironmentDefinition@LargeShipMaxSpeed)||
|[PlanetProperties](Sandbox.Definitions.MyEnvironmentDefinition@PlanetProperties)||
|[PostProcessSettings](Sandbox.Definitions.MyEnvironmentDefinition@PostProcessSettings)||
|[SmallShipMaxSpeed](Sandbox.Definitions.MyEnvironmentDefinition@SmallShipMaxSpeed)||
|[SSAOSettings](Sandbox.Definitions.MyEnvironmentDefinition@SSAOSettings)||
|[SunProperties](Sandbox.Definitions.MyEnvironmentDefinition@SunProperties)||
...
|Member|Description|
|---|---|
|[ExtremeLoddingSettings](Sandbox.Definitions.MyEnvironmentDefinition@ExtremeLoddingSettings)||
|[HighLoddingSettings](Sandbox.Definitions.MyEnvironmentDefinition@HighLoddingSettings)||
|[LargeShipMaxAngularSpeed](Sandbox.Definitions.MyEnvironmentDefinition@LargeShipMaxAngularSpeed)||
|[LargeShipMaxAngularSpeedInRadians](Sandbox.Definitions.MyEnvironmentDefinition@LargeShipMaxAngularSpeedInRadians)||
|[LowLoddingSettings](Sandbox.Definitions.MyEnvironmentDefinition@LowLoddingSettings)||
|[MediumLoddingSettings](Sandbox.Definitions.MyEnvironmentDefinition@MediumLoddingSettings)||
|[ShadowSettings](Sandbox.Definitions.MyEnvironmentDefinition@ShadowSettings)||
|[SmallShipMaxAngularSpeed](Sandbox.Definitions.MyEnvironmentDefinition@SmallShipMaxAngularSpeed)||
|[SmallShipMaxAngularSpeedInRadians](Sandbox.Definitions.MyEnvironmentDefinition@SmallShipMaxAngularSpeedInRadians)||
...
|Member|Description|
|---|---|
|[MyEnvironmentDefinition()](Sandbox.Definitions.MyEnvironmentDefinition@.ctor)||
...
|Member|Description|
|---|---|
|[GetObjectBuilder()](Sandbox.Definitions.MyEnvironmentDefinition@GetObjectBuilder)||
|[Merge(MyEnvironmentDefinition)](Sandbox.Definitions.MyEnvironmentDefinition@Merge)||
