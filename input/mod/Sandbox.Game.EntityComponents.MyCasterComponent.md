...
```csharp
public class MyCasterComponent: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[Caster](Sandbox.Game.EntityComponents.MyCasterComponent@Caster)||
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyCasterComponent@ComponentTypeDebugString)||
|[DistanceToHitSq](Sandbox.Game.EntityComponents.MyCasterComponent@DistanceToHitSq)||
|[EnvironmentItem](Sandbox.Game.EntityComponents.MyCasterComponent@EnvironmentItem)||
|[HitBlock](Sandbox.Game.EntityComponents.MyCasterComponent@HitBlock)|Gets block that is hit by a raycaster.|
|[HitCharacter](Sandbox.Game.EntityComponents.MyCasterComponent@HitCharacter)||
|[HitCubeGrid](Sandbox.Game.EntityComponents.MyCasterComponent@HitCubeGrid)||
|[HitDestroyableObj](Sandbox.Game.EntityComponents.MyCasterComponent@HitDestroyableObj)||
|[HitEnvironmentSector](Sandbox.Game.EntityComponents.MyCasterComponent@HitEnvironmentSector)||
|[HitFloatingObject](Sandbox.Game.EntityComponents.MyCasterComponent@HitFloatingObject)||
|[HitPosition](Sandbox.Game.EntityComponents.MyCasterComponent@HitPosition)||
|[PointOfReference](Sandbox.Game.EntityComponents.MyCasterComponent@PointOfReference)||
...
|Member|Description|
|---|---|
|[MyCasterComponent(MyDrillSensorBase)](Sandbox.Game.EntityComponents.MyCasterComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[GetCastLength()](Sandbox.Game.EntityComponents.MyCasterComponent@GetCastLength)||
|[Init(MyComponentDefinitionBase)](Sandbox.Game.EntityComponents.MyCasterComponent@Init)||
|[OnAddedToContainer()](Sandbox.Game.EntityComponents.MyCasterComponent@OnAddedToContainer)||
|[OnBeforeRemovedFromContainer()](Sandbox.Game.EntityComponents.MyCasterComponent@OnBeforeRemovedFromContainer)||
|[OnWorldPosChanged(ref MatrixD)](Sandbox.Game.EntityComponents.MyCasterComponent@OnWorldPosChanged)||
|[SetPointOfReference(Vector3D)](Sandbox.Game.EntityComponents.MyCasterComponent@SetPointOfReference)||
