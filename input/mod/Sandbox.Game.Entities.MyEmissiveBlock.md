...
```csharp
public class MyEmissiveBlock: MyCubeBlock, IMyEntity, IMyEntity, IMyComponentOwner<MyIDModule>, IMyCubeBlock, IMyCubeBlock, IMyUpgradableBlock, IMyUpgradableBlock
```
...
|Member|Description|
|---|---|
|[OnModelChanged](Sandbox.Game.Entities.MyEmissiveBlock@OnModelChanged)||
...
|Member|Description|
|---|---|
|[MyEmissiveBlock()](Sandbox.Game.Entities.MyEmissiveBlock@.ctor)||
...
|[OnModelChange()](Sandbox.Game.Entities.MyEmissiveBlock@OnModelChange)||
|[SetEmissivity(float)](Sandbox.Game.Entities.MyEmissiveBlock@SetEmissivity)||
