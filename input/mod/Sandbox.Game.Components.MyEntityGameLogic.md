...
```csharp
public class MyEntityGameLogic: MyGameLogicComponent, IMyComponentBase, IMyEntityComponentBase, IMyGameLogicComponent
```
...
|[OnClose](Sandbox.Game.Components.MyEntityGameLogic@OnClose)||
|[OnClosing](Sandbox.Game.Components.MyEntityGameLogic@OnClosing)||
|[OnMarkForClose](Sandbox.Game.Components.MyEntityGameLogic@OnMarkForClose)|This event may not be invoked at all, when calling MyEntities.CloseAll, marking is bypassed|
...
|Member|Description|
|---|---|
|[GameLogic](Sandbox.Game.Components.MyEntityGameLogic@GameLogic)||
...
|Member|Description|
|---|---|
|[MyEntityGameLogic()](Sandbox.Game.Components.MyEntityGameLogic@.ctor)||

## Methods

|Member|Description|
|---|---|
|[Close()](Sandbox.Game.Components.MyEntityGameLogic@Close)||
|[GetObjectBuilder(bool)](Sandbox.Game.Components.MyEntityGameLogic@GetObjectBuilder)||
|[Init(MyObjectBuilder_EntityBase)](Sandbox.Game.Components.MyEntityGameLogic@Init)||
|[Init(StringBuilder, string, MyEntity, float?, string)](Sandbox.Game.Components.MyEntityGameLogic@Init)||
|[MarkForClose()](Sandbox.Game.Components.MyEntityGameLogic@MarkForClose)|This method marks this entity for close which means, that Close will be called after all entities are updated|
|[OnAddedToContainer()](Sandbox.Game.Components.MyEntityGameLogic@OnAddedToContainer)||
|[UpdateAfterSimulation()](Sandbox.Game.Components.MyEntityGameLogic@UpdateAfterSimulation)||
|[UpdateAfterSimulation10()](Sandbox.Game.Components.MyEntityGameLogic@UpdateAfterSimulation10)||
|[UpdateAfterSimulation100()](Sandbox.Game.Components.MyEntityGameLogic@UpdateAfterSimulation100)||
|[UpdateBeforeSimulation()](Sandbox.Game.Components.MyEntityGameLogic@UpdateBeforeSimulation)||
|[UpdateBeforeSimulation10()](Sandbox.Game.Components.MyEntityGameLogic@UpdateBeforeSimulation10)|Called each 10th frame if registered for update10|
|[UpdateBeforeSimulation100()](Sandbox.Game.Components.MyEntityGameLogic@UpdateBeforeSimulation100)|Called each 100th frame if registered for update100|
|[UpdateOnceBeforeFrame()](Sandbox.Game.Components.MyEntityGameLogic@UpdateOnceBeforeFrame)||
|[UpdatingStopped()](Sandbox.Game.Components.MyEntityGameLogic@UpdatingStopped)||
