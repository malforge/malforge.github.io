...
```csharp
public class MyEntityReverbDetectorComponent: MyUpdatingEntityComponent, IMyComponentBase, IMyEntityComponentBase, IMyEventProxy, IMyEventOwner, IMyUpdatingEntityComponent
```
...
|Member|Description|
|---|---|
|[static CurrentReverbPreset](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@CurrentReverbPreset)||
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@ComponentTypeDebugString)||
|[Grids](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@Grids)||
|[Initialized](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@Initialized)||
|[Voxels](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@Voxels)||
...
|Member|Description|
|---|---|
|[MyEntityReverbDetectorComponent()](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@.ctor)||
...
|Member|Description|
|---|---|
|[GetDetectedAverage(bool)](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@GetDetectedAverage)||
|[GetDetectedNumberOfObjects(ReverbDetectedType)](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@GetDetectedNumberOfObjects)||
|[GetDetectedNumberOfObjects(out int, out int)](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@GetDetectedNumberOfObjects)||
|[InitComponent(MyEntity, bool)](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@InitComponent)||
|[UpdateBeforeSimulation()](Sandbox.Game.EntityComponents.MyEntityReverbDetectorComponent@UpdateBeforeSimulation)||
