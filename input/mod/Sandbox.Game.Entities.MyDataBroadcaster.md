...
```csharp
public class MyDataBroadcaster: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase, IMyEventProxy, IMyEventOwner
```
...
|Member|Description|
|---|---|
|[AntennaEntityId](Sandbox.Game.Entities.MyDataBroadcaster@AntennaEntityId)||
|[BroadcastPosition](Sandbox.Game.Entities.MyDataBroadcaster@BroadcastPosition)||
|[Closed](Sandbox.Game.Entities.MyDataBroadcaster@Closed)||
|[ComponentTypeDebugString](Sandbox.Game.Entities.MyDataBroadcaster@ComponentTypeDebugString)||
|[HasRemoteControl](Sandbox.Game.Entities.MyDataBroadcaster@HasRemoteControl)||
|[Info](Sandbox.Game.Entities.MyDataBroadcaster@Info)||
|[IsBeacon](Sandbox.Game.Entities.MyDataBroadcaster@IsBeacon)||
|[MainRemoteControlId](Sandbox.Game.Entities.MyDataBroadcaster@MainRemoteControlId)||
|[MainRemoteControlOwner](Sandbox.Game.Entities.MyDataBroadcaster@MainRemoteControlOwner)||
|[MainRemoteControlSharing](Sandbox.Game.Entities.MyDataBroadcaster@MainRemoteControlSharing)||
|[Owner](Sandbox.Game.Entities.MyDataBroadcaster@Owner)||
|[Receiver](Sandbox.Game.Entities.MyDataBroadcaster@Receiver)||
|[ReceiversInRange](Sandbox.Game.Entities.MyDataBroadcaster@ReceiversInRange)||
|[ShowInTerminal](Sandbox.Game.Entities.MyDataBroadcaster@ShowInTerminal)||
|[ShowOnHud](Sandbox.Game.Entities.MyDataBroadcaster@ShowOnHud)||
...
|Member|Description|
|---|---|
|[MyDataBroadcaster()](Sandbox.Game.Entities.MyDataBroadcaster@.ctor)||

## Methods

|Member|Description|
|---|---|
|[static CanBeUsedByPlayer(long, IMyEntity)](Sandbox.Game.Entities.MyDataBroadcaster@CanBeUsedByPlayer)||
|[CanBeUsedByPlayer(long)](Sandbox.Game.Entities.MyDataBroadcaster@CanBeUsedByPlayer)||
|[GetHudParams(bool)](Sandbox.Game.Entities.MyDataBroadcaster@GetHudParams)||
|[InitProxyObjectBuilder(MyObjectBuilder_ProxyAntenna)](Sandbox.Game.Entities.MyDataBroadcaster@InitProxyObjectBuilder)||
|[OnAddedToContainer()](Sandbox.Game.Entities.MyDataBroadcaster@OnAddedToContainer)||
|[OnBeforeRemovedFromContainer()](Sandbox.Game.Entities.MyDataBroadcaster@OnBeforeRemovedFromContainer)||
|[RaiseAntennaNameChanged(MyTerminalBlock)](Sandbox.Game.Entities.MyDataBroadcaster@RaiseAntennaNameChanged)||
|[RaiseNameChanged(MyCubeGrid)](Sandbox.Game.Entities.MyDataBroadcaster@RaiseNameChanged)||
|[RaiseOwnerChanged()](Sandbox.Game.Entities.MyDataBroadcaster@RaiseOwnerChanged)||
|[UpdateHudParams(MyEntity)](Sandbox.Game.Entities.MyDataBroadcaster@UpdateHudParams)||
|[UpdateReceiversInRange()](Sandbox.Game.Entities.MyDataBroadcaster@UpdateReceiversInRange)||
|[UpdateRemoteControlInfo()](Sandbox.Game.Entities.MyDataBroadcaster@UpdateRemoteControlInfo)||
