...
|Member|Description|
|---|---|
|[End](VRage.Game.ModAPI.IMyContractEscort@End)|End position of the contract|
|[OwnerIdentityId](VRage.Game.ModAPI.IMyContractEscort@OwnerIdentityId)|Identity id of the owner of the escorted grid|
|[Start](VRage.Game.ModAPI.IMyContractEscort@Start)|Start position of the contract|
