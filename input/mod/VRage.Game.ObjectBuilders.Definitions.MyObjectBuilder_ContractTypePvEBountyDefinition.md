...
```csharp
public class MyObjectBuilder_ContractTypePvEBountyDefinition: MyObjectBuilder_ContractTypeDefinition
```
...
|Member|Description|
|---|---|
|[Duration_BaseTime](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@Duration_BaseTime)||
|[KeepGridAtTheEnd](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@KeepGridAtTheEnd)||
|[KillRange](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@KillRange)||
|[KillRangeMultiplier](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@KillRangeMultiplier)||
|[MaxDistance](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@MaxDistance)||
|[MinDistance](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@MinDistance)||
|[MoneyReputationCoeficient](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@MoneyReputationCoeficient)||
|[ReferenceMass](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@ReferenceMass)||
|[RemarkPeriodInS](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@RemarkPeriodInS)||
|[RemarkVariance](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@RemarkVariance)||
|[ReputationLossForTarget](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@ReputationLossForTarget)||
|[RewardModifierMax](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@RewardModifierMax)||
|[RewardModifierMin](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@RewardModifierMin)||
|[RewardRadius](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@RewardRadius)||
|[TargetFactionType](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@TargetFactionType)||
|[TargetSpawnGroups](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@TargetSpawnGroups)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_ContractTypePvEBountyDefinition()](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypePvEBountyDefinition@.ctor)||
|[MyObjectBuilder_ContractTypeDefinition()](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypeDefinition@.ctor)|_Inherited from [MyObjectBuilder_ContractTypeDefinition](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypeDefinition)_|
...
**Inheritance:**   [MyObjectBuilder_Base](VRage.ObjectBuilders.MyObjectBuilder_Base) ˃ [MyObjectBuilder_DefinitionBase](VRage.Game.MyObjectBuilder_DefinitionBase) ˃ [MyObjectBuilder_ContractTypeDefinition](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ContractTypeDefinition)
