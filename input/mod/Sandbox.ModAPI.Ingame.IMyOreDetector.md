...
|Member|Description|
|---|---|
|[BroadcastUsingAntennas](Sandbox.ModAPI.Ingame.IMyOreDetector@BroadcastUsingAntennas)|Gets or sets whether block should use antennas to broadcast ore deposits|
|[Range](Sandbox.ModAPI.Ingame.IMyOreDetector@Range)|Gets ore detection range in meters|
...
* MyObjectBuilder_OreDetector/LargeOreDetectorReskin  
* MyObjectBuilder_OreDetector/SmallBlockOreDetector  
* MyObjectBuilder_OreDetector/SmallOreDetectorReskin
