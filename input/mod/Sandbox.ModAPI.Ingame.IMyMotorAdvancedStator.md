...
|[RotateToAngle(MyRotationDirection, float, float)](Sandbox.ModAPI.Ingame.IMyMotorStator@RotateToAngle)|Sets velocity and limits to rotate the rotor to the specified angle value<br /><br />_Inherited from [IMyMotorStator](Sandbox.ModAPI.Ingame.IMyMotorStator)_|
