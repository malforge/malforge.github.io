...
|Member|Description|
|---|---|
|[BlockDefId](VRage.Game.MyObjectBuilder_BlockItem@BlockDefId)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_BlockItem()](VRage.Game.MyObjectBuilder_BlockItem@.ctor)||
...
|Member|Description|
|---|---|
|[CanStack(MyObjectBuilder_PhysicalObject)](VRage.Game.MyObjectBuilder_BlockItem@CanStack)||
|[CanStack(MyObjectBuilderType, MyStringHash, MyItemFlags)](VRage.Game.MyObjectBuilder_BlockItem@CanStack)||
|[GetObjectId()](VRage.Game.MyObjectBuilder_BlockItem@GetObjectId)||
