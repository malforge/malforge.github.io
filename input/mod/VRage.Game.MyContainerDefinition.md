...
|Member|Description|
|---|---|
|[DefaultComponents](VRage.Game.MyContainerDefinition@DefaultComponents)||
|[Flags](VRage.Game.MyContainerDefinition@Flags)||
...
|Member|Description|
|---|---|
|[MyContainerDefinition()](VRage.Game.MyContainerDefinition@.ctor)||
...
|Member|Description|
|---|---|
|[GetObjectBuilder()](VRage.Game.MyContainerDefinition@GetObjectBuilder)||
|[HasDefaultComponent(string)](VRage.Game.MyContainerDefinition@HasDefaultComponent)|This will search through definitions to find if Default Components contains the searched component either as BuilderType, InstanceType, or ComponentType|
