...
```csharp
public interface IMyPistonTop: IMyAttachableTopBlock, IMyCubeBlock, IMyCubeBlock, IMyEntity, IMyEntity, IMyAttachableTopBlock, IMyPistonTop
```
...
|Member|Description|
|---|---|
|[Base](Sandbox.ModAPI.IMyPistonTop@Base)|Gets the attached stator/suspension block|
|[Piston](Sandbox.ModAPI.IMyPistonTop@Piston)|Gets the attached piston block|
