...
```csharp
public class MyCustomRenderEntitySubpart<TCustomRenderComponent>: MyEntitySubpart, IMyEntity, IMyEntity
```
...
|Member|Description|
|---|---|
|[Render](Sandbox.Game.Entities.MyCustomRenderEntitySubpart{TCustomRenderComponent}@Render)||
...
|Member|Description|
|---|---|
|[MyCustomRenderEntitySubpart()](Sandbox.Game.Entities.MyCustomRenderEntitySubpart{TCustomRenderComponent}@.ctor)||
|[MyEntitySubpart()](VRage.Game.Entity.MyEntitySubpart@.ctor)|_Inherited from [MyEntitySubpart](VRage.Game.Entity.MyEntitySubpart)_|
...
|[static GetSubpartFromDummy(string, string, MyModelDummy, ref Data)](VRage.Game.Entity.MyEntitySubpart@GetSubpartFromDummy)|_Inherited from [MyEntitySubpart](VRage.Game.Entity.MyEntitySubpart)_|
|[HasCustomRenderComponent(out TCustomRenderComponent)](Sandbox.Game.Entities.MyCustomRenderEntitySubpart{TCustomRenderComponent}@HasCustomRenderComponent)||
|[InitComponents()](Sandbox.Game.Entities.MyCustomRenderEntitySubpart{TCustomRenderComponent}@InitComponents)||
...
**Inheritance:**   [MyEntity](VRage.Game.Entity.MyEntity) ˃ [MyEntitySubpart](VRage.Game.Entity.MyEntitySubpart)
