...
|[BoulderInfo](Sandbox.Game.Entities.MyVoxelBase@BoulderInfo)||
|[CreateStorageCopyOnWrite](Sandbox.Game.Entities.MyVoxelBase@CreateStorageCopyOnWrite)||
|[IsSeedOpen](Sandbox.Game.Entities.MyVoxelBase@IsSeedOpen)||
|[VoxelMapPruningProxyId](Sandbox.Game.Entities.MyVoxelBase@VoxelMapPruningProxyId)||
...
|Member|Description|
|---|---|
|[RangeChanged](Sandbox.Game.Entities.MyVoxelBase@RangeChanged)||
...
|Member|Description|
|---|---|
|[AsteroidName](Sandbox.Game.Entities.MyVoxelBase@AsteroidName)||
|[BeforeContentChanged](Sandbox.Game.Entities.MyVoxelBase@BeforeContentChanged)||
|[ContentChanged](Sandbox.Game.Entities.MyVoxelBase@ContentChanged)||
|[CreatedByUser](Sandbox.Game.Entities.MyVoxelBase@CreatedByUser)||
|[DelayRigidBodyCreation](Sandbox.Game.Entities.MyVoxelBase@DelayRigidBodyCreation)||
|[IsGlobalEncounterAsteroid](Sandbox.Game.Entities.MyVoxelBase@IsGlobalEncounterAsteroid)||
|[IsTransparentForJumpDrive](Sandbox.Game.Entities.MyVoxelBase@IsTransparentForJumpDrive)||
|[Orientation](Sandbox.Game.Entities.MyVoxelBase@Orientation)||
|[PositionLeftBottomCorner](Sandbox.Game.Entities.MyVoxelBase@PositionLeftBottomCorner)|Position of left/bottom corner of this voxel map, in world space (not relative to sector)|
|[RootVoxel](Sandbox.Game.Entities.MyVoxelBase@RootVoxel)|Gets root voxel, for asteroids and planets itself. For MyVoxelPhysics, should return owning planet.|
|[ScaleGroup](Sandbox.Game.Entities.MyVoxelBase@ScaleGroup)||
|[Size](Sandbox.Game.Entities.MyVoxelBase@Size)|Size of voxel map (in voxels)|
|[SizeInMetres](Sandbox.Game.Entities.MyVoxelBase@SizeInMetres)|Size of voxel map (in metres)|
|[SizeInMetresHalf](Sandbox.Game.Entities.MyVoxelBase@SizeInMetresHalf)||
|[SizeMinusOne](Sandbox.Game.Entities.MyVoxelBase@SizeMinusOne)||
|[Storage](Sandbox.Game.Entities.MyVoxelBase@Storage)||
|[StorageMax](Sandbox.Game.Entities.MyVoxelBase@StorageMax)||
|[StorageMin](Sandbox.Game.Entities.MyVoxelBase@StorageMin)||
|[StorageName](Sandbox.Game.Entities.MyVoxelBase@StorageName)||
|[VoxelSize](Sandbox.Game.Entities.MyVoxelBase@VoxelSize)||
...
|Member|Description|
|---|---|
|[MyVoxelBase()](Sandbox.Game.Entities.MyVoxelBase@.ctor)||
...
|Member|Description|
|---|---|
|[static IsForbiddenEntity(MyEntity)](Sandbox.Game.Entities.MyVoxelBase@IsForbiddenEntity)||
...
|[AreAllAabbCornersInside(ref MatrixD, BoundingBoxD)](Sandbox.Game.Entities.MyVoxelBase@AreAllAabbCornersInside)||
|[BroadcastShipCutout(ref NetworkCutoutData)](Sandbox.Game.Entities.MyVoxelBase@BroadcastShipCutout)||
|[CountPointsInside(*Vector3D, int, bool)](Sandbox.Game.Entities.MyVoxelBase@CountPointsInside)||
|[CreateVoxelMeteorCrater(Vector3D, float, Vector3, MyVoxelMaterialDefinition)](Sandbox.Game.Entities.MyVoxelBase@CreateVoxelMeteorCrater)||
|[CutOutShapeWithProperties(MyShape, out float, out MyVoxelMaterialDefinition, Dictionary<MyVoxelMaterialDefinition, int>, bool, bool, bool, bool)](Sandbox.Game.Entities.MyVoxelBase@CutOutShapeWithProperties)||
|[CutOutShapeWithPropertiesAsync(OnCutOutResults, MyShape, bool, bool, bool, bool, bool)](Sandbox.Game.Entities.MyVoxelBase@CutOutShapeWithPropertiesAsync)||
|[DoOverlapSphereTest(float, Vector3D)](Sandbox.Game.Entities.MyVoxelBase@DoOverlapSphereTest)||
|[FindOutsidePosition(Vector3D, float)](Sandbox.Game.Entities.MyVoxelBase@FindOutsidePosition)|Find a storage local position that is outside of voxel content within a given radius.|
|[GetContainedVoxelCoords(ref BoundingBoxD, out Vector3I, out Vector3I)](Sandbox.Game.Entities.MyVoxelBase@GetContainedVoxelCoords)||
|[GetFilledStorageBounds(out Vector3I, out Vector3I)](Sandbox.Game.Entities.MyVoxelBase@GetFilledStorageBounds)||
|[GetIntersectionWithLine(ref LineD, out MyIntersectionResultLineTriangleEx?, IntersectionFlags)](Sandbox.Game.Entities.MyVoxelBase@GetIntersectionWithLine)||
|[GetIntersectionWithLine(ref LineD, out Vector3D?, bool, IntersectionFlags)](Sandbox.Game.Entities.MyVoxelBase@GetIntersectionWithLine)||
|[GetMaterialAt(ref Vector3D)](Sandbox.Game.Entities.MyVoxelBase@GetMaterialAt)||
|[GetMaterialsInShape(MyShape, int)](Sandbox.Game.Entities.MyVoxelBase@GetMaterialsInShape)||
|[GetObjectBuilder(bool)](Sandbox.Game.Entities.MyVoxelBase@GetObjectBuilder)||
|[GetOrePriority()](Sandbox.Game.Entities.MyVoxelBase@GetOrePriority)||
|[GetVoxelContentInBoundingBox_Fast(BoundingBoxD, MatrixD, bool, float)](Sandbox.Game.Entities.MyVoxelBase@GetVoxelContentInBoundingBox_Fast)|Calculates amount of volume of a bounding box in voxels.|
|[GetVoxelRangeTypeInBoundingBox(BoundingBoxD)](Sandbox.Game.Entities.MyVoxelBase@GetVoxelRangeTypeInBoundingBox)||
|[Init(MyObjectBuilder_EntityBase, IMyStorage)](Sandbox.Game.Entities.MyVoxelBase@Init)||
|[Init(string, IMyStorage, Vector3D)](Sandbox.Game.Entities.MyVoxelBase@Init)||
|[Init(string, IMyStorage, MatrixD, bool)](Sandbox.Game.Entities.MyVoxelBase@Init)||
|[IntersectStorage(ref BoundingBox, bool)](Sandbox.Game.Entities.MyVoxelBase@IntersectStorage)||
|[IsAnyAabbCornerInside(ref MatrixD, BoundingBoxD)](Sandbox.Game.Entities.MyVoxelBase@IsAnyAabbCornerInside)||
|[IsAnyOfPointInside(Vector3D[])](Sandbox.Game.Entities.MyVoxelBase@IsAnyOfPointInside)||
|[IsBoxIntersectingBoundingBoxOfThisVoxelMap(ref BoundingBoxD)](Sandbox.Game.Entities.MyVoxelBase@IsBoxIntersectingBoundingBoxOfThisVoxelMap)||
|[IsOverlapOverThreshold(BoundingBoxD, float)](Sandbox.Game.Entities.MyVoxelBase@IsOverlapOverThreshold)||
|[OnReplicationEnded()](Sandbox.Game.Entities.MyVoxelBase@OnReplicationEnded)||
|[OnReplicationStarted()](Sandbox.Game.Entities.MyVoxelBase@OnReplicationStarted)||
|[PerformCutOutSphereFast(Vector3D, float, bool)](Sandbox.Game.Entities.MyVoxelBase@PerformCutOutSphereFast)||
|[RequestVoxelCutoutSphere(Vector3D, float, bool, bool)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelCutoutSphere)||
|[RequestVoxelOperationBox(BoundingBoxD, MatrixD, byte, OperationType)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelOperationBox)||
|[RequestVoxelOperationCapsule(Vector3D, Vector3D, float, MatrixD, byte, OperationType)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelOperationCapsule)||
|[RequestVoxelOperationElipsoid(Vector3, MatrixD, byte, OperationType)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelOperationElipsoid)||
|[RequestVoxelOperationRamp(BoundingBoxD, Vector3D, double, MatrixD, byte, OperationType)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelOperationRamp)||
|[RequestVoxelOperationSphere(Vector3D, float, byte, OperationType)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelOperationSphere)||
|[RevertVoxelAccess(Vector3I, MyStorageDataTypeFlags)](Sandbox.Game.Entities.MyVoxelBase@RevertVoxelAccess)||
