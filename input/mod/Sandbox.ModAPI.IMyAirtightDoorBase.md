...
```csharp
public interface IMyAirtightDoorBase: IMyDoor, IMyFunctionalBlock, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyDoor, IMyAirtightDoorBase
```
