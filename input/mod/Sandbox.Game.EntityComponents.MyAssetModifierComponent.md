...
|Member|Description|
|---|---|
|[AssetModifiers](Sandbox.Game.EntityComponents.MyAssetModifierComponent@AssetModifiers)||
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyAssetModifierComponent@ComponentTypeDebugString)||
...
|Member|Description|
|---|---|
|[MyAssetModifierComponent()](Sandbox.Game.EntityComponents.MyAssetModifierComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[static ApplyAssetModifierSync(long, Byte[], bool)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@ApplyAssetModifierSync)||
|[static ApplyAssetModifierSync(long, string, bool)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@ApplyAssetModifierSync)||
|[static ResetDrill(MyEntity)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@ResetDrill)||
|[static ResetGrinder(MyEntity)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@ResetGrinder)||
|[static ResetRifle(MyEntity)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@ResetRifle)||
|[static ResetWelder(MyEntity)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@ResetWelder)||
|[static SetDefaultTextures(MyEntity, string)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@SetDefaultTextures)||
|[Deserialize(MyObjectBuilder_ComponentBase)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@Deserialize)||
|[IsSerialized()](Sandbox.Game.EntityComponents.MyAssetModifierComponent@IsSerialized)||
|[LazyUpdate()](Sandbox.Game.EntityComponents.MyAssetModifierComponent@LazyUpdate)||
|[OnRemovedFromScene()](Sandbox.Game.EntityComponents.MyAssetModifierComponent@OnRemovedFromScene)||
|[ResetSlot(MyGameInventoryItemSlot)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@ResetSlot)||
|[Serialize(bool)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@Serialize)||
|[TryAddAssetModifier(Byte[])](Sandbox.Game.EntityComponents.MyAssetModifierComponent@TryAddAssetModifier)||
|[TryAddAssetModifier(string)](Sandbox.Game.EntityComponents.MyAssetModifierComponent@TryAddAssetModifier)||
