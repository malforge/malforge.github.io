...
```csharp
public interface IMyJumpDrive: IMyFunctionalBlock, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyJumpDrive
```
...
|Member|Description|
|---|---|
|[CurrentStoredPower](Sandbox.ModAPI.IMyJumpDrive@CurrentStoredPower)|Gets or sets the stored charge.|
...
|Member|Description|
|---|---|
|[Jump(bool)](Sandbox.ModAPI.IMyJumpDrive@Jump)|Requests the jump drive to make a jump. MODDERS: Use IMyCubeGrid.JumpSystems for more options.|
