...
```csharp
public class MyContainerDropComponent: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[Competetive](Sandbox.Game.Components.MyContainerDropComponent@Competetive)||
|[ComponentTypeDebugString](Sandbox.Game.Components.MyContainerDropComponent@ComponentTypeDebugString)||
|[GPSName](Sandbox.Game.Components.MyContainerDropComponent@GPSName)||
|[GridEntityId](Sandbox.Game.Components.MyContainerDropComponent@GridEntityId)||
|[Owner](Sandbox.Game.Components.MyContainerDropComponent@Owner)||
...
|Member|Description|
|---|---|
|[MyContainerDropComponent()](Sandbox.Game.Components.MyContainerDropComponent@.ctor)||
|[MyContainerDropComponent(bool, string, long, string)](Sandbox.Game.Components.MyContainerDropComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[Deserialize(MyObjectBuilder_ComponentBase)](Sandbox.Game.Components.MyContainerDropComponent@Deserialize)||
|[IsSerialized()](Sandbox.Game.Components.MyContainerDropComponent@IsSerialized)||
|[OnAddedToContainer()](Sandbox.Game.Components.MyContainerDropComponent@OnAddedToContainer)||
|[OnAddedToScene()](Sandbox.Game.Components.MyContainerDropComponent@OnAddedToScene)||
|[OnBeforeRemovedFromContainer()](Sandbox.Game.Components.MyContainerDropComponent@OnBeforeRemovedFromContainer)||
|[OnRemovedFromScene()](Sandbox.Game.Components.MyContainerDropComponent@OnRemovedFromScene)||
|[PlaySound(string)](Sandbox.Game.Components.MyContainerDropComponent@PlaySound)||
|[Serialize(bool)](Sandbox.Game.Components.MyContainerDropComponent@Serialize)||
|[StopSound()](Sandbox.Game.Components.MyContainerDropComponent@StopSound)||
|[UpdateSound()](Sandbox.Game.Components.MyContainerDropComponent@UpdateSound)||
