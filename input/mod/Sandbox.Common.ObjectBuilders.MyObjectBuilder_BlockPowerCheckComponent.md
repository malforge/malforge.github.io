...
```csharp
public class MyObjectBuilder_BlockPowerCheckComponent: MyObjectBuilder_ComponentBase
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_BlockPowerCheckComponent()](Sandbox.Common.ObjectBuilders.MyObjectBuilder_BlockPowerCheckComponent@.ctor)||
