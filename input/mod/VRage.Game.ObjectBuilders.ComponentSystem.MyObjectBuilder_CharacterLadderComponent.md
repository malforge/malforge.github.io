...
```csharp
public class MyObjectBuilder_CharacterLadderComponent: MyObjectBuilder_ComponentBase
```
...
|Member|Description|
|---|---|
|[EnableJetpackOnExit](VRage.Game.ObjectBuilders.ComponentSystem.MyObjectBuilder_CharacterLadderComponent@EnableJetpackOnExit)||
|[LadderId](VRage.Game.ObjectBuilders.ComponentSystem.MyObjectBuilder_CharacterLadderComponent@LadderId)||
|[LadderInfo](VRage.Game.ObjectBuilders.ComponentSystem.MyObjectBuilder_CharacterLadderComponent@LadderInfo)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_CharacterLadderComponent()](VRage.Game.ObjectBuilders.ComponentSystem.MyObjectBuilder_CharacterLadderComponent@.ctor)||
