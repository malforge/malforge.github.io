...
|Member|Description|
|---|---|
|[static RaycastGridGroupVisibilityConnection](Sandbox.Game.EntityComponents.MyGridTargeting@RaycastGridGroupVisibilityConnection)||
|[AllowScanning](Sandbox.Game.EntityComponents.MyGridTargeting@AllowScanning)||
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyGridTargeting@ComponentTypeDebugString)||
|[ScanLock](Sandbox.Game.EntityComponents.MyGridTargeting@ScanLock)||
|[TargetBlocks](Sandbox.Game.EntityComponents.MyGridTargeting@TargetBlocks)||
...
|Member|Description|
|---|---|
|[MyGridTargeting()](Sandbox.Game.EntityComponents.MyGridTargeting@.ctor)||

## Methods

|Member|Description|
|---|---|
|[GetTargetRoots(bool, bool, bool, List<MyEntity>)](Sandbox.Game.EntityComponents.MyGridTargeting@GetTargetRoots)||
|[IsTargetLocked(MyEntity)](Sandbox.Game.EntityComponents.MyGridTargeting@IsTargetLocked)||
|[OnAddedToContainer()](Sandbox.Game.EntityComponents.MyGridTargeting@OnAddedToContainer)||
|[OnBeforeRemovedFromContainer()](Sandbox.Game.EntityComponents.MyGridTargeting@OnBeforeRemovedFromContainer)||
|[PrepareGridGroups(bool, bool, bool, List<List<long>>, List<long>, bool)](Sandbox.Game.EntityComponents.MyGridTargeting@PrepareGridGroups)||
|[RescanIfNeeded()](Sandbox.Game.EntityComponents.MyGridTargeting@RescanIfNeeded)||
|[SetLockedGridsOrCharacters(ICollection<long>)](Sandbox.Game.EntityComponents.MyGridTargeting@SetLockedGridsOrCharacters)||
|[UpdateGridConnections(List<List<long>>, List<long>, MyEntity)](Sandbox.Game.EntityComponents.MyGridTargeting@UpdateGridConnections)||
