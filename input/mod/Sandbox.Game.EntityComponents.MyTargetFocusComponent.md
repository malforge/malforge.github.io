...
```csharp
public class MyTargetFocusComponent: MyUpdatingEntityComponent, IMyComponentBase, IMyEntityComponentBase, IMyEventProxy, IMyEventOwner, IMyUpdatingEntityComponent
```
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyTargetFocusComponent@ComponentTypeDebugString)||
|[CurrentTarget](Sandbox.Game.EntityComponents.MyTargetFocusComponent@CurrentTarget)||
|[FocusSearchMaxDistance](Sandbox.Game.EntityComponents.MyTargetFocusComponent@FocusSearchMaxDistance)||
|[FocusSearchMaxDistanceSquared](Sandbox.Game.EntityComponents.MyTargetFocusComponent@FocusSearchMaxDistanceSquared)||
|[GridId](Sandbox.Game.EntityComponents.MyTargetFocusComponent@GridId)||
|[IsLocallyControlled](Sandbox.Game.EntityComponents.MyTargetFocusComponent@IsLocallyControlled)||
|[IsTargetLockingEnabledInController](Sandbox.Game.EntityComponents.MyTargetFocusComponent@IsTargetLockingEnabledInController)||
...
|Member|Description|
|---|---|
|[MyTargetFocusComponent()](Sandbox.Game.EntityComponents.MyTargetFocusComponent@.ctor)||
...
|Member|Description|
|---|---|
|[Init(MyComponentDefinitionBase)](Sandbox.Game.EntityComponents.MyTargetFocusComponent@Init)||
|[IsSerialized()](Sandbox.Game.EntityComponents.MyTargetFocusComponent@IsSerialized)||
|[IsTargetInRange(MatrixD, MyEntity, out double, bool)](Sandbox.Game.EntityComponents.MyTargetFocusComponent@IsTargetInRange)||
|[LookupSuperGridsInRange()](Sandbox.Game.EntityComponents.MyTargetFocusComponent@LookupSuperGridsInRange)||
|[OnLockRequest()](Sandbox.Game.EntityComponents.MyTargetFocusComponent@OnLockRequest)||
|[UpdateAfterSimulation()](Sandbox.Game.EntityComponents.MyTargetFocusComponent@UpdateAfterSimulation)||
|[UpdateAfterSimulation10()](Sandbox.Game.EntityComponents.MyTargetFocusComponent@UpdateAfterSimulation10)||
|[UpdateAfterSimulation100()](Sandbox.Game.EntityComponents.MyTargetFocusComponent@UpdateAfterSimulation100)||
|[UpdateAimVector()](Sandbox.Game.EntityComponents.MyTargetFocusComponent@UpdateAimVector)||
