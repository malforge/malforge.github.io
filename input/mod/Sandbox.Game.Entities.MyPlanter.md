...
```csharp
public class MyPlanter: MyCubeBlock, IMyEntity, IMyEntity, IMyComponentOwner<MyIDModule>, IMyCubeBlock, IMyCubeBlock, IMyUpgradableBlock, IMyUpgradableBlock
```
...
|Member|Description|
|---|---|
|[MyPlanter()](Sandbox.Game.Entities.MyPlanter@.ctor)||
