...
```csharp
public class MyVoxelMap: MyVoxelBase, IMyEntity, IMyEntity, IMyVoxelDrawable, IMyVoxelBase, IMyDecalProxy, IMyEventProxy, IMyEventOwner, IMyVoxelMap
```
...
|Member|Description|
|---|---|
|[IsStaticForCluster](Sandbox.Game.Entities.MyVoxelMap@IsStaticForCluster)||
|[RootVoxel](Sandbox.Game.Entities.MyVoxelMap@RootVoxel)||
|[Storage](Sandbox.Game.Entities.MyVoxelMap@Storage)||
...
|Member|Description|
|---|---|
|[MyVoxelMap()](Sandbox.Game.Entities.MyVoxelMap@.ctor)||
...
|Member|Description|
|---|---|
|[static GetNewStorageName(string, long)](Sandbox.Game.Entities.MyVoxelMap@GetNewStorageName)||
...
|[GetFriendlyName()](Sandbox.Game.Entities.MyVoxelMap@GetFriendlyName)||
|[GetIntersectionWithAABB(ref BoundingBoxD)](Sandbox.Game.Entities.MyVoxelMap@GetIntersectionWithAABB)||
|[GetIntersectionWithSphere(ref BoundingSphereD)](Sandbox.Game.Entities.MyVoxelMap@GetIntersectionWithSphere)||
|[GetObjectBuilder(bool)](Sandbox.Game.Entities.MyVoxelMap@GetObjectBuilder)||
|[GetOrePriority()](Sandbox.Game.Entities.MyVoxelMap@GetOrePriority)||
|[Init(MyObjectBuilder_EntityBase)](Sandbox.Game.Entities.MyVoxelMap@Init)||
|[Init(MyObjectBuilder_EntityBase, IMyStorage)](Sandbox.Game.Entities.MyVoxelMap@Init)||
|[Init(string, IMyStorage, MatrixD, bool)](Sandbox.Game.Entities.MyVoxelMap@Init)||
|[IsOverlapOverThreshold(BoundingBoxD, float)](Sandbox.Game.Entities.MyVoxelMap@IsOverlapOverThreshold)||
|[UpdateAfterSimulation10()](Sandbox.Game.Entities.MyVoxelMap@UpdateAfterSimulation10)||
|[UpdateBeforeSimulation10()](Sandbox.Game.Entities.MyVoxelMap@UpdateBeforeSimulation10)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyVoxelMap@UpdateOnceBeforeFrame)||
...
|[ClampVoxelCoord(ref Vector3I)](VRage.Game.ModAPI.IMyVoxelMap@ClampVoxelCoord)|_Inherited from [IMyVoxelMap](VRage.Game.ModAPI.IMyVoxelMap)_|
...
|[Close()](VRage.Game.ModAPI.IMyVoxelMap@Close)|_Inherited from [IMyVoxelMap](VRage.Game.ModAPI.IMyVoxelMap)_|
...
|[DoOverlapSphereTest(float, Vector3D)](VRage.Game.ModAPI.IMyVoxelMap@DoOverlapSphereTest)|_Inherited from [IMyVoxelMap](VRage.Game.ModAPI.IMyVoxelMap)_|
...
|[GetIntersectionWithSphere(ref BoundingSphereD)](VRage.Game.ModAPI.IMyVoxelMap@GetIntersectionWithSphere)|_Inherited from [IMyVoxelMap](VRage.Game.ModAPI.IMyVoxelMap)_|
...
|[GetObjectBuilder(bool)](VRage.Game.ModAPI.IMyVoxelMap@GetObjectBuilder)|_Inherited from [IMyVoxelMap](VRage.Game.ModAPI.IMyVoxelMap)_|
...
|[GetVoxelContentInBoundingBox(BoundingBoxD, out float)](VRage.Game.ModAPI.IMyVoxelMap@GetVoxelContentInBoundingBox)|_Inherited from [IMyVoxelMap](VRage.Game.ModAPI.IMyVoxelMap)_|
...
|[GetVoxelCoordinateFromMeters(Vector3D)](VRage.Game.ModAPI.IMyVoxelMap@GetVoxelCoordinateFromMeters)|_Inherited from [IMyVoxelMap](VRage.Game.ModAPI.IMyVoxelMap)_|
...
|[Init(MyObjectBuilder_EntityBase)](VRage.Game.ModAPI.IMyVoxelMap@Init)|_Inherited from [IMyVoxelMap](VRage.Game.ModAPI.IMyVoxelMap)_|
