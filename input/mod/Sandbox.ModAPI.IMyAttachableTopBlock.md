...
```csharp
public interface IMyAttachableTopBlock: IMyCubeBlock, IMyCubeBlock, IMyEntity, IMyEntity, IMyAttachableTopBlock
```
...
|Member|Description|
|---|---|
|[Base](Sandbox.ModAPI.IMyAttachableTopBlock@Base)|Gets the attached base block|
