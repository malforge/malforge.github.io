...
|Member|Description|
|---|---|
|[static CameraControllerSpectator](Sandbox.Game.Entities.MyBlockBuilderBase@CameraControllerSpectator)||
|[static CubeBuilderDefinition](Sandbox.Game.Entities.MyBlockBuilderBase@CubeBuilderDefinition)||
|[static IntersectionDirection](Sandbox.Game.Entities.MyBlockBuilderBase@IntersectionDirection)||
|[static IntersectionDistance](Sandbox.Game.Entities.MyBlockBuilderBase@IntersectionDistance)||
|[static IntersectionStart](Sandbox.Game.Entities.MyBlockBuilderBase@IntersectionStart)||
|[static PlacementProvider](Sandbox.Game.Entities.MyBlockBuilderBase@PlacementProvider)||
|[static SpectatorIsBuilding](Sandbox.Game.Entities.MyBlockBuilderBase@SpectatorIsBuilding)||
|[CurrentBlockDefinition](Sandbox.Game.Entities.MyBlockBuilderBase@CurrentBlockDefinition)||
|[FreePlacementTarget](Sandbox.Game.Entities.MyBlockBuilderBase@FreePlacementTarget)||
|[HitInfo](Sandbox.Game.Entities.MyBlockBuilderBase@HitInfo)||
|[IsActivated](Sandbox.Game.Entities.MyBlockBuilderBase@IsActivated)||
...
|Member|Description|
|---|---|
|[static ComputeSteps(Vector3I, Vector3I, Vector3I, out Vector3I, out Vector3I, out int)](Sandbox.Game.Entities.MyBlockBuilderBase@ComputeSteps)||
|[Activate(MyDefinitionId?, bool)](Sandbox.Game.Entities.MyBlockBuilderBase@Activate)||
|[Deactivate()](Sandbox.Game.Entities.MyBlockBuilderBase@Deactivate)||
|[FindClosestGrid()](Sandbox.Game.Entities.MyBlockBuilderBase@FindClosestGrid)||
|[FindClosestPlacementObject(out MyCubeGrid, out MyVoxelBase)](Sandbox.Game.Entities.MyBlockBuilderBase@FindClosestPlacementObject)|Finds closest object (grid or voxel map) for placement of blocks .|
|[InitFromDefinition(MySessionComponentDefinition)](Sandbox.Game.Entities.MyBlockBuilderBase@InitFromDefinition)||
