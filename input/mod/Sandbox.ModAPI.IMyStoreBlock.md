...
```csharp
public interface IMyStoreBlock: IMyFunctionalBlock, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyStoreBlock
```
...
|Member|Description|
|---|---|
|[CreateStoreItem(MyDefinitionId, int, int, StoreItemTypes)](Sandbox.ModAPI.IMyStoreBlock@CreateStoreItem)|Creates a store item that allows more control over how the item is setup. This method is suitable for PhysicalItem types.|
...
|[InsertOrder(MyStoreItemData, out long)](Sandbox.ModAPI.IMyStoreBlock@InsertOrder)|Creates store item and returns its id.|
|[InsertStoreItem(IMyStoreItem)](Sandbox.ModAPI.IMyStoreBlock@InsertStoreItem)|Allows you to add an item to a store block. This is a direct add and does not involve any listing fees, etc.|
|[RemoveStoreItem(IMyStoreItem)](Sandbox.ModAPI.IMyStoreBlock@RemoveStoreItem)|Allows you to remove an item to a store block.|
...
|[CancelStoreItem(long)](Sandbox.ModAPI.Ingame.IMyStoreBlock@CancelStoreItem)|Cancels the item (either order or offer).<br /><br />_Inherited from [IMyStoreBlock](Sandbox.ModAPI.Ingame.IMyStoreBlock)_|
...
|[GetPlayerStoreItems(List<MyStoreQueryItem>)](Sandbox.ModAPI.Ingame.IMyStoreBlock@GetPlayerStoreItems)|Returns player store items.<br /><br />_Inherited from [IMyStoreBlock](Sandbox.ModAPI.Ingame.IMyStoreBlock)_|
...
|[InsertOffer(MyStoreItemDataSimple, out long)](Sandbox.ModAPI.Ingame.IMyStoreBlock@InsertOffer)|Creates store item offer and returns its id.<br /><br />_Inherited from [IMyStoreBlock](Sandbox.ModAPI.Ingame.IMyStoreBlock)_|
|[InsertOrder(MyStoreItemDataSimple, out long)](Sandbox.ModAPI.Ingame.IMyStoreBlock@InsertOrder)|Creates store item order and returns its id.<br /><br />_Inherited from [IMyStoreBlock](Sandbox.ModAPI.Ingame.IMyStoreBlock)_|
