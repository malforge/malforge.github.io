...
```csharp
public Action<IMyEntity> event OnClosing
```
...
Modders should prefer [OnMarkForClose](VRage.ModAPI.IMyEntity@OnMarkForClose) or [OnClosing](VRage.ModAPI.IMyEntity@OnClosing) 
