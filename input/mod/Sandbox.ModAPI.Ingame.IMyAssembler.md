...
|[IsProducing](Sandbox.ModAPI.Ingame.IMyProductionBlock@IsProducing)|Gets whether block is currently producing.<br /><br />_Inherited from [IMyProductionBlock](Sandbox.ModAPI.Ingame.IMyProductionBlock)_|
|[IsQueueEmpty](Sandbox.ModAPI.Ingame.IMyProductionBlock@IsQueueEmpty)|Gets whether production queue is empty.<br /><br />_Inherited from [IMyProductionBlock](Sandbox.ModAPI.Ingame.IMyProductionBlock)_|
...
|[DisassembleEnabled](Sandbox.ModAPI.Ingame.IMyAssembler@DisassembleEnabled)|_**Obsolete:** Use the Mode property_<br /><br />Gets whether this assembler has disassemble mode enabled|
...
|[GetQueue(List<MyProductionItem>)](Sandbox.ModAPI.Ingame.IMyProductionBlock@GetQueue)|Gets the current production queue<br /><br />_Inherited from [IMyProductionBlock](Sandbox.ModAPI.Ingame.IMyProductionBlock)_|
