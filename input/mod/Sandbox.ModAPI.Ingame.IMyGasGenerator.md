...
|Member|Description|
|---|---|
|[AutoRefill](Sandbox.ModAPI.Ingame.IMyGasGenerator@AutoRefill)|Gets or sets bottles auto refill enabled|
|[IsProducing](Sandbox.ModAPI.Ingame.IMyGasGenerator@IsProducing)|Is true when gas generator is currently producing a gas|
|[UseConveyorSystem](Sandbox.ModAPI.Ingame.IMyGasGenerator@UseConveyorSystem)|Gets or sets whether block can use conveyor system (pull ice and hydrogen/oxygen bottles)|
