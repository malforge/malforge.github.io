...
|Member|Description|
|---|---|
|[IsJumping](Sandbox.Game.Entities.MyJumpDrive@IsJumping)||
...
|Member|Description|
|---|---|
|[BlockDefinition](Sandbox.Game.Entities.MyJumpDrive@BlockDefinition)||
|[StoredPowerRatio](Sandbox.Game.Entities.MyJumpDrive@StoredPowerRatio)||
...
|[CurrentStoredPower](Sandbox.ModAPI.Ingame.IMyJumpDrive@CurrentStoredPower)|Gets block stored power<br /><br />_Inherited from [IMyJumpDrive](Sandbox.ModAPI.Ingame.IMyJumpDrive)_|
|[CurrentStoredPower](Sandbox.ModAPI.IMyJumpDrive@CurrentStoredPower)|Gets or sets the stored charge.<br /><br />_Inherited from [IMyJumpDrive](Sandbox.ModAPI.IMyJumpDrive)_|
...
|[JumpDistanceMeters](Sandbox.ModAPI.Ingame.IMyJumpDrive@JumpDistanceMeters)|Gets or sets jump drive distance in meters.<br /><br />_Inherited from [IMyJumpDrive](Sandbox.ModAPI.Ingame.IMyJumpDrive)_|
|[JumpDistanceRatio](Sandbox.ModAPI.Ingame.IMyJumpDrive@JumpDistanceRatio)|Gets or sets jump drive distance ratio, value from 0 to 1.<br /><br />_Inherited from [IMyJumpDrive](Sandbox.ModAPI.Ingame.IMyJumpDrive)_|
...
|[MaxJumpDistanceMeters](Sandbox.ModAPI.Ingame.IMyJumpDrive@MaxJumpDistanceMeters)|Gets maximum jump drive distance.<br /><br />_Inherited from [IMyJumpDrive](Sandbox.ModAPI.Ingame.IMyJumpDrive)_|
|[MaxStoredPower](Sandbox.ModAPI.Ingame.IMyJumpDrive@MaxStoredPower)|Gets block max stored power<br /><br />_Inherited from [IMyJumpDrive](Sandbox.ModAPI.Ingame.IMyJumpDrive)_|
...
|[MinJumpDistanceMeters](Sandbox.ModAPI.Ingame.IMyJumpDrive@MinJumpDistanceMeters)|Gets minimum jump drive distance.<br /><br />_Inherited from [IMyJumpDrive](Sandbox.ModAPI.Ingame.IMyJumpDrive)_|
...
|[Recharge](Sandbox.ModAPI.Ingame.IMyJumpDrive@Recharge)|Turns on/off recharging<br /><br />_Inherited from [IMyJumpDrive](Sandbox.ModAPI.Ingame.IMyJumpDrive)_|
...
|[Status](Sandbox.ModAPI.Ingame.IMyJumpDrive@Status)|Gets block status<br /><br />_Inherited from [IMyJumpDrive](Sandbox.ModAPI.Ingame.IMyJumpDrive)_|
...
|Member|Description|
|---|---|
|[MyJumpDrive()](Sandbox.Game.Entities.MyJumpDrive@.ctor)||

## Methods

|Member|Description|
|---|---|
|[CanJumpAndHasAccess(long)](Sandbox.Game.Entities.MyJumpDrive@CanJumpAndHasAccess)||
|[CanJumpIfFullAndHasAccess(long)](Sandbox.Game.Entities.MyJumpDrive@CanJumpIfFullAndHasAccess)||
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyJumpDrive@GetObjectBuilderCubeBlock)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyJumpDrive@Init)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyJumpDrive@OnAddedToScene)||
|[OnModelChange()](Sandbox.Game.Entities.MyJumpDrive@OnModelChange)||
|[OnRegisteredToGridSystems()](Sandbox.Game.Entities.MyJumpDrive@OnRegisteredToGridSystems)||
|[OnUnregisteredFromGridSystems()](Sandbox.Game.Entities.MyJumpDrive@OnUnregisteredFromGridSystems)||
|[SetEmissiveStateDamaged()](Sandbox.Game.Entities.MyJumpDrive@SetEmissiveStateDamaged)||
|[SetEmissiveStateDisabled()](Sandbox.Game.Entities.MyJumpDrive@SetEmissiveStateDisabled)||
|[SetEmissiveStateWorking()](Sandbox.Game.Entities.MyJumpDrive@SetEmissiveStateWorking)||
|[SetStoredPower(float)](Sandbox.Game.Entities.MyJumpDrive@SetStoredPower)||
|[UpdateAfterSimulation()](Sandbox.Game.Entities.MyJumpDrive@UpdateAfterSimulation)||
|[UpdateAfterSimulation100()](Sandbox.Game.Entities.MyJumpDrive@UpdateAfterSimulation100)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyJumpDrive@UpdateOnceBeforeFrame)||
...
|[Jump(bool)](Sandbox.ModAPI.IMyJumpDrive@Jump)|Requests the jump drive to make a jump. MODDERS: Use IMyCubeGrid.JumpSystems for more options.<br /><br />_Inherited from [IMyJumpDrive](Sandbox.ModAPI.IMyJumpDrive)_|
