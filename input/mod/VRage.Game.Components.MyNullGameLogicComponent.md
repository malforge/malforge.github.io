...
```csharp
public class MyNullGameLogicComponent: MyGameLogicComponent, IMyComponentBase, IMyEntityComponentBase, IMyGameLogicComponent
```
...
|Member|Description|
|---|---|
|[MyNullGameLogicComponent()](VRage.Game.Components.MyNullGameLogicComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[Close()](VRage.Game.Components.MyNullGameLogicComponent@Close)||
|[GetObjectBuilder(bool)](VRage.Game.Components.MyNullGameLogicComponent@GetObjectBuilder)||
|[Init(MyObjectBuilder_EntityBase)](VRage.Game.Components.MyNullGameLogicComponent@Init)||
|[MarkForClose()](VRage.Game.Components.MyNullGameLogicComponent@MarkForClose)||
|[UpdateAfterSimulation()](VRage.Game.Components.MyNullGameLogicComponent@UpdateAfterSimulation)||
|[UpdateAfterSimulation10()](VRage.Game.Components.MyNullGameLogicComponent@UpdateAfterSimulation10)||
|[UpdateAfterSimulation100()](VRage.Game.Components.MyNullGameLogicComponent@UpdateAfterSimulation100)||
|[UpdateBeforeSimulation()](VRage.Game.Components.MyNullGameLogicComponent@UpdateBeforeSimulation)||
|[UpdateBeforeSimulation10()](VRage.Game.Components.MyNullGameLogicComponent@UpdateBeforeSimulation10)||
|[UpdateBeforeSimulation100()](VRage.Game.Components.MyNullGameLogicComponent@UpdateBeforeSimulation100)||
|[UpdateOnceBeforeFrame()](VRage.Game.Components.MyNullGameLogicComponent@UpdateOnceBeforeFrame)||
