...
|Member|Description|
|---|---|
|[UpdateFrequency](Sandbox.Game.EntityComponents.MyIngameScriptComponent@UpdateFrequency)|The update frequency with which to run the script.|
...
|Member|Description|
|---|---|
|[MyIngameScriptComponent()](Sandbox.Game.EntityComponents.MyIngameScriptComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[Init(MyObjectBuilder_EntityBase)](Sandbox.Game.EntityComponents.MyIngameScriptComponent@Init)||
|[UpdateAfterSimulation()](Sandbox.Game.EntityComponents.MyIngameScriptComponent@UpdateAfterSimulation)||
|[UpdateBeforeSimulation()](Sandbox.Game.EntityComponents.MyIngameScriptComponent@UpdateBeforeSimulation)||
|[UpdateBeforeSimulation10()](Sandbox.Game.EntityComponents.MyIngameScriptComponent@UpdateBeforeSimulation10)||
|[UpdateBeforeSimulation100()](Sandbox.Game.EntityComponents.MyIngameScriptComponent@UpdateBeforeSimulation100)||
