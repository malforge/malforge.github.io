...
|Member|Description|
|---|---|
|[AlignToGravity](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@AlignToGravity)||
|[CoastingTestEnabled](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@CoastingTestEnabled)||
|[CourseCorrectionMaxDistanceInPrecisionModeGridSizeMultiple](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@CourseCorrectionMaxDistanceInPrecisionModeGridSizeMultiple)||
|[CourseCorrectionMaxDistanceLargeGrid](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@CourseCorrectionMaxDistanceLargeGrid)||
|[CourseCorrectionMaxDistanceSmallGrid](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@CourseCorrectionMaxDistanceSmallGrid)||
|[CourseCorrectionMaxRemainingRotationBeforeThrust](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@CourseCorrectionMaxRemainingRotationBeforeThrust)||
|[CourseCorrectionMaxRemainingRotationBeforeThrustInPrecisionMode](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@CourseCorrectionMaxRemainingRotationBeforeThrustInPrecisionMode)||
|[CourseCorrectionMaxThrustPercentage](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@CourseCorrectionMaxThrustPercentage)||
|[DefaultPitchAngleDeg](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@DefaultPitchAngleDeg)||
|[DefaultRollAngleDeg](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@DefaultRollAngleDeg)||
|[MaxPitchAngleDeg](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@MaxPitchAngleDeg)||
|[MaxRollAngleDeg](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@MaxRollAngleDeg)||
|[MaxRotationSpeed](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@MaxRotationSpeed)||
|[MaxRotationSpeedTresholdRadians](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@MaxRotationSpeedTresholdRadians)||
|[MinHeightAboveTerrainBounds](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@MinHeightAboveTerrainBounds)||
|[MinHeightAlignmentEnabled](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@MinHeightAlignmentEnabled)||
|[MinRotationSpeed](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@MinRotationSpeed)||
|[MinRotationSpeedThresholdRadians](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@MinRotationSpeedThresholdRadians)||
|[PrecisionModeRotationVelocitySlowFactor](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@PrecisionModeRotationVelocitySlowFactor)||
|[RotationDeadzone](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@RotationDeadzone)||
|[RotationDeadzoneAdaptiveSpeed](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@RotationDeadzoneAdaptiveSpeed)||
|[RotationVelocitySlowFactorAutomaticBehavior](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@RotationVelocitySlowFactorAutomaticBehavior)||
|[RotationVelocitySlowFactorAutomaticBehaviorTreshold](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@RotationVelocitySlowFactorAutomaticBehaviorTreshold)||
...
|Member|Description|
|---|---|
|[MyAutopilotComponentDefinition()](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@.ctor)||
...
|Member|Description|
|---|---|
|[GetObjectBuilder()](Sandbox.Game.EntityComponents.MyAutopilotComponentDefinition@GetObjectBuilder)||
...
**Inheritance:**   [MyDefinitionBase](VRage.Game.MyDefinitionBase) ˃ [MyComponentDefinitionBase](VRage.Game.MyComponentDefinitionBase)
