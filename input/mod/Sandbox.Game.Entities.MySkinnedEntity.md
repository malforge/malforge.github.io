...
|[UseNewAnimationSystem](Sandbox.Game.Entities.MySkinnedEntity@UseNewAnimationSystem)|VRAGE TODO: THIS IS TEMPORARY! Remove when by the time we use only the new animation system.|
...
|Member|Description|
|---|---|
|[AnimationController](Sandbox.Game.Entities.MySkinnedEntity@AnimationController)||
|[BoneAbsoluteTransforms](Sandbox.Game.Entities.MySkinnedEntity@BoneAbsoluteTransforms)||
|[BoneRelativeTransforms](Sandbox.Game.Entities.MySkinnedEntity@BoneRelativeTransforms)||
|[DecalBoneUpdates](Sandbox.Game.Entities.MySkinnedEntity@DecalBoneUpdates)||
|[UpdateFlags](Sandbox.Game.Entities.MySkinnedEntity@UpdateFlags)||
...
|Member|Description|
|---|---|
|[MySkinnedEntity()](Sandbox.Game.Entities.MySkinnedEntity@.ctor)||
...
|[AddCommand(MyAnimationCommand, bool)](Sandbox.Game.Entities.MySkinnedEntity@AddCommand)|Enqueue animation command. Parameter sync is used in child classes.|
|[GetAdditionalRotation(string)](Sandbox.Game.Entities.MySkinnedEntity@GetAdditionalRotation)||
|[Init(StringBuilder, string, MyEntity, float?, string)](Sandbox.Game.Entities.MySkinnedEntity@Init)||
|[ObtainBones()](Sandbox.Game.Entities.MySkinnedEntity@ObtainBones)|Get the bones from the model and create a bone class object for each bone. We use our bone class to do the real animated bone work.|
|[SetBoneLODs(Dictionary<float, String[]>)](Sandbox.Game.Entities.MySkinnedEntity@SetBoneLODs)||
|[UpdateAfterSimulationParallel()](Sandbox.Game.Entities.MySkinnedEntity@UpdateAfterSimulationParallel)||
|[UpdateAnimation(float)](Sandbox.Game.Entities.MySkinnedEntity@UpdateAnimation)||
|[UpdateBeforeSimulationParallel()](Sandbox.Game.Entities.MySkinnedEntity@UpdateBeforeSimulationParallel)||
|[UpdateControl(float)](Sandbox.Game.Entities.MySkinnedEntity@UpdateControl)||
...
|[UpdateAnimation(float)](VRage.Game.IMySkinnedEntity@UpdateAnimation)|_Inherited from [IMySkinnedEntity](VRage.Game.IMySkinnedEntity)_|
...
|[UpdateControl(float)](VRage.Game.IMySkinnedEntity@UpdateControl)|_Inherited from [IMySkinnedEntity](VRage.Game.IMySkinnedEntity)_|
