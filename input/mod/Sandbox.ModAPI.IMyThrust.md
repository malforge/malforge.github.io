...
```csharp
public interface IMyThrust: IMyThrust, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity
```
...
|Member|Description|
|---|---|
|[ThrustChanged](Sandbox.ModAPI.IMyThrust@ThrustChanged)|Fires when thrust is changed|
|[ThrustOverrideChanged](Sandbox.ModAPI.IMyThrust@ThrustOverrideChanged)|Event when thrust override changes|
...
|Member|Description|
|---|---|
|[PowerConsumptionMultiplier](Sandbox.ModAPI.IMyThrust@PowerConsumptionMultiplier)|Gets or set power consumption multiplier|
|[ThrustMultiplier](Sandbox.ModAPI.IMyThrust@ThrustMultiplier)|Gets or set the thrust multiplier|
