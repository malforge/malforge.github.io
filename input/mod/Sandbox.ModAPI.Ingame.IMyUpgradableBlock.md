...
|Member|Description|
|---|---|
|[UpgradeCount](Sandbox.ModAPI.Ingame.IMyUpgradableBlock@UpgradeCount)|Gets number of upgrades applied|
...
|Member|Description|
|---|---|
|[FillUpgradesDictionary(Dictionary<string, float>)](Sandbox.ModAPI.Ingame.IMyUpgradableBlock@FillUpgradesDictionary)|Get list of upgrades. Read only.|
...
|[GetUpgrades(out Dictionary<string, float>)](Sandbox.ModAPI.Ingame.IMyUpgradableBlock@GetUpgrades)|_**Obsolete:** Use FillUpgradesDictionary without the out parameter instead._<br /><br />Obsolete|
