...
|Member|Description|
|---|---|
|[CurrentOutput](Sandbox.ModAPI.Ingame.IMyPowerProducer@CurrentOutput)|Gets current output in Megawatts|
|[CurrentOutputRatio](Sandbox.ModAPI.Ingame.IMyPowerProducer@CurrentOutputRatio)|Gets ratio of current output|
|[MaxOutput](Sandbox.ModAPI.Ingame.IMyPowerProducer@MaxOutput)|Gets maximum output in Megawatts|
