...
|Member|Description|
|---|---|
|[BaseProductionTimeInSeconds](VRage.Game.MyObjectBuilder_BlueprintDefinition@BaseProductionTimeInSeconds)|Base production time in seconds, which is affected by speed increase of refinery or assembler.|
|[IgnoreEfficiencyMultiplier](VRage.Game.MyObjectBuilder_BlueprintDefinition@IgnoreEfficiencyMultiplier)||
|[IsPrimary](VRage.Game.MyObjectBuilder_BlueprintDefinition@IsPrimary)||
|[Prerequisites](VRage.Game.MyObjectBuilder_BlueprintDefinition@Prerequisites)||
|[Priority](VRage.Game.MyObjectBuilder_BlueprintDefinition@Priority)||
|[ProgressBarSoundCue](VRage.Game.MyObjectBuilder_BlueprintDefinition@ProgressBarSoundCue)||
|[Result](VRage.Game.MyObjectBuilder_BlueprintDefinition@Result)|THIS IS OBSOLETE|
|[Results](VRage.Game.MyObjectBuilder_BlueprintDefinition@Results)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_BlueprintDefinition()](VRage.Game.MyObjectBuilder_BlueprintDefinition@.ctor)||
