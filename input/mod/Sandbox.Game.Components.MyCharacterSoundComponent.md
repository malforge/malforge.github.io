...
```csharp
public class MyCharacterSoundComponent: MyUpdatingEntityComponent, IMyComponentBase, IMyEntityComponentBase, IMyEventProxy, IMyEventOwner, IMyUpdatingEntityComponent, IMyCharacterComponent
```
...
|Member|Description|
|---|---|
|[Character](Sandbox.Game.Components.MyCharacterSoundComponent@Character)||
|[ComponentTypeDebugString](Sandbox.Game.Components.MyCharacterSoundComponent@ComponentTypeDebugString)||
|[StandingOnGrid](Sandbox.Game.Components.MyCharacterSoundComponent@StandingOnGrid)||
|[StandingOnVoxel](Sandbox.Game.Components.MyCharacterSoundComponent@StandingOnVoxel)||
...
|Member|Description|
|---|---|
|[MyCharacterSoundComponent()](Sandbox.Game.Components.MyCharacterSoundComponent@.ctor)||
...
|Member|Description|
|---|---|
|[OnAddedToContainer()](Sandbox.Game.Components.MyCharacterSoundComponent@OnAddedToContainer)||
|[OnBeforeRemovedFromContainer()](Sandbox.Game.Components.MyCharacterSoundComponent@OnBeforeRemovedFromContainer)||
|[OnCharacterDead()](Sandbox.Game.Components.MyCharacterSoundComponent@OnCharacterDead)||
|[PlayActionSound(MySoundPair, bool?)](Sandbox.Game.Components.MyCharacterSoundComponent@PlayActionSound)||
|[PlayDamageSound(float)](Sandbox.Game.Components.MyCharacterSoundComponent@PlayDamageSound)||
|[PlayDeathSound(MyStringHash, bool)](Sandbox.Game.Components.MyCharacterSoundComponent@PlayDeathSound)||
|[PlayFallSound()](Sandbox.Game.Components.MyCharacterSoundComponent@PlayFallSound)||
|[PlaySecondarySound(CharacterSoundsEnum, bool, bool, bool?)](Sandbox.Game.Components.MyCharacterSoundComponent@PlaySecondarySound)||
|[Preload()](Sandbox.Game.Components.MyCharacterSoundComponent@Preload)||
|[StartSecondarySound(string, bool)](Sandbox.Game.Components.MyCharacterSoundComponent@StartSecondarySound)||
|[StartSecondarySound(MyCueId, bool)](Sandbox.Game.Components.MyCharacterSoundComponent@StartSecondarySound)||
|[StopSecondarySound(bool)](Sandbox.Game.Components.MyCharacterSoundComponent@StopSecondarySound)||
|[StopStateSound(bool)](Sandbox.Game.Components.MyCharacterSoundComponent@StopStateSound)||
|[UpdateAfterSimulation()](Sandbox.Game.Components.MyCharacterSoundComponent@UpdateAfterSimulation)||
|[UpdateAfterSimulation100()](Sandbox.Game.Components.MyCharacterSoundComponent@UpdateAfterSimulation100)||
|[UpdateAfterSimulationParallel()](Sandbox.Game.Components.MyCharacterSoundComponent@UpdateAfterSimulationParallel)||
