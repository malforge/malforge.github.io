...
```csharp
public interface IMyDoor: IMyFunctionalBlock, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyDoor
```
...
|Member|Description|
|---|---|
|[DoorStateChanged](Sandbox.ModAPI.IMyDoor@DoorStateChanged)|Called when door changes state|
|[OnDoorClosed](Sandbox.ModAPI.IMyDoor@OnDoorClosed)|Called when door changes opened state to closed|
|[OnDoorOpened](Sandbox.ModAPI.IMyDoor@OnDoorOpened)|Called when door changes opened state to open|
|[OnDoorStateChanged](Sandbox.ModAPI.IMyDoor@OnDoorStateChanged)|Called when door changes opened state|
...
|Member|Description|
|---|---|
|[IsFullyClosed](Sandbox.ModAPI.IMyDoor@IsFullyClosed)|Returns whether door is fully closed. (Animations are stopped)|
