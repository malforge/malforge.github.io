...
```csharp
public class MyObjectBuilder_GridsStorageEntityComponentDefinition: MyObjectBuilder_ComponentDefinitionBase
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_GridsStorageEntityComponentDefinition()](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_GridsStorageEntityComponentDefinition@.ctor)||
