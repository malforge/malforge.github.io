...
```csharp
public interface IMyUpgradableBlock: IMyCubeBlock, IMyCubeBlock, IMyEntity, IMyEntity, IMyUpgradableBlock
```

Describes block, which has upgrade effects from block [IMyUpgradableBlock](Sandbox.ModAPI.Ingame.IMyUpgradableBlock) (PB scripting interface)
