...
```csharp
public class MyObjectBuilder_SalvageServiceComponentDefinition: MyObjectBuilder_ComponentDefinitionBase
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_SalvageServiceComponentDefinition()](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_SalvageServiceComponentDefinition@.ctor)||
