...
```csharp
public class MyCubeBlock: MyEntity, IMyEntity, IMyEntity, IMyComponentOwner<MyIDModule>, IMyCubeBlock, IMyCubeBlock, IMyUpgradableBlock, IMyUpgradableBlock
```
...
|Member|Description|
|---|---|
|[static m_emissiveNames](Sandbox.Game.Entities.MyCubeBlock@m_emissiveNames)||
|[static MAX_CUSTOM_NAME_LENGTH](Sandbox.Game.Entities.MyCubeBlock@MAX_CUSTOM_NAME_LENGTH)||
...
|[CurrentAttachedUpgradeModules](Sandbox.Game.Entities.MyCubeBlock@CurrentAttachedUpgradeModules)||
|[HandleEmissiveStateChange](Sandbox.Game.Entities.MyCubeBlock@HandleEmissiveStateChange)||
...
|Member|Description|
|---|---|
|[CanContinueBuildCheck](Sandbox.Game.Entities.MyCubeBlock@CanContinueBuildCheck)||
|[CheckConnectionChanged](Sandbox.Game.Entities.MyCubeBlock@CheckConnectionChanged)||
|[CubeGridChanged](Sandbox.Game.Entities.MyCubeBlock@CubeGridChanged)||
|[GetEmissiveStateHashFromComponent](Sandbox.Game.Entities.MyCubeBlock@GetEmissiveStateHashFromComponent)||
|[GetIsWorking](Sandbox.Game.Entities.MyCubeBlock@GetIsWorking)||
|[IsWorkingChanged](Sandbox.Game.Entities.MyCubeBlock@IsWorkingChanged)||
|[OnBlockDisableUpdates](Sandbox.Game.Entities.MyCubeBlock@OnBlockDisableUpdates)||
|[OnBlockModelChange](Sandbox.Game.Entities.MyCubeBlock@OnBlockModelChange)||
|[OnBlockRegisteredToGridSystems](Sandbox.Game.Entities.MyCubeBlock@OnBlockRegisteredToGridSystems)||
|[OnBlockUpdateVisual](Sandbox.Game.Entities.MyCubeBlock@OnBlockUpdateVisual)||
|[OnUpdateBeforenextFrame](Sandbox.Game.Entities.MyCubeBlock@OnUpdateBeforenextFrame)||
|[OnUpgradeValuesChanged](Sandbox.Game.Entities.MyCubeBlock@OnUpgradeValuesChanged)||
...
|Member|Description|
|---|---|
|[BlockDefinition](Sandbox.Game.Entities.MyCubeBlock@BlockDefinition)||
|[BuiltBy](Sandbox.Game.Entities.MyCubeBlock@BuiltBy)||
|[CheckConnectionAllowed](Sandbox.Game.Entities.MyCubeBlock@CheckConnectionAllowed)||
|[CubeGrid](Sandbox.Game.Entities.MyCubeBlock@CubeGrid)||
|[DefinitionDisplayNameText](Sandbox.Game.Entities.MyCubeBlock@DefinitionDisplayNameText)||
|[DisassembleRatio](Sandbox.Game.Entities.MyCubeBlock@DisassembleRatio)||
|[ForceBlockDestructible](Sandbox.Game.Entities.MyCubeBlock@ForceBlockDestructible)||
|[HighlightMode](Sandbox.Game.Entities.MyCubeBlock@HighlightMode)||
|[IDModule](Sandbox.Game.Entities.MyCubeBlock@IDModule)||
|[IsBeingHacked](Sandbox.Game.Entities.MyCubeBlock@IsBeingHacked)||
|[IsBuilt](Sandbox.Game.Entities.MyCubeBlock@IsBuilt)||
|[IsFunctional](Sandbox.Game.Entities.MyCubeBlock@IsFunctional)||
|[IsSubBlock](Sandbox.Game.Entities.MyCubeBlock@IsSubBlock)||
|[IsTransparentForJumpDrive](Sandbox.Game.Entities.MyCubeBlock@IsTransparentForJumpDrive)||
|[IsWorking](Sandbox.Game.Entities.MyCubeBlock@IsWorking)||
|[Max](Sandbox.Game.Entities.MyCubeBlock@Max)||
|[Min](Sandbox.Game.Entities.MyCubeBlock@Min)||
|[NumberInGrid](Sandbox.Game.Entities.MyCubeBlock@NumberInGrid)||
|[Orientation](Sandbox.Game.Entities.MyCubeBlock@Orientation)||
|[OwnerBlock](Sandbox.Game.Entities.MyCubeBlock@OwnerBlock)|If the block is subblock then OwnerBlock is set to block which owns (spawns) subblocks (subgrids)|
|[OwnerId](Sandbox.Game.Entities.MyCubeBlock@OwnerId)||
...
|[UsesEmissivePreset](Sandbox.Game.Entities.MyCubeBlock@UsesEmissivePreset)||
...
|Member|Description|
|---|---|
|[MyCubeBlock()](Sandbox.Game.Entities.MyCubeBlock@.ctor)||
...
|Member|Description|
|---|---|
|[static GetBlockGridOffset(MyCubeBlockDefinition)](Sandbox.Game.Entities.MyCubeBlock@GetBlockGridOffset)|Returns block offset in spawned grid.|
...
|[AddUpgradeValue(string, float)](Sandbox.Game.Entities.MyCubeBlock@AddUpgradeValue)||
|[CalcLocalMatrix(out Matrix, out string)](Sandbox.Game.Entities.MyCubeBlock@CalcLocalMatrix)||
|[CalculateCurrentModel(out Matrix)](Sandbox.Game.Entities.MyCubeBlock@CalculateCurrentModel)||
|[CanContinueBuild()](Sandbox.Game.Entities.MyCubeBlock@CanContinueBuild)||
|[ChangeBlockOwnerRequest(long, MyOwnershipShareModeEnum)](Sandbox.Game.Entities.MyCubeBlock@ChangeBlockOwnerRequest)||
|[ChangeOwner(long, MyOwnershipShareModeEnum)](Sandbox.Game.Entities.MyCubeBlock@ChangeOwner)||
|[CheckEmissiveState(bool)](Sandbox.Game.Entities.MyCubeBlock@CheckEmissiveState)||
|[CommitUpgradeValues()](Sandbox.Game.Entities.MyCubeBlock@CommitUpgradeValues)||
...
|[ContactPointCallback(ref MyGridContactInfo)](Sandbox.Game.Entities.MyCubeBlock@ContactPointCallback)|Return true when contact is valid|
|[CreateRenderer(MyPersistentEntityFlags2, Vector3, object)](Sandbox.Game.Entities.MyCubeBlock@CreateRenderer)||
|[DisableUpdates()](Sandbox.Game.Entities.MyCubeBlock@DisableUpdates)||
|[FriendlyWithBlock(MyCubeBlock)](Sandbox.Game.Entities.MyCubeBlock@FriendlyWithBlock)|Whether the two blocks are friendly. This relation is base on their owners and is symmetrical|
|[GetComponent()](Sandbox.Game.Entities.MyCubeBlock@GetComponent)||
|[GetGeometryLocalBox()](Sandbox.Game.Entities.MyCubeBlock@GetGeometryLocalBox)||
|[GetInteractiveObject(uint)](Sandbox.Game.Entities.MyCubeBlock@GetInteractiveObject)||
|[GetIntersectionWithLine(ref LineD, out MyIntersectionResultLineTriangleEx?, IntersectionFlags)](Sandbox.Game.Entities.MyCubeBlock@GetIntersectionWithLine)||
|[GetLocalMatrix(out Matrix)](Sandbox.Game.Entities.MyCubeBlock@GetLocalMatrix)||
|[GetMass()](Sandbox.Game.Entities.MyCubeBlock@GetMass)||
|[GetObjectBuilder(bool)](Sandbox.Game.Entities.MyCubeBlock@GetObjectBuilder)||
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyCubeBlock@GetObjectBuilderCubeBlock)||
|[GetOwnerFactionTag()](Sandbox.Game.Entities.MyCubeBlock@GetOwnerFactionTag)||
|[GetPlayerRelationToOwner()](Sandbox.Game.Entities.MyCubeBlock@GetPlayerRelationToOwner)||
|[GetSubBlocks()](Sandbox.Game.Entities.MyCubeBlock@GetSubBlocks)||
|[GetUserRelationToOwner(long, MyRelationsBetweenPlayerAndBlock)](Sandbox.Game.Entities.MyCubeBlock@GetUserRelationToOwner)||
|[Init()](Sandbox.Game.Entities.MyCubeBlock@Init)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyCubeBlock@Init)||
|[Init(MyObjectBuilder_CubeBlock, IMyCubeGrid)](Sandbox.Game.Entities.MyCubeBlock@Init)||
|[InitComponents()](Sandbox.Game.Entities.MyCubeBlock@InitComponents)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyCubeBlock@OnAddedToScene)||
...
|[OnCubeGridChanged(MyCubeGrid)](Sandbox.Game.Entities.MyCubeBlock@OnCubeGridChanged)|Notifies about grid change with old grid in parameter (new grid is available in property).|
|[OnDestroy()](Sandbox.Game.Entities.MyCubeBlock@OnDestroy)|Called when block is destroyed before being removed from grid|
|[OnModelChange()](Sandbox.Game.Entities.MyCubeBlock@OnModelChange)|Called when the model referred by the block is changed|
|[OnRegisteredToGridSystems()](Sandbox.Game.Entities.MyCubeBlock@OnRegisteredToGridSystems)|Called at the end of registration from grid systems (after block has been registered).|
|[OnRemovedByCubeBuilder()](Sandbox.Game.Entities.MyCubeBlock@OnRemovedByCubeBuilder)|Method called when user removes a cube block from grid. Useful when block has to remove some other attached block (like motors).|
|[OnRemovedFromScene(object)](Sandbox.Game.Entities.MyCubeBlock@OnRemovedFromScene)||
|[OnTeleport()](Sandbox.Game.Entities.MyCubeBlock@OnTeleport)||
|[OnUnregisteredFromGridSystems()](Sandbox.Game.Entities.MyCubeBlock@OnUnregisteredFromGridSystems)|Called at the end of unregistration from grid systems (after block has been unregistered).|
|[ReceivedDamage(float, MyStringHash, long, long, bool, MyStringHash?)](Sandbox.Game.Entities.MyCubeBlock@ReceivedDamage)|Block received damage from any source.|
|[RefreshModels(string, string)](Sandbox.Game.Entities.MyCubeBlock@RefreshModels)||
|[ReleaseInventory(MyInventory, bool)](Sandbox.Game.Entities.MyCubeBlock@ReleaseInventory)||
|[RemoveEffect(string, int)](Sandbox.Game.Entities.MyCubeBlock@RemoveEffect)||
|[SetDamageEffect(bool)](Sandbox.Game.Entities.MyCubeBlock@SetDamageEffect)||
|[SetDamageEffectDelayed(bool)](Sandbox.Game.Entities.MyCubeBlock@SetDamageEffectDelayed)||
|[SetEffect(string, bool)](Sandbox.Game.Entities.MyCubeBlock@SetEffect)||
|[SetEffect(string, float, bool, bool, bool)](Sandbox.Game.Entities.MyCubeBlock@SetEffect)||
|[SetEmissiveState(MyStringHash, uint, string)](Sandbox.Game.Entities.MyCubeBlock@SetEmissiveState)||
|[SetEmissiveStateDamaged()](Sandbox.Game.Entities.MyCubeBlock@SetEmissiveStateDamaged)||
|[SetEmissiveStateDisabled()](Sandbox.Game.Entities.MyCubeBlock@SetEmissiveStateDisabled)||
|[SetEmissiveStateWorking()](Sandbox.Game.Entities.MyCubeBlock@SetEmissiveStateWorking)||
|[StopDamageEffect(bool)](Sandbox.Game.Entities.MyCubeBlock@StopDamageEffect)||
|[TryGetSubBlock(string, out MySlimBlock)](Sandbox.Game.Entities.MyCubeBlock@TryGetSubBlock)||
|[UpdateBeforeSimulation()](Sandbox.Game.Entities.MyCubeBlock@UpdateBeforeSimulation)||
|[UpdateBeforeSimulation10()](Sandbox.Game.Entities.MyCubeBlock@UpdateBeforeSimulation10)||
|[UpdateEmissiveParts(uint, float, Color, Color)](Sandbox.Game.Entities.MyCubeBlock@UpdateEmissiveParts)||
|[UpdateIsWorking()](Sandbox.Game.Entities.MyCubeBlock@UpdateIsWorking)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyCubeBlock@UpdateOnceBeforeFrame)||
|[UpdateSkin(bool)](Sandbox.Game.Entities.MyCubeBlock@UpdateSkin)||
|[UpdateVisual()](Sandbox.Game.Entities.MyCubeBlock@UpdateVisual)||
