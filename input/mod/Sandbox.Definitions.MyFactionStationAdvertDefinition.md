...
```csharp
public class MyFactionStationAdvertDefinition: MyDefinitionBase
```
...
|Member|Description|
|---|---|
|[BackgroundSprite](Sandbox.Definitions.MyFactionStationAdvertDefinition@BackgroundSprite)||
|[ForegroundSprite](Sandbox.Definitions.MyFactionStationAdvertDefinition@ForegroundSprite)||
|[TextEntries](Sandbox.Definitions.MyFactionStationAdvertDefinition@TextEntries)||
...
|Member|Description|
|---|---|
|[MyFactionStationAdvertDefinition()](Sandbox.Definitions.MyFactionStationAdvertDefinition@.ctor)||
