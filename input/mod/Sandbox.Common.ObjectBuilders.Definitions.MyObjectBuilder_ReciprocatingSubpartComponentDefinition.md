...
```csharp
public class MyObjectBuilder_ReciprocatingSubpartComponentDefinition: MyObjectBuilder_ComponentDefinitionBase
```
...
|Member|Description|
|---|---|
|[AnimationOffsets](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@AnimationOffsets)||
|[Direction](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@Direction)||
|[MaxPosition](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@MaxPosition)||
|[MinPosition](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@MinPosition)||
|[MoveSpeed](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@MoveSpeed)||
|[MovesWhenWorking](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@MovesWhenWorking)||
|[NeedsEnergyToMove](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@NeedsEnergyToMove)||
|[SpinDown](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@SpinDown)||
|[SpinUp](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@SpinUp)||
|[SubpartCommonTag](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@SubpartCommonTag)||
|[SubpartName](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@SubpartName)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_ReciprocatingSubpartComponentDefinition()](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ReciprocatingSubpartComponentDefinition@.ctor)||
