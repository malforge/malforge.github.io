...
|Member|Description|
|---|---|
|[AnimateWhenBlockNotFunctional](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@AnimateWhenBlockNotFunctional)||
|[Axis](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@Axis)||
|[Direction](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@Direction)||
|[NeedsEnergyToRotate](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@NeedsEnergyToRotate)||
|[PropagateRotationToChildernSubparts](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@PropagateRotationToChildernSubparts)||
|[RemoveExistingComponentOnNewInsert](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@RemoveExistingComponentOnNewInsert)||
|[Speed](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@Speed)||
|[Spindown](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@Spindown)||
|[Spinup](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@Spinup)||
|[SubpartName](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@SubpartName)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_RotatingSubpartComponentDefinition()](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RotatingSubpartComponentDefinition@.ctor)||
