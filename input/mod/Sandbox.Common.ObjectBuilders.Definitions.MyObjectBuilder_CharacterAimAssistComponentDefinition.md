...
```csharp
public class MyObjectBuilder_CharacterAimAssistComponentDefinition: MyObjectBuilder_ComponentDefinitionBase
```
...
|Member|Description|
|---|---|
|[AimAssistDistance](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_CharacterAimAssistComponentDefinition@AimAssistDistance)||
|[CapsuleHeight](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_CharacterAimAssistComponentDefinition@CapsuleHeight)||
|[CapsuleRadius](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_CharacterAimAssistComponentDefinition@CapsuleRadius)||
|[SensitivityMultiplierDisabled](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_CharacterAimAssistComponentDefinition@SensitivityMultiplierDisabled)||
|[SensitivityMultiplierEnabled](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_CharacterAimAssistComponentDefinition@SensitivityMultiplierEnabled)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_CharacterAimAssistComponentDefinition()](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_CharacterAimAssistComponentDefinition@.ctor)||
