...
|Member|Description|
|---|---|
|[ThrustLengthRand](Sandbox.Game.Entities.MyThrust@ThrustLengthRand)||

## Events

|Member|Description|
|---|---|
|[ThrustChanged](Sandbox.Game.Entities.MyThrust@ThrustChanged)||
|[ThrustOverrideChanged](Sandbox.Game.Entities.MyThrust@ThrustOverrideChanged)||
...
|[ThrustChanged](Sandbox.ModAPI.IMyThrust@ThrustChanged)|Fires when thrust is changed<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.IMyThrust)_|
|[ThrustOverrideChanged](Sandbox.ModAPI.IMyThrust@ThrustOverrideChanged)|Event when thrust override changes<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.IMyThrust)_|
...
|Member|Description|
|---|---|
|[BlockDefinition](Sandbox.Game.Entities.MyThrust@BlockDefinition)||
|[ConveyorEndpoint](Sandbox.Game.Entities.MyThrust@ConveyorEndpoint)||
|[CurrentStrength](Sandbox.Game.Entities.MyThrust@CurrentStrength)||
|[FlameDamageLengthScale](Sandbox.Game.Entities.MyThrust@FlameDamageLengthScale)||
|[FlameGlareIndex](Sandbox.Game.Entities.MyThrust@FlameGlareIndex)||
|[FlameLengthMaterial](Sandbox.Game.Entities.MyThrust@FlameLengthMaterial)||
|[FlamePointMaterial](Sandbox.Game.Entities.MyThrust@FlamePointMaterial)||
|[Flames](Sandbox.Game.Entities.MyThrust@Flames)||
|[Flares](Sandbox.Game.Entities.MyThrust@Flares)||
|[FuelConverterDefinition](Sandbox.Game.Entities.MyThrust@FuelConverterDefinition)||
|[FuelDefinition](Sandbox.Game.Entities.MyThrust@FuelDefinition)||
|[GridThrustDirection](Sandbox.Game.Entities.MyThrust@GridThrustDirection)||
|[IsOverridden](Sandbox.Game.Entities.MyThrust@IsOverridden)|Whether this thrust is overriden.|
|[IsPowered](Sandbox.Game.Entities.MyThrust@IsPowered)||
|[IsTieredUpdateSupported](Sandbox.Game.Entities.MyThrust@IsTieredUpdateSupported)||
|[MaxPowerConsumption](Sandbox.Game.Entities.MyThrust@MaxPowerConsumption)||
|[MinPowerConsumption](Sandbox.Game.Entities.MyThrust@MinPowerConsumption)||
|[Propeller](Sandbox.Game.Entities.MyThrust@Propeller)||
|[Render](Sandbox.Game.Entities.MyThrust@Render)||
|[ThrustForce](Sandbox.Game.Entities.MyThrust@ThrustForce)|Thrust force direction is opposite to thrust forward vector orientation|
|[ThrustForceLength](Sandbox.Game.Entities.MyThrust@ThrustForceLength)||
|[ThrustForwardVector](Sandbox.Game.Entities.MyThrust@ThrustForwardVector)||
|[ThrustOverride](Sandbox.Game.Entities.MyThrust@ThrustOverride)|Overridden thrust in Newtons|
|[ThrustOverrideOverForceLen](Sandbox.Game.Entities.MyThrust@ThrustOverrideOverForceLen)|Returns ThrustOverride / ThrustForceLength. No division is actually needed after fraction simplification.|
...
|[CurrentThrust](Sandbox.ModAPI.Ingame.IMyThrust@CurrentThrust)|Gets the current thrust amount, in Newtons (N)<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.Ingame.IMyThrust)_|
|[CurrentThrustPercentage](Sandbox.ModAPI.Ingame.IMyThrust@CurrentThrustPercentage)|Gets the current thrust amount, in %. CurrentThrust of MaxThrust<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.Ingame.IMyThrust)_|
...
|[GridThrustDirection](Sandbox.ModAPI.Ingame.IMyThrust@GridThrustDirection)|Gets the direction of thrust, relative to ship controller (cockpit).<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.Ingame.IMyThrust)_|
...
|[MaxEffectiveThrust](Sandbox.ModAPI.Ingame.IMyThrust@MaxEffectiveThrust)|Gets the maximum effective thrust amount, in Newtons (N)<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.Ingame.IMyThrust)_|
...
|[MaxThrust](Sandbox.ModAPI.Ingame.IMyThrust@MaxThrust)|Gets the maximum thrust amount, in Newtons (N)<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.Ingame.IMyThrust)_|
...
|[PowerConsumptionMultiplier](Sandbox.ModAPI.IMyThrust@PowerConsumptionMultiplier)|Gets or set power consumption multiplier<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.IMyThrust)_|
...
|[ThrustMultiplier](Sandbox.ModAPI.IMyThrust@ThrustMultiplier)|Gets or set the thrust multiplier<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.IMyThrust)_|
|[ThrustOverride](Sandbox.ModAPI.Ingame.IMyThrust@ThrustOverride)|Gets or sets the override thrust amount, in Newtons (N)<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.Ingame.IMyThrust)_|
|[ThrustOverridePercentage](Sandbox.ModAPI.Ingame.IMyThrust@ThrustOverridePercentage)|Gets or sets the thrust override as a percentage between 0 and 1<br /><br />_Inherited from [IMyThrust](Sandbox.ModAPI.Ingame.IMyThrust)_|
...
|Member|Description|
|---|---|
|[MyThrust()](Sandbox.Game.Entities.MyThrust@.ctor)||

## Methods

|Member|Description|
|---|---|
|[static GetDelegate(Action<IMyThrust, float>)](Sandbox.Game.Entities.MyThrust@GetDelegate)||
|[static RandomizeFlameProperties(float, float, ref float, ref float)](Sandbox.Game.Entities.MyThrust@RandomizeFlameProperties)||
|[AllowSelfPulling()](Sandbox.Game.Entities.MyThrust@AllowSelfPulling)||
|[ClearThrustComponent()](Sandbox.Game.Entities.MyThrust@ClearThrustComponent)||
|[CubeBlock_OnWorkingChanged(MyCubeBlock)](Sandbox.Game.Entities.MyThrust@CubeBlock_OnWorkingChanged)||
|[DoUpdateTimerTick()](Sandbox.Game.Entities.MyThrust@DoUpdateTimerTick)||
|[GetDamageCapsuleLine(FlameInfo, ref MatrixD)](Sandbox.Game.Entities.MyThrust@GetDamageCapsuleLine)||
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyThrust@GetObjectBuilderCubeBlock)||
|[GetPullInformation()](Sandbox.Game.Entities.MyThrust@GetPullInformation)||
|[GetPushInformation()](Sandbox.Game.Entities.MyThrust@GetPushInformation)||
|[GetTerminalName(StringBuilder)](Sandbox.Game.Entities.MyThrust@GetTerminalName)||
|[GetTimerEnabledState()](Sandbox.Game.Entities.MyThrust@GetTimerEnabledState)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyThrust@Init)||
|[InitComponents()](Sandbox.Game.Entities.MyThrust@InitComponents)||
|[InitializeConveyorEndpoint()](Sandbox.Game.Entities.MyThrust@InitializeConveyorEndpoint)||
|[OnCubeGridChanged(MyCubeGrid)](Sandbox.Game.Entities.MyThrust@OnCubeGridChanged)||
|[OnModelChange()](Sandbox.Game.Entities.MyThrust@OnModelChange)||
|[OnRegisteredToGridSystems()](Sandbox.Game.Entities.MyThrust@OnRegisteredToGridSystems)||
|[OnUnregisteredFromGridSystems()](Sandbox.Game.Entities.MyThrust@OnUnregisteredFromGridSystems)||
|[Sink_IsPoweredChanged()](Sandbox.Game.Entities.MyThrust@Sink_IsPoweredChanged)||
|[UpdateAfterSimulation()](Sandbox.Game.Entities.MyThrust@UpdateAfterSimulation)||
|[UpdateAfterSimulation10()](Sandbox.Game.Entities.MyThrust@UpdateAfterSimulation10)||
|[UpdateAfterSimulation100()](Sandbox.Game.Entities.MyThrust@UpdateAfterSimulation100)||
|[UpdateBeforeSimulation100()](Sandbox.Game.Entities.MyThrust@UpdateBeforeSimulation100)||
...
**Inheritance:**   MyFunctionalBlock <sub>prohibited</sub>
