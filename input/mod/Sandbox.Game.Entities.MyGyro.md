...
|Member|Description|
|---|---|
|[OnGyroPowerChanged](Sandbox.Game.Entities.MyGyro@OnGyroPowerChanged)||
...
|Member|Description|
|---|---|
|[GyroOverride](Sandbox.Game.Entities.MyGyro@GyroOverride)||
|[GyroOverrideVelocityGrid](Sandbox.Game.Entities.MyGyro@GyroOverrideVelocityGrid)||
|[GyroPower](Sandbox.Game.Entities.MyGyro@GyroPower)||
|[IsAccountedByGyroSystem](Sandbox.Game.Entities.MyGyro@IsAccountedByGyroSystem)||
|[IsPowered](Sandbox.Game.Entities.MyGyro@IsPowered)||
|[MaxGyroForce](Sandbox.Game.Entities.MyGyro@MaxGyroForce)||
|[RequiredPowerInput](Sandbox.Game.Entities.MyGyro@RequiredPowerInput)||
...
|[GyroOverride](Sandbox.ModAPI.Ingame.IMyGyro@GyroOverride)|Gets or set whether this gyro has enabled override<br /><br />_Inherited from [IMyGyro](Sandbox.ModAPI.Ingame.IMyGyro)_|
|[GyroPower](Sandbox.ModAPI.Ingame.IMyGyro@GyroPower)|Get or set gyroscope power in<br /><br />_Inherited from [IMyGyro](Sandbox.ModAPI.Ingame.IMyGyro)_|
|[GyroStrengthMultiplier](Sandbox.ModAPI.IMyGyro@GyroStrengthMultiplier)|Gets or sets multiplier for max gyro strength<br /><br />_Inherited from [IMyGyro](Sandbox.ModAPI.IMyGyro)_|
...
|[Pitch](Sandbox.ModAPI.Ingame.IMyGyro@Pitch)|Gets or set the pitch angle<br /><br />_Inherited from [IMyGyro](Sandbox.ModAPI.Ingame.IMyGyro)_|
...
|[PowerConsumptionMultiplier](Sandbox.ModAPI.IMyGyro@PowerConsumptionMultiplier)|Gets or sets multiplier gyro power consumption<br /><br />_Inherited from [IMyGyro](Sandbox.ModAPI.IMyGyro)_|
...
|[Roll](Sandbox.ModAPI.Ingame.IMyGyro@Roll)|Gets or set the roll angle<br /><br />_Inherited from [IMyGyro](Sandbox.ModAPI.Ingame.IMyGyro)_|
...
|[Yaw](Sandbox.ModAPI.Ingame.IMyGyro@Yaw)|Gets or sets the yaw angle<br /><br />_Inherited from [IMyGyro](Sandbox.ModAPI.Ingame.IMyGyro)_|
...
|Member|Description|
|---|---|
|[MyGyro()](Sandbox.Game.Entities.MyGyro@.ctor)||

## Methods

|Member|Description|
|---|---|
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyGyro@GetObjectBuilderCubeBlock)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyGyro@Init)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyGyro@OnAddedToScene)||
|[SetEmissiveStateWorking()](Sandbox.Game.Entities.MyGyro@SetEmissiveStateWorking)||
|[SetGyroOverride(bool)](Sandbox.Game.Entities.MyGyro@SetGyroOverride)||
|[SetGyroTorque(Vector3)](Sandbox.Game.Entities.MyGyro@SetGyroTorque)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyGyro@UpdateOnceBeforeFrame)||
