...
```csharp
public static void SetAlphaHighlightForAll(string entityName, bool enabled, int thickness, int pulseTimeInFrames, Color color, string subPartNames, float alpha)
```
