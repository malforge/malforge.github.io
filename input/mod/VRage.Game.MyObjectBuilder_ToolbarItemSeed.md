...
```csharp
public class MyObjectBuilder_ToolbarItemSeed: MyObjectBuilder_ToolbarItemDefinition
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_ToolbarItemSeed()](VRage.Game.MyObjectBuilder_ToolbarItemSeed@.ctor)||
