...
```csharp
public class MyObjectBuilder_ResourceSinkComponentDefinition: MyObjectBuilder_ComponentDefinitionBase
```
...
|Member|Description|
|---|---|
|[PowerConsumption](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ResourceSinkComponentDefinition@PowerConsumption)||
|[ResourceSinkGroup](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ResourceSinkComponentDefinition@ResourceSinkGroup)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_ResourceSinkComponentDefinition()](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_ResourceSinkComponentDefinition@.ctor)||
