...
```csharp
public class MyPlanet: MyVoxelBase, IMyEntity, IMyEntity, IMyVoxelDrawable, IMyVoxelBase, IMyDecalProxy, IMyEventProxy, IMyEventOwner, IMyOxygenProvider
```
...
|Member|Description|
|---|---|
|[static MemoryTracker](Sandbox.Game.Entities.MyPlanet@MemoryTracker)||
|[static PHYSICS_SECTOR_SIZE_METERS](Sandbox.Game.Entities.MyPlanet@PHYSICS_SECTOR_SIZE_METERS)||
|[static RUN_SECTORS](Sandbox.Game.Entities.MyPlanet@RUN_SECTORS)||
...
|[BoulderInfo](Sandbox.Game.Entities.MyVoxelBase@BoulderInfo)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[CreateStorageCopyOnWrite](Sandbox.Game.Entities.MyVoxelBase@CreateStorageCopyOnWrite)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[IsSeedOpen](Sandbox.Game.Entities.MyVoxelBase@IsSeedOpen)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[VoxelMapPruningProxyId](Sandbox.Game.Entities.MyVoxelBase@VoxelMapPruningProxyId)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[RangeChanged](Sandbox.Game.Entities.MyVoxelBase@RangeChanged)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|Member|Description|
|---|---|
|[AtmosphereAltitude](Sandbox.Game.Entities.MyPlanet@AtmosphereAltitude)||
|[AtmosphereRadius](Sandbox.Game.Entities.MyPlanet@AtmosphereRadius)||
|[AtmosphereSettings](Sandbox.Game.Entities.MyPlanet@AtmosphereSettings)||
|[AtmosphereWavelengths](Sandbox.Game.Entities.MyPlanet@AtmosphereWavelengths)||
|[AverageRadius](Sandbox.Game.Entities.MyPlanet@AverageRadius)||
|[Generator](Sandbox.Game.Entities.MyPlanet@Generator)||
|[GetInitArguments](Sandbox.Game.Entities.MyPlanet@GetInitArguments)||
|[HasAtmosphere](Sandbox.Game.Entities.MyPlanet@HasAtmosphere)||
|[MaximumRadius](Sandbox.Game.Entities.MyPlanet@MaximumRadius)||
|[MinimumRadius](Sandbox.Game.Entities.MyPlanet@MinimumRadius)||
|[PositionLeftBottomCorner](Sandbox.Game.Entities.MyPlanet@PositionLeftBottomCorner)||
|[Provider](Sandbox.Game.Entities.MyPlanet@Provider)||
|[RootVoxel](Sandbox.Game.Entities.MyPlanet@RootVoxel)||
|[ScaleGroup](Sandbox.Game.Entities.MyPlanet@ScaleGroup)||
|[SpherizeWithDistance](Sandbox.Game.Entities.MyPlanet@SpherizeWithDistance)||
|[Storage](Sandbox.Game.Entities.MyPlanet@Storage)||
|[AsteroidName](Sandbox.Game.Entities.MyVoxelBase@AsteroidName)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[BeforeContentChanged](Sandbox.Game.Entities.MyVoxelBase@BeforeContentChanged)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[ContentChanged](Sandbox.Game.Entities.MyVoxelBase@ContentChanged)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[CreatedByUser](Sandbox.Game.Entities.MyVoxelBase@CreatedByUser)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[DelayRigidBodyCreation](Sandbox.Game.Entities.MyVoxelBase@DelayRigidBodyCreation)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[IsGlobalEncounterAsteroid](Sandbox.Game.Entities.MyVoxelBase@IsGlobalEncounterAsteroid)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[IsTransparentForJumpDrive](Sandbox.Game.Entities.MyVoxelBase@IsTransparentForJumpDrive)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[Orientation](Sandbox.Game.Entities.MyVoxelBase@Orientation)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[PositionLeftBottomCorner](VRage.ModAPI.IMyVoxelBase@PositionLeftBottomCorner)|_Inherited from [IMyVoxelBase](VRage.ModAPI.IMyVoxelBase)_|
|[PositionLeftBottomCorner](Sandbox.Game.Entities.MyVoxelBase@PositionLeftBottomCorner)|Position of left/bottom corner of this voxel map, in world space (not relative to sector)<br /><br />_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[RootVoxel](Sandbox.Game.Entities.MyVoxelBase@RootVoxel)|Gets root voxel, for asteroids and planets itself. For MyVoxelPhysics, should return owning planet.<br /><br />_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[ScaleGroup](Sandbox.Game.Entities.MyVoxelBase@ScaleGroup)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[Size](Sandbox.Game.Entities.MyVoxelBase@Size)|Size of voxel map (in voxels)<br /><br />_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[SizeInMetres](Sandbox.Game.Entities.MyVoxelBase@SizeInMetres)|Size of voxel map (in metres)<br /><br />_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[SizeInMetresHalf](Sandbox.Game.Entities.MyVoxelBase@SizeInMetresHalf)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[SizeMinusOne](Sandbox.Game.Entities.MyVoxelBase@SizeMinusOne)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[Storage](VRage.ModAPI.IMyVoxelBase@Storage)|_Inherited from [IMyVoxelBase](VRage.ModAPI.IMyVoxelBase)_|
...
|[Storage](Sandbox.Game.Entities.MyVoxelBase@Storage)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[Storage](VRage.Game.Entity.MyEntity@Storage)|_Inherited from [MyEntity](VRage.Game.Entity.MyEntity)_|
|[StorageMax](Sandbox.Game.Entities.MyVoxelBase@StorageMax)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[StorageMin](Sandbox.Game.Entities.MyVoxelBase@StorageMin)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[StorageName](VRage.ModAPI.IMyVoxelBase@StorageName)|_Inherited from [IMyVoxelBase](VRage.ModAPI.IMyVoxelBase)_|
|[StorageName](Sandbox.Game.Entities.MyVoxelBase@StorageName)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[VoxelSize](Sandbox.Game.Entities.MyVoxelBase@VoxelSize)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|Member|Description|
|---|---|
|[MyPlanet()](Sandbox.Game.Entities.MyPlanet@.ctor)||
|[MyVoxelBase()](Sandbox.Game.Entities.MyVoxelBase@.ctor)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|Member|Description|
|---|---|
|[static RevertBoulder(MyBoulderInformation)](Sandbox.Game.Entities.MyPlanet@RevertBoulder)||
|[static RevertBoulderBroadcast(long, long, int)](Sandbox.Game.Entities.MyPlanet@RevertBoulderBroadcast)||
|[static RevertBoulderServer(MyVoxelBase)](Sandbox.Game.Entities.MyPlanet@RevertBoulderServer)||
...
|[static IsForbiddenEntity(MyEntity)](Sandbox.Game.Entities.MyVoxelBase@IsForbiddenEntity)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[AddChildEntity(MyEntity)](Sandbox.Game.Entities.MyPlanet@AddChildEntity)||
|[AddToStationOreBlockTree(ref MyDynamicAABBTree, Vector3D, float)](Sandbox.Game.Entities.MyPlanet@AddToStationOreBlockTree)||
|[AfterPaste()](Sandbox.Game.Entities.MyPlanet@AfterPaste)||
|[BeforePaste()](Sandbox.Game.Entities.MyPlanet@BeforePaste)||
|[CorrectSpawnLocation(ref Vector3D, double)](Sandbox.Game.Entities.MyPlanet@CorrectSpawnLocation)||
|[CorrectSpawnLocation2(ref Vector3D, double, bool)](Sandbox.Game.Entities.MyPlanet@CorrectSpawnLocation2)||
|[DebugDrawPhysics()](Sandbox.Game.Entities.MyPlanet@DebugDrawPhysics)||
|[GetAirDensity(Vector3D)](Sandbox.Game.Entities.MyPlanet@GetAirDensity)||
|[GetClosestSurfacePointGlobal(Vector3D)](Sandbox.Game.Entities.MyPlanet@GetClosestSurfacePointGlobal)||
|[GetClosestSurfacePointGlobal(ref Vector3D)](Sandbox.Game.Entities.MyPlanet@GetClosestSurfacePointGlobal)||
|[GetClosestSurfacePointLocal(ref Vector3)](Sandbox.Game.Entities.MyPlanet@GetClosestSurfacePointLocal)||
|[GetHeightFromSurface(Vector3D)](Sandbox.Game.Entities.MyPlanet@GetHeightFromSurface)||
|[GetInstanceHash()](Sandbox.Game.Entities.MyPlanet@GetInstanceHash)||
...
|[Init(MyPlanetInitArguments)](Sandbox.Game.Entities.MyPlanet@Init)||
|[IntersectsWithGravityFast(ref BoundingBoxD)](Sandbox.Game.Entities.MyPlanet@IntersectsWithGravityFast)||
|[IsUnderGround(Vector3D)](Sandbox.Game.Entities.MyPlanet@IsUnderGround)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyPlanet@OnAddedToScene)||
|[OnRemovedFromScene(object)](Sandbox.Game.Entities.MyPlanet@OnRemovedFromScene)||
|[PrefetchShapeOnRay(ref LineD, bool)](Sandbox.Game.Entities.MyPlanet@PrefetchShapeOnRay)|Prefetch voxel physics and creates one if it don't exist|
|[RemoveChildEntity(MyEntity)](Sandbox.Game.Entities.MyPlanet@RemoveChildEntity)||
|[SetStationOreBlockTree(MyDynamicAABBTree)](Sandbox.Game.Entities.MyPlanet@SetStationOreBlockTree)||
|[UpdateAfterSimulation10()](Sandbox.Game.Entities.MyPlanet@UpdateAfterSimulation10)||
|[UpdateAfterSimulation100()](Sandbox.Game.Entities.MyPlanet@UpdateAfterSimulation100)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyPlanet@UpdateOnceBeforeFrame)||
...
|[AreAllAabbCornersInside(ref MatrixD, BoundingBoxD)](Sandbox.Game.Entities.MyVoxelBase@AreAllAabbCornersInside)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[BroadcastShipCutout(ref NetworkCutoutData)](Sandbox.Game.Entities.MyVoxelBase@BroadcastShipCutout)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[CountPointsInside(*Vector3D, int, bool)](Sandbox.Game.Entities.MyVoxelBase@CountPointsInside)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[CreateSync()](VRage.Game.Entity.MyEntity@CreateSync)|_Inherited from [MyEntity](VRage.Game.Entity.MyEntity)_|
|[CreateVoxelMeteorCrater(Vector3D, float, Vector3, MyVoxelMaterialDefinition)](Sandbox.Game.Entities.MyVoxelBase@CreateVoxelMeteorCrater)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[CutOutShapeWithProperties(MyShape, out float, out MyVoxelMaterialDefinition, Dictionary<MyVoxelMaterialDefinition, int>, bool, bool, bool, bool)](Sandbox.Game.Entities.MyVoxelBase@CutOutShapeWithProperties)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[CutOutShapeWithPropertiesAsync(OnCutOutResults, MyShape, bool, bool, bool, bool, bool)](Sandbox.Game.Entities.MyVoxelBase@CutOutShapeWithPropertiesAsync)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[DoOverlapSphereTest(float, Vector3D)](Sandbox.Game.Entities.MyVoxelBase@DoOverlapSphereTest)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[FindOutsidePosition(Vector3D, float)](Sandbox.Game.Entities.MyVoxelBase@FindOutsidePosition)|Find a storage local position that is outside of voxel content within a given radius.<br /><br />_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[GetContainedVoxelCoords(ref BoundingBoxD, out Vector3I, out Vector3I)](Sandbox.Game.Entities.MyVoxelBase@GetContainedVoxelCoords)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[GetFilledStorageBounds(out Vector3I, out Vector3I)](Sandbox.Game.Entities.MyVoxelBase@GetFilledStorageBounds)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[GetIntersectionWithLine(ref LineD, out MyIntersectionResultLineTriangleEx?, IntersectionFlags)](Sandbox.Game.Entities.MyVoxelBase@GetIntersectionWithLine)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[GetIntersectionWithLine(ref LineD, out Vector3D?, bool, IntersectionFlags)](Sandbox.Game.Entities.MyVoxelBase@GetIntersectionWithLine)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[GetMaterialAt(ref Vector3D)](Sandbox.Game.Entities.MyVoxelBase@GetMaterialAt)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[GetMaterialsInShape(MyShape, int)](Sandbox.Game.Entities.MyVoxelBase@GetMaterialsInShape)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[GetObjectBuilder(bool)](Sandbox.Game.Entities.MyVoxelBase@GetObjectBuilder)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[GetOrePriority()](Sandbox.Game.Entities.MyVoxelBase@GetOrePriority)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[GetOxygenForPosition(Vector3D)](VRage.Game.ModAPI.IMyOxygenProvider@GetOxygenForPosition)|Gets oxygen for position<br /><br />_Inherited from [IMyOxygenProvider](VRage.Game.ModAPI.IMyOxygenProvider)_|
...
|[GetVoxelContentInBoundingBox_Fast(BoundingBoxD, MatrixD, bool, float)](Sandbox.Game.Entities.MyVoxelBase@GetVoxelContentInBoundingBox_Fast)|Calculates amount of volume of a bounding box in voxels.<br /><br />_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[GetVoxelRangeTypeInBoundingBox(BoundingBoxD)](Sandbox.Game.Entities.MyVoxelBase@GetVoxelRangeTypeInBoundingBox)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[Init(MyObjectBuilder_EntityBase, IMyStorage)](Sandbox.Game.Entities.MyVoxelBase@Init)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[Init(string, IMyStorage, Vector3D)](Sandbox.Game.Entities.MyVoxelBase@Init)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[Init(string, IMyStorage, MatrixD, bool)](Sandbox.Game.Entities.MyVoxelBase@Init)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[IntersectStorage(ref BoundingBox, bool)](Sandbox.Game.Entities.MyVoxelBase@IntersectStorage)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[IsAnyAabbCornerInside(ref MatrixD, BoundingBoxD)](Sandbox.Game.Entities.MyVoxelBase@IsAnyAabbCornerInside)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[IsAnyOfPointInside(Vector3D[])](Sandbox.Game.Entities.MyVoxelBase@IsAnyOfPointInside)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[IsBoxIntersectingBoundingBoxOfThisVoxelMap(ref BoundingBoxD)](VRage.ModAPI.IMyVoxelBase@IsBoxIntersectingBoundingBoxOfThisVoxelMap)|_Inherited from [IMyVoxelBase](VRage.ModAPI.IMyVoxelBase)_|
|[IsBoxIntersectingBoundingBoxOfThisVoxelMap(ref BoundingBoxD)](Sandbox.Game.Entities.MyVoxelBase@IsBoxIntersectingBoundingBoxOfThisVoxelMap)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[IsOverlapOverThreshold(BoundingBoxD, float)](Sandbox.Game.Entities.MyVoxelBase@IsOverlapOverThreshold)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[IsPositionInRange(Vector3D)](VRage.Game.ModAPI.IMyOxygenProvider@IsPositionInRange)|Checks if provider can provide oxygen in that position<br /><br />_Inherited from [IMyOxygenProvider](VRage.Game.ModAPI.IMyOxygenProvider)_|
...
|[OnReplicationEnded()](Sandbox.Game.Entities.MyVoxelBase@OnReplicationEnded)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[OnReplicationEnded()](VRage.Game.Entity.MyEntity@OnReplicationEnded)|_Inherited from [MyEntity](VRage.Game.Entity.MyEntity)_|
|[OnReplicationStarted()](Sandbox.Game.Entities.MyVoxelBase@OnReplicationStarted)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[PerformCutOutSphereFast(Vector3D, float, bool)](Sandbox.Game.Entities.MyVoxelBase@PerformCutOutSphereFast)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
|[RequestVoxelCutoutSphere(Vector3D, float, bool, bool)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelCutoutSphere)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[RequestVoxelOperationBox(BoundingBoxD, MatrixD, byte, OperationType)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelOperationBox)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[RequestVoxelOperationCapsule(Vector3D, Vector3D, float, MatrixD, byte, OperationType)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelOperationCapsule)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[RequestVoxelOperationElipsoid(Vector3, MatrixD, byte, OperationType)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelOperationElipsoid)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[RequestVoxelOperationRamp(BoundingBoxD, Vector3D, double, MatrixD, byte, OperationType)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelOperationRamp)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[RequestVoxelOperationSphere(Vector3D, float, byte, OperationType)](Sandbox.Game.Entities.MyVoxelBase@RequestVoxelOperationSphere)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
|[ResetControls()](VRage.Game.Entity.MyEntity@ResetControls)|_Inherited from [MyEntity](VRage.Game.Entity.MyEntity)_|
|[RevertVoxelAccess(Vector3I, MyStorageDataTypeFlags)](Sandbox.Game.Entities.MyVoxelBase@RevertVoxelAccess)|_Inherited from [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)_|
...
**Inheritance:**   [MyEntity](VRage.Game.Entity.MyEntity) ˃ [MyVoxelBase](Sandbox.Game.Entities.MyVoxelBase)
...
* IMyVoxelDrawable <sub>prohibited</sub>
