...
|Member|Description|
|---|---|
|[BackkickForcePerSecond](Sandbox.Game.Entities.MyHandToolBase@BackkickForcePerSecond)||
|[CurrentAmmunition](Sandbox.Game.Entities.MyHandToolBase@CurrentAmmunition)||
|[CurrentMagazineAmmunition](Sandbox.Game.Entities.MyHandToolBase@CurrentMagazineAmmunition)||
|[CurrentMagazineAmount](Sandbox.Game.Entities.MyHandToolBase@CurrentMagazineAmount)||
|[DefinitionId](Sandbox.Game.Entities.MyHandToolBase@DefinitionId)||
|[EnabledInWorldRules](Sandbox.Game.Entities.MyHandToolBase@EnabledInWorldRules)||
|[ForceAnimationInsteadOfIK](Sandbox.Game.Entities.MyHandToolBase@ForceAnimationInsteadOfIK)||
|[GunBase](Sandbox.Game.Entities.MyHandToolBase@GunBase)||
|[IsBlocking](Sandbox.Game.Entities.MyHandToolBase@IsBlocking)||
|[IsRecoiling](Sandbox.Game.Entities.MyHandToolBase@IsRecoiling)||
|[IsReloading](Sandbox.Game.Entities.MyHandToolBase@IsReloading)||
|[IsShooting](Sandbox.Game.Entities.MyHandToolBase@IsShooting)||
|[IsSkinnable](Sandbox.Game.Entities.MyHandToolBase@IsSkinnable)||
|[IsTargetLockingCapable](Sandbox.Game.Entities.MyHandToolBase@IsTargetLockingCapable)||
|[MaximumShotLength](Sandbox.Game.Entities.MyHandToolBase@MaximumShotLength)||
|[NeedsReload](Sandbox.Game.Entities.MyHandToolBase@NeedsReload)||
|[NeedsShootDirectionWhileAiming](Sandbox.Game.Entities.MyHandToolBase@NeedsShootDirectionWhileAiming)||
|[Owner](Sandbox.Game.Entities.MyHandToolBase@Owner)||
|[OwnerId](Sandbox.Game.Entities.MyHandToolBase@OwnerId)||
|[OwnerIdentityId](Sandbox.Game.Entities.MyHandToolBase@OwnerIdentityId)||
|[PhysicalItemDefinition](Sandbox.Game.Entities.MyHandToolBase@PhysicalItemDefinition)||
|[PhysicalObject](Sandbox.Game.Entities.MyHandToolBase@PhysicalObject)||
|[Physics](Sandbox.Game.Entities.MyHandToolBase@Physics)||
|[Reloadable](Sandbox.Game.Entities.MyHandToolBase@Reloadable)||
|[ShakeAmount](Sandbox.Game.Entities.MyHandToolBase@ShakeAmount)||
|[ShootDirectionUpdateTime](Sandbox.Game.Entities.MyHandToolBase@ShootDirectionUpdateTime)||
...
|Member|Description|
|---|---|
|[MyHandToolBase()](Sandbox.Game.Entities.MyHandToolBase@.ctor)||
...
|[BeginFailReaction(MyShootActionEnum, MyGunStatusEnum)](Sandbox.Game.Entities.MyHandToolBase@BeginFailReaction)||
|[BeginFailReactionLocal(MyShootActionEnum, MyGunStatusEnum)](Sandbox.Game.Entities.MyHandToolBase@BeginFailReactionLocal)||
|[BeginShoot(MyShootActionEnum)](Sandbox.Game.Entities.MyHandToolBase@BeginShoot)||
|[CanDoubleClickToStick(MyShootActionEnum)](Sandbox.Game.Entities.MyHandToolBase@CanDoubleClickToStick)||
|[CanReload()](Sandbox.Game.Entities.MyHandToolBase@CanReload)||
|[CanShoot(MyShootActionEnum, long, out MyGunStatusEnum)](Sandbox.Game.Entities.MyHandToolBase@CanShoot)||
|[DirectionToTarget(Vector3D)](Sandbox.Game.Entities.MyHandToolBase@DirectionToTarget)||
|[DoubleClicked(MyShootActionEnum)](Sandbox.Game.Entities.MyHandToolBase@DoubleClicked)||
|[DrawHud(IMyCameraController, long, bool)](Sandbox.Game.Entities.MyHandToolBase@DrawHud)||
|[DrawHud(IMyCameraController, long)](Sandbox.Game.Entities.MyHandToolBase@DrawHud)||
|[EndShoot(MyShootActionEnum)](Sandbox.Game.Entities.MyHandToolBase@EndShoot)||
|[GetAmmunitionAmount()](Sandbox.Game.Entities.MyHandToolBase@GetAmmunitionAmount)||
|[GetMagazineAmount()](Sandbox.Game.Entities.MyHandToolBase@GetMagazineAmount)||
|[GetMuzzlePosition()](Sandbox.Game.Entities.MyHandToolBase@GetMuzzlePosition)||
|[GetObjectBuilder(bool)](Sandbox.Game.Entities.MyHandToolBase@GetObjectBuilder)||
|[GetReloadDuration()](Sandbox.Game.Entities.MyHandToolBase@GetReloadDuration)||
|[GetShakeOnAction(MyShootActionEnum)](Sandbox.Game.Entities.MyHandToolBase@GetShakeOnAction)||
|[GetShootDirection()](Sandbox.Game.Entities.MyHandToolBase@GetShootDirection)||
|[GetTotalAmmunitionAmount()](Sandbox.Game.Entities.MyHandToolBase@GetTotalAmmunitionAmount)||
|[Init(MyObjectBuilder_EntityBase)](Sandbox.Game.Entities.MyHandToolBase@Init)||
|[IsToolbarUsable()](Sandbox.Game.Entities.MyHandToolBase@IsToolbarUsable)||
|[OnControlAcquired(IMyCharacter)](Sandbox.Game.Entities.MyHandToolBase@OnControlAcquired)||
|[OnControlReleased()](Sandbox.Game.Entities.MyHandToolBase@OnControlReleased)||
|[PlayReloadSound()](Sandbox.Game.Entities.MyHandToolBase@PlayReloadSound)||
|[Reload()](Sandbox.Game.Entities.MyHandToolBase@Reload)||
|[Shoot(MyShootActionEnum, Vector3, Vector3D?, string)](Sandbox.Game.Entities.MyHandToolBase@Shoot)||
|[ShootFailReactionLocal(MyShootActionEnum, MyGunStatusEnum)](Sandbox.Game.Entities.MyHandToolBase@ShootFailReactionLocal)||
|[ShouldEndShootOnPause(MyShootActionEnum)](Sandbox.Game.Entities.MyHandToolBase@ShouldEndShootOnPause)||
|[StopShooting(MyEntity)](Sandbox.Game.Entities.MyHandToolBase@StopShooting)||
|[SupressShootAnimation()](Sandbox.Game.Entities.MyHandToolBase@SupressShootAnimation)||
|[UpdateAfterSimulation()](Sandbox.Game.Entities.MyHandToolBase@UpdateAfterSimulation)||
|[UpdateAfterSimulation10()](Sandbox.Game.Entities.MyHandToolBase@UpdateAfterSimulation10)||
|[UpdateSoundEmitter()](Sandbox.Game.Entities.MyHandToolBase@UpdateSoundEmitter)||
...
|[StopShooting(MyEntity)](Sandbox.Game.Entities.IStoppableAttackingTool@StopShooting)|_Inherited from [IStoppableAttackingTool](Sandbox.Game.Entities.IStoppableAttackingTool)_|
...
* [IMyGunObject<MyToolBase>](VRage.Game.ModAPI.IMyGunObject{MyToolBase})  
* [IMyHandheldGunObject<MyToolBase>](Sandbox.Game.Entities.IMyHandheldGunObject{MyToolBase})  
