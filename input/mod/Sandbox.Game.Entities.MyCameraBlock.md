...
|Member|Description|
|---|---|
|[static DUMMY_NAME_POSITION](Sandbox.Game.Entities.MyCameraBlock@DUMMY_NAME_POSITION)||
|[static ID_VIEW](Sandbox.Game.Entities.MyCameraBlock@ID_VIEW)||
...
|Member|Description|
|---|---|
|[BlockDefinition](Sandbox.Game.Entities.MyCameraBlock@BlockDefinition)||
|[EnableFirstPersonView](Sandbox.Game.Entities.MyCameraBlock@EnableFirstPersonView)||
|[EnableRaycast](Sandbox.Game.Entities.MyCameraBlock@EnableRaycast)||
|[Entity](Sandbox.Game.Entities.MyCameraBlock@Entity)||
|[ForceFirstPersonCamera](Sandbox.Game.Entities.MyCameraBlock@ForceFirstPersonCamera)||
|[IsActive](Sandbox.Game.Entities.MyCameraBlock@IsActive)||
|[IsInFirstPersonView](Sandbox.Game.Entities.MyCameraBlock@IsInFirstPersonView)||
...
|[AvailableScanRange](Sandbox.ModAPI.Ingame.IMyCameraBlock@AvailableScanRange)|Gets the maximum distance that this camera can scan, based on the time since the last scan.<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
...
|[EnableRaycast](Sandbox.ModAPI.Ingame.IMyCameraBlock@EnableRaycast)|Gets or Sets whether the raycast is enabled. When this is true, the available raycast distance will count up, and power usage is increased.<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
...
|[IsActive](Sandbox.ModAPI.Ingame.IMyCameraBlock@IsActive)|Gets whether this camera is currently in use by at least one player.<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
|[IsActiveLocal](Sandbox.ModAPI.IMyCameraBlock@IsActiveLocal)|Gets whether this camera is in use locally by theplayer. To determine ifplayer is controlling the camera, instead use [IsActive](Sandbox.ModAPI.Ingame.IMyCameraBlock@IsActive) .<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.IMyCameraBlock)_|
...
|[RaycastConeLimit](Sandbox.ModAPI.Ingame.IMyCameraBlock@RaycastConeLimit)|Gets the maximum positive angle you can apply for pitch and yaw.<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
|[RaycastDistanceLimit](Sandbox.ModAPI.Ingame.IMyCameraBlock@RaycastDistanceLimit)|Gets the maximum distance you can request a raycast. -1 means infinite.<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
|[RaycastTimeMultiplier](Sandbox.ModAPI.Ingame.IMyCameraBlock@RaycastTimeMultiplier)|Gets the raycast time multiplier that converts time in milliseconds to available raycast distance in meters.<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
...
|Member|Description|
|---|---|
|[MyCameraBlock()](Sandbox.Game.Entities.MyCameraBlock@.ctor)||

## Methods

|Member|Description|
|---|---|
|[CanUse()](Sandbox.Game.Entities.MyCameraBlock@CanUse)||
|[ChangeZoomPrecise(float)](Sandbox.Game.Entities.MyCameraBlock@ChangeZoomPrecise)||
|[CheckAngleLimits(Vector3D)](Sandbox.Game.Entities.MyCameraBlock@CheckAngleLimits)|Checks if the specified world direction relative to the camera is within the valid scanning range|
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyCameraBlock@GetObjectBuilderCubeBlock)||
|[GetOverridingFocusMatrix()](Sandbox.Game.Entities.MyCameraBlock@GetOverridingFocusMatrix)||
|[GetViewMatrix()](Sandbox.Game.Entities.MyCameraBlock@GetViewMatrix)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyCameraBlock@Init)||
|[OnActiveChanged(bool)](Sandbox.Game.Entities.MyCameraBlock@OnActiveChanged)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyCameraBlock@OnAddedToScene)||
|[OnAssumeControl(IMyCameraController)](Sandbox.Game.Entities.MyCameraBlock@OnAssumeControl)||
|[OnExitView()](Sandbox.Game.Entities.MyCameraBlock@OnExitView)||
|[OnReleaseControl(IMyCameraController)](Sandbox.Game.Entities.MyCameraBlock@OnReleaseControl)||
|[Raycast(double, Vector3D)](Sandbox.Game.Entities.MyCameraBlock@Raycast)||
|[RequestSetView()](Sandbox.Game.Entities.MyCameraBlock@RequestSetView)||
|[Rotate(Vector2, float)](Sandbox.Game.Entities.MyCameraBlock@Rotate)||
|[RotateStopped()](Sandbox.Game.Entities.MyCameraBlock@RotateStopped)||
|[SetEmissiveStateWorking()](Sandbox.Game.Entities.MyCameraBlock@SetEmissiveStateWorking)||
|[SetView()](Sandbox.Game.Entities.MyCameraBlock@SetView)||
|[UpdateAfterSimulation()](Sandbox.Game.Entities.MyCameraBlock@UpdateAfterSimulation)||
|[UpdateAfterSimulation10()](Sandbox.Game.Entities.MyCameraBlock@UpdateAfterSimulation10)||
...
|[CanScan(double)](Sandbox.ModAPI.Ingame.IMyCameraBlock@CanScan)|Checks if the camera can scan the given distance.<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
|[CanScan(double, Vector3D)](Sandbox.ModAPI.Ingame.IMyCameraBlock@CanScan)|Checks if the camera can scan to the given direction and distance (in camera local space).<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
|[CanScan(Vector3D)](Sandbox.ModAPI.Ingame.IMyCameraBlock@CanScan)|Checks if the camera can scan to the given target<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
...
|[Raycast(double, float, float)](Sandbox.ModAPI.Ingame.IMyCameraBlock@Raycast)|Does a raycast in the direction the camera is facing.<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
|[Raycast(Vector3D)](Sandbox.ModAPI.Ingame.IMyCameraBlock@Raycast)|Does a raycast to the specific target point.<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
|[Raycast(double, Vector3D)](Sandbox.ModAPI.Ingame.IMyCameraBlock@Raycast)|Does a raycast in the given direction (in camera local space).<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
...
|[TimeUntilScan(double)](Sandbox.ModAPI.Ingame.IMyCameraBlock@TimeUntilScan)|Calculates time until scan<br /><br />_Inherited from [IMyCameraBlock](Sandbox.ModAPI.Ingame.IMyCameraBlock)_|
