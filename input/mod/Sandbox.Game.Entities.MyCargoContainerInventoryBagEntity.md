...
```csharp
public class MyCargoContainerInventoryBagEntity: MyEntity, IMyEntity, IMyEntity, IMyInventoryBag, IMyDestroyableObject, IMySyncedEntity, IMyParallelUpdateable, IMyEventProxy, IMyEventOwner
```
...
|[CreationTime](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@CreationTime)||
...
|Member|Description|
|---|---|
|[GeneratedGravity](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@GeneratedGravity)||
|[Integrity](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@Integrity)||
|[SyncType](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@SyncType)||
|[UpdateFlags](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@UpdateFlags)||
|[UseDamageSystem](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@UseDamageSystem)||
...
|Member|Description|
|---|---|
|[MyCargoContainerInventoryBagEntity()](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@.ctor)||
...
|[DoDamage(float, MyStringHash, bool, long, MyStringHash?)](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@DoDamage)||
|[GetObjectBuilder(bool)](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@GetObjectBuilder)||
|[Init(MyObjectBuilder_EntityBase)](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@Init)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@OnAddedToScene)||
|[OnDestroy()](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@OnDestroy)||
|[OnReplicationEnded()](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@OnReplicationEnded)||
|[OnReplicationStarted()](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@OnReplicationStarted)||
|[SendCloseRequest()](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@SendCloseRequest)||
|[UpdateAfterSimulation100()](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@UpdateAfterSimulation100)||
|[UpdateAfterSimulationParallel()](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@UpdateAfterSimulationParallel)||
|[UpdateBeforeSimulationParallel()](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@UpdateBeforeSimulationParallel)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyCargoContainerInventoryBagEntity@UpdateOnceBeforeFrame)||
