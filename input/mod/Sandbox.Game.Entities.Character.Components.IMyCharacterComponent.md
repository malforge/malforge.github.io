...
|Member|Description|
|---|---|
|[Character](Sandbox.Game.Entities.Character.Components.IMyCharacterComponent@Character)||

## Methods

|Member|Description|
|---|---|
|[OnCharacterDead()](Sandbox.Game.Entities.Character.Components.IMyCharacterComponent@OnCharacterDead)||
