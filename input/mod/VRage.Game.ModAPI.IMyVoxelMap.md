...
|Member|Description|
|---|---|
|[ClampVoxelCoord(ref Vector3I)](VRage.Game.ModAPI.IMyVoxelMap@ClampVoxelCoord)||
|[Close()](VRage.Game.ModAPI.IMyVoxelMap@Close)||
|[DoOverlapSphereTest(float, Vector3D)](VRage.Game.ModAPI.IMyVoxelMap@DoOverlapSphereTest)||
|[GetIntersectionWithSphere(ref BoundingSphereD)](VRage.Game.ModAPI.IMyVoxelMap@GetIntersectionWithSphere)||
|[GetObjectBuilder(bool)](VRage.Game.ModAPI.IMyVoxelMap@GetObjectBuilder)||
|[GetVoxelContentInBoundingBox(BoundingBoxD, out float)](VRage.Game.ModAPI.IMyVoxelMap@GetVoxelContentInBoundingBox)||
|[GetVoxelCoordinateFromMeters(Vector3D)](VRage.Game.ModAPI.IMyVoxelMap@GetVoxelCoordinateFromMeters)||
|[Init(MyObjectBuilder_EntityBase)](VRage.Game.ModAPI.IMyVoxelMap@Init)||
