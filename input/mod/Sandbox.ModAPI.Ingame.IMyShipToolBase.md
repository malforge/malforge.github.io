...
|Member|Description|
|---|---|
|[IsActivated](Sandbox.ModAPI.Ingame.IMyShipToolBase@IsActivated)|True if the tool is activated by mouse click or toggling via terminal.|
|[UseConveyorSystem](Sandbox.ModAPI.Ingame.IMyShipToolBase@UseConveyorSystem)|Gets or sets if block should push/pull items from conveyor system|
...
* MyObjectBuilder_ShipGrinder/LargeShipGrinderReskin  
* MyObjectBuilder_ShipGrinder/SmallShipGrinder  
* MyObjectBuilder_ShipGrinder/SmallShipGrinderReskin  
