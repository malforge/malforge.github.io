...
|[NormalizedPosition](Sandbox.ModAPI.Ingame.IMyPistonBase@NormalizedPosition)|Gets the current position normalized between MinLimit and MaxLimit<br /><br />_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
...
|[MoveToPosition(float, float)](Sandbox.ModAPI.Ingame.IMyPistonBase@MoveToPosition)|Sets velocity and limits to move the piston to the specified extent value<br /><br />_Inherited from [IMyPistonBase](Sandbox.ModAPI.Ingame.IMyPistonBase)_|
...
* MyObjectBuilder_ExtendedPistonBase/LargePistonBaseReskin  
* MyObjectBuilder_ExtendedPistonBase/SmallPistonBase  
* MyObjectBuilder_ExtendedPistonBase/SmallPistonBaseReskin
