...
```csharp
public abstract class MyGravityProviderComponent: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase, IMyGravityProvider
```
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](Sandbox.Game.Entities.MyGravityProviderComponent@ComponentTypeDebugString)||
|[GravityLimit](Sandbox.Game.Entities.MyGravityProviderComponent@GravityLimit)||
|[IsWorking](Sandbox.Game.Entities.MyGravityProviderComponent@IsWorking)||
...
|Member|Description|
|---|---|
|[DoesTrajectoryIntersectNaturalGravity(RayD, double)](Sandbox.Game.Entities.MyGravityProviderComponent@DoesTrajectoryIntersectNaturalGravity)||
|[GetGravityMultiplier(Vector3D)](Sandbox.Game.Entities.MyGravityProviderComponent@GetGravityMultiplier)||
|[GetProxyAABB(out BoundingBoxD)](Sandbox.Game.Entities.MyGravityProviderComponent@GetProxyAABB)||
|[GetWorldGravity(Vector3D)](Sandbox.Game.Entities.MyGravityProviderComponent@GetWorldGravity)||
|[GetWorldGravityNormalized(ref Vector3D)](Sandbox.Game.Entities.MyGravityProviderComponent@GetWorldGravityNormalized)||
|[IsPositionInRange(Vector3D)](Sandbox.Game.Entities.MyGravityProviderComponent@IsPositionInRange)||
