...
```csharp
public class MyObjectBuilder_RepairServiceComponentDefinition: MyObjectBuilder_ComponentDefinitionBase
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_RepairServiceComponentDefinition()](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_RepairServiceComponentDefinition@.ctor)||
