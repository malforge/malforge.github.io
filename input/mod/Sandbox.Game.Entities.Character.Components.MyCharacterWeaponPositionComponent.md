...
```csharp
public class MyCharacterWeaponPositionComponent: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[ArmsIkWeight](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@ArmsIkWeight)||
|[Character](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@Character)||
|[ComponentTypeDebugString](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@ComponentTypeDebugString)||
|[GraphicalPositionWorld](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@GraphicalPositionWorld)||
|[IsInIronSight](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@IsInIronSight)||
|[IsShooting](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@IsShooting)||
|[LogicalCrosshairPoint](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@LogicalCrosshairPoint)||
|[LogicalOrientationWorld](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@LogicalOrientationWorld)||
|[LogicalPositionLocalSpace](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@LogicalPositionLocalSpace)||
|[LogicalPositionWorld](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@LogicalPositionWorld)||
|[ShouldSupressShootAnimation](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@ShouldSupressShootAnimation)||
...
|Member|Description|
|---|---|
|[MyCharacterWeaponPositionComponent()](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[AddBackkick(float)](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@AddBackkick)||
|[Init(MyObjectBuilder_Character)](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@Init)|Initialize from character object builder.|
|[Update(bool)](Sandbox.Game.Entities.Character.Components.MyCharacterWeaponPositionComponent@Update)|Update weapon position, either logical and graphical.|
