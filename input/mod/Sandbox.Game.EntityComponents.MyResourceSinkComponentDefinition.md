...
```csharp
public class MyResourceSinkComponentDefinition: MyComponentDefinitionBase
```
...
|Member|Description|
|---|---|
|[PowerConsumption](Sandbox.Game.EntityComponents.MyResourceSinkComponentDefinition@PowerConsumption)||
|[ResourceSinkGroup](Sandbox.Game.EntityComponents.MyResourceSinkComponentDefinition@ResourceSinkGroup)||
...
|Member|Description|
|---|---|
|[MyResourceSinkComponentDefinition()](Sandbox.Game.EntityComponents.MyResourceSinkComponentDefinition@.ctor)||
