...
|Member|Description|
|---|---|
|[static Enabled](VRage.Game.MyParticlesManager@Enabled)||
|[static CalculateGravityInPoint](VRage.Game.MyParticlesManager@CalculateGravityInPoint)|_**Obsolete:** Use MyGravityProviderSystem or IMyPhysics instead_|
...
|Member|Description|
|---|---|
|[static CurrentTime](VRage.Game.MyParticlesManager@CurrentTime)||
|[static Effects](VRage.Game.MyParticlesManager@Effects)||
|[static InstanceCount](VRage.Game.MyParticlesManager@InstanceCount)||
|[static Paused](VRage.Game.MyParticlesManager@Paused)||
...
|Member|Description|
|---|---|
|[MyParticlesManager()](VRage.Game.MyParticlesManager@.ctor)||
...
|Member|Description|
|---|---|
|[static OnRemoved(uint)](VRage.Game.MyParticlesManager@OnRemoved)||
|[static RemoveParticleEffect(MyParticleEffect)](VRage.Game.MyParticlesManager@RemoveParticleEffect)||
|[static ScheduleUpdate(MyParticleEffect)](VRage.Game.MyParticlesManager@ScheduleUpdate)||
|[static TryCreateParticleEffect(string, ref MatrixD, ref Vector3D, uint, out MyParticleEffect, int)](VRage.Game.MyParticlesManager@TryCreateParticleEffect)||
|[static TryCreateParticleEffect(string, ref MatrixD, ref Vector3D, uint, out MyParticleEffect)](VRage.Game.MyParticlesManager@TryCreateParticleEffect)||
|[static TryCreateParticleEffect(int, out MyParticleEffect, ref MatrixD, ref Vector3D, uint, bool)](VRage.Game.MyParticlesManager@TryCreateParticleEffect)||
|[static TryCreateParticleEffect(string, out MyParticleEffect)](VRage.Game.MyParticlesManager@TryCreateParticleEffect)|_**Obsolete:** Use TryCreateParticleEffect with parenting instead_|
|[static TryCreateParticleEffect(string, MatrixD, out MyParticleEffect)](VRage.Game.MyParticlesManager@TryCreateParticleEffect)|_**Obsolete:** Use TryCreateParticleEffect with parenting instead_|
|[static TryCreateParticleEffect(int, out MyParticleEffect, bool)](VRage.Game.MyParticlesManager@TryCreateParticleEffect)|_**Obsolete:** Use TryCreateParticleEffect with parenting instead_|
|[LoadData()](VRage.Game.MyParticlesManager@LoadData)||
|[RecreateParticleEffects(MyParticleEffectData)](VRage.Game.MyParticlesManager@RecreateParticleEffects)||
|[RemoveParticleEffects(MyParticleEffectData)](VRage.Game.MyParticlesManager@RemoveParticleEffects)||
|[UpdateAfterSimulation()](VRage.Game.MyParticlesManager@UpdateAfterSimulation)||
...
* IParticleManager <sub>prohibited</sub>
