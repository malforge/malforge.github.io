...
|Member|Description|
|---|---|
|[RepairAmount](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_RepairBlueprintDefinition@RepairAmount)||
...
|[BaseProductionTimeInSeconds](VRage.Game.MyObjectBuilder_BlueprintDefinition@BaseProductionTimeInSeconds)|Base production time in seconds, which is affected by speed increase of refinery or assembler.<br /><br />_Inherited from [MyObjectBuilder_BlueprintDefinition](VRage.Game.MyObjectBuilder_BlueprintDefinition)_|
...
|[IgnoreEfficiencyMultiplier](VRage.Game.MyObjectBuilder_BlueprintDefinition@IgnoreEfficiencyMultiplier)|_Inherited from [MyObjectBuilder_BlueprintDefinition](VRage.Game.MyObjectBuilder_BlueprintDefinition)_|
|[IsPrimary](VRage.Game.MyObjectBuilder_BlueprintDefinition@IsPrimary)|_Inherited from [MyObjectBuilder_BlueprintDefinition](VRage.Game.MyObjectBuilder_BlueprintDefinition)_|
|[Prerequisites](VRage.Game.MyObjectBuilder_BlueprintDefinition@Prerequisites)|_Inherited from [MyObjectBuilder_BlueprintDefinition](VRage.Game.MyObjectBuilder_BlueprintDefinition)_|
|[Priority](VRage.Game.MyObjectBuilder_BlueprintDefinition@Priority)|_Inherited from [MyObjectBuilder_BlueprintDefinition](VRage.Game.MyObjectBuilder_BlueprintDefinition)_|
|[ProgressBarSoundCue](VRage.Game.MyObjectBuilder_BlueprintDefinition@ProgressBarSoundCue)|_Inherited from [MyObjectBuilder_BlueprintDefinition](VRage.Game.MyObjectBuilder_BlueprintDefinition)_|
...
|[Result](VRage.Game.MyObjectBuilder_BlueprintDefinition@Result)|THIS IS OBSOLETE<br /><br />_Inherited from [MyObjectBuilder_BlueprintDefinition](VRage.Game.MyObjectBuilder_BlueprintDefinition)_|
|[Results](VRage.Game.MyObjectBuilder_BlueprintDefinition@Results)|_Inherited from [MyObjectBuilder_BlueprintDefinition](VRage.Game.MyObjectBuilder_BlueprintDefinition)_|
...
|Member|Description|
|---|---|
|[MyObjectBuilder_RepairBlueprintDefinition()](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_RepairBlueprintDefinition@.ctor)||
|[MyObjectBuilder_BlueprintDefinition()](VRage.Game.MyObjectBuilder_BlueprintDefinition@.ctor)|_Inherited from [MyObjectBuilder_BlueprintDefinition](VRage.Game.MyObjectBuilder_BlueprintDefinition)_|
...
**Inheritance:**   [MyObjectBuilder_Base](VRage.ObjectBuilders.MyObjectBuilder_Base) ˃ [MyObjectBuilder_DefinitionBase](VRage.Game.MyObjectBuilder_DefinitionBase) ˃ [MyObjectBuilder_BlueprintDefinition](VRage.Game.MyObjectBuilder_BlueprintDefinition)
