...
```csharp
public class MyKitchen: MyCubeBlock, IMyEntity, IMyEntity, IMyComponentOwner<MyIDModule>, IMyCubeBlock, IMyCubeBlock, IMyUpgradableBlock, IMyUpgradableBlock
```
...
|Member|Description|
|---|---|
|[MyKitchen()](Sandbox.Game.Entities.MyKitchen@.ctor)||
