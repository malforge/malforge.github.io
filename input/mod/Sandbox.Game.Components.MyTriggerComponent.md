...
```csharp
public class MyTriggerComponent: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[Center](Sandbox.Game.Components.MyTriggerComponent@Center)|Trigger BB center position.|
|[ComponentTypeDebugString](Sandbox.Game.Components.MyTriggerComponent@ComponentTypeDebugString)||
|[CustomDebugColor](Sandbox.Game.Components.MyTriggerComponent@CustomDebugColor)||
|[Enabled](Sandbox.Game.Components.MyTriggerComponent@Enabled)||
|[OBB](Sandbox.Game.Components.MyTriggerComponent@OBB)||
|[TriggerAreaType](Sandbox.Game.Components.MyTriggerComponent@TriggerAreaType)||
|[UpdateFrequency](Sandbox.Game.Components.MyTriggerComponent@UpdateFrequency)||
...
|Member|Description|
|---|---|
|[MyTriggerComponent(TriggerType, uint)](Sandbox.Game.Components.MyTriggerComponent@.ctor)||
|[MyTriggerComponent()](Sandbox.Game.Components.MyTriggerComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[Contains(Vector3D)](Sandbox.Game.Components.MyTriggerComponent@Contains)||
|[DebugDraw()](Sandbox.Game.Components.MyTriggerComponent@DebugDraw)||
|[Deserialize(MyObjectBuilder_ComponentBase)](Sandbox.Game.Components.MyTriggerComponent@Deserialize)||
|[Dispose()](Sandbox.Game.Components.MyTriggerComponent@Dispose)|Override for custom trigger disposal before removing.|
|[IsSerialized()](Sandbox.Game.Components.MyTriggerComponent@IsSerialized)||
|[OnAddedToContainer()](Sandbox.Game.Components.MyTriggerComponent@OnAddedToContainer)||
|[OnAddedToScene()](Sandbox.Game.Components.MyTriggerComponent@OnAddedToScene)||
|[OnBeforeRemovedFromContainer()](Sandbox.Game.Components.MyTriggerComponent@OnBeforeRemovedFromContainer)||
|[OnRemovedFromScene()](Sandbox.Game.Components.MyTriggerComponent@OnRemovedFromScene)||
|[Serialize(bool)](Sandbox.Game.Components.MyTriggerComponent@Serialize)||
|[Update()](Sandbox.Game.Components.MyTriggerComponent@Update)||
