...
|Member|Description|
|---|---|
|[AngleAllowedToShoot](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@AngleAllowedToShoot)||
|[DefaultMaximalDistance](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@DefaultMaximalDistance)||
|[DefaultMinimalDistance](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@DefaultMinimalDistance)||
|[EvasiveManeuverDistance](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@EvasiveManeuverDistance)||
|[MaxMaximalDistance](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@MaxMaximalDistance)||
|[MaxMinimalDistance](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@MaxMinimalDistance)||
|[MinMaximalDistance](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@MinMaximalDistance)||
|[MinMinimalDistance](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@MinMinimalDistance)||
|[UniqueSelectionId](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@UniqueSelectionId)||
|[UpdateIntervalInFrames](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@UpdateIntervalInFrames)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_OffensiveCombatStayAtRangeDefinition()](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_OffensiveCombatStayAtRangeDefinition@.ctor)||
