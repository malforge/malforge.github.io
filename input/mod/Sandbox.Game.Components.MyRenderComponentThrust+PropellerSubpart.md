...
```csharp
public class PropellerSubpart: MyCustomRenderEntitySubpart<MyPropellerRenderComponent>, IMyEntity, IMyEntity
```
...
|Member|Description|
|---|---|
|[PropellerSubpart()](Sandbox.Game.Components.MyRenderComponentThrust+PropellerSubpart@.ctor)||
...
**Inheritance:**   [MyCustomRenderEntitySubpart](Sandbox.Game.Entities.MyCustomRenderEntitySubpart{MyPropellerRenderComponent})
