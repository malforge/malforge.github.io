...
```csharp
public class MyEntityReferenceComponent: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```

Reference counting component for entities. Allows simplified management of short lived entities that may be shared amongst systems. The count is initially 0 so the first referencee becomes the owner of the entity (this is sometimes called a floating reference).
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyEntityReferenceComponent@ComponentTypeDebugString)||
...
|Member|Description|
|---|---|
|[MyEntityReferenceComponent()](Sandbox.Game.EntityComponents.MyEntityReferenceComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[Ref()](Sandbox.Game.EntityComponents.MyEntityReferenceComponent@Ref)|Increase the reference count of this entity.|
|[Unref()](Sandbox.Game.EntityComponents.MyEntityReferenceComponent@Unref)|Decrease the entitie's reference count.|
