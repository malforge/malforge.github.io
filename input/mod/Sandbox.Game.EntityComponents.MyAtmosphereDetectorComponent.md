...
```csharp
public class MyAtmosphereDetectorComponent: MyUpdatingEntityComponent, IMyComponentBase, IMyEntityComponentBase, IMyEventProxy, IMyEventOwner, IMyUpdatingEntityComponent
```
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyAtmosphereDetectorComponent@ComponentTypeDebugString)||
|[InAtmosphere](Sandbox.Game.EntityComponents.MyAtmosphereDetectorComponent@InAtmosphere)||
|[InShipOrStation](Sandbox.Game.EntityComponents.MyAtmosphereDetectorComponent@InShipOrStation)||
|[InVoid](Sandbox.Game.EntityComponents.MyAtmosphereDetectorComponent@InVoid)||
...
|Member|Description|
|---|---|
|[MyAtmosphereDetectorComponent()](Sandbox.Game.EntityComponents.MyAtmosphereDetectorComponent@.ctor)||
...
|Member|Description|
|---|---|
|[InitComponent(bool, MyCharacter)](Sandbox.Game.EntityComponents.MyAtmosphereDetectorComponent@InitComponent)||
|[UpdateBeforeSimulation100()](Sandbox.Game.EntityComponents.MyAtmosphereDetectorComponent@UpdateBeforeSimulation100)||
