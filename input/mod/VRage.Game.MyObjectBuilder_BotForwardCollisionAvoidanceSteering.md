...
```csharp
public class MyObjectBuilder_BotForwardCollisionAvoidanceSteering: MyObjectBuilder_BotSteeringBase
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_BotForwardCollisionAvoidanceSteering()](VRage.Game.MyObjectBuilder_BotForwardCollisionAvoidanceSteering@.ctor)||
