...
```csharp
public abstract class MyPositionComponentBase: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[static OnReportInvalidMatrix](VRage.Game.Components.MyPositionComponentBase@OnReportInvalidMatrix)||
|[m_lastParentWorldMatrixCounter](VRage.Game.Components.MyPositionComponentBase@m_lastParentWorldMatrixCounter)||
|[m_worldMatrixCounter](VRage.Game.Components.MyPositionComponentBase@m_worldMatrixCounter)||
|[m_worldMatrixDirty](VRage.Game.Components.MyPositionComponentBase@m_worldMatrixDirty)||
...
|[OnLocalAABBChanged](VRage.Game.Components.MyPositionComponentBase@OnLocalAABBChanged)||
|[OnPositionChanged](VRage.Game.Components.MyPositionComponentBase@OnPositionChanged)||
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](VRage.Game.Components.MyPositionComponentBase@ComponentTypeDebugString)||
|[LocalAABB](VRage.Game.Components.MyPositionComponentBase@LocalAABB)|Sets the local aabb.|
|[LocalMatrixRef](VRage.Game.Components.MyPositionComponentBase@LocalMatrixRef)|Gets or sets the local matrix.|
|[LocalVolume](VRage.Game.Components.MyPositionComponentBase@LocalVolume)|Sets the local volume.|
|[LocalVolumeOffset](VRage.Game.Components.MyPositionComponentBase@LocalVolumeOffset)|Gets or sets the local volume offset.|
|[NeedsRecalculateWorldMatrix](VRage.Game.Components.MyPositionComponentBase@NeedsRecalculateWorldMatrix)||
|[Scale](VRage.Game.Components.MyPositionComponentBase@Scale)||
|[WorldAABB](VRage.Game.Components.MyPositionComponentBase@WorldAABB)|Gets the world aabb.|
|[WorldMatrixInvScaled](VRage.Game.Components.MyPositionComponentBase@WorldMatrixInvScaled)||
|[WorldMatrixNormalizedInv](VRage.Game.Components.MyPositionComponentBase@WorldMatrixNormalizedInv)||
|[WorldMatrixRef](VRage.Game.Components.MyPositionComponentBase@WorldMatrixRef)|World matrix of this physic object. Use it whenever you want to do world-matrix transformations with this physic objects.|
|[WorldVolume](VRage.Game.Components.MyPositionComponentBase@WorldVolume)|Gets the world volume.|
...
|[LocalMatrix](VRage.Game.Components.MyPositionComponentBase@LocalMatrix)|_**Obsolete:** Deprecated, use LocalMatrixRef instead._|
|[WorldMatrix](VRage.Game.Components.MyPositionComponentBase@WorldMatrix)|_**Obsolete:** Deprecated, use WorldMatrixRef instead._|

## Methods

|Member|Description|
|---|---|
|[GetOrientation()](VRage.Game.Components.MyPositionComponentBase@GetOrientation)|Gets the entity orientation.|
|[GetPosition()](VRage.Game.Components.MyPositionComponentBase@GetPosition)|Gets the entity position.|
|[GetViewMatrix()](VRage.Game.Components.MyPositionComponentBase@GetViewMatrix)||
|[OnAddedToContainer()](VRage.Game.Components.MyPositionComponentBase@OnAddedToContainer)||
|[OnBeforeRemovedFromContainer()](VRage.Game.Components.MyPositionComponentBase@OnBeforeRemovedFromContainer)||
|[SetLocalMatrix(ref Matrix, object, bool, ref Matrix, bool)](VRage.Game.Components.MyPositionComponentBase@SetLocalMatrix)||
|[SetLocalMatrix(ref Matrix, object, bool)](VRage.Game.Components.MyPositionComponentBase@SetLocalMatrix)||
|[SetPosition(Vector3D, object, bool, bool)](VRage.Game.Components.MyPositionComponentBase@SetPosition)|Sets the position.|
|[SetWorldMatrix(ref MatrixD, object, bool, bool, bool, bool, bool, bool)](VRage.Game.Components.MyPositionComponentBase@SetWorldMatrix)|Sets the world matrix.|
|[ToString()](VRage.Game.Components.MyPositionComponentBase@ToString)||
|[UpdateWorldMatrix(ref MatrixD, object, bool, bool)](VRage.Game.Components.MyPositionComponentBase@UpdateWorldMatrix)|Updates the world matrix (change caused by parent)|
...
|[SetWorldMatrix(MatrixD, object, bool, bool, bool, bool, bool, bool)](VRage.Game.Components.MyPositionComponentBase@SetWorldMatrix)|_**Obsolete:** SetWorldMatrix(MatrixD,...) is deprecated, please use SetWorldMatrix(ref MatrixD,...) instead._|
