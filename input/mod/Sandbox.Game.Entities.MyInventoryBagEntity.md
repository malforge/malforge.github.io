...
```csharp
public class MyInventoryBagEntity: MyEntity, IMyEntity, IMyEntity, IMyInventoryBag
```
...
|[OwnerIdentityId](Sandbox.Game.Entities.MyInventoryBagEntity@OwnerIdentityId)||
...
|Member|Description|
|---|---|
|[GeneratedGravity](Sandbox.Game.Entities.MyInventoryBagEntity@GeneratedGravity)||
...
|Member|Description|
|---|---|
|[MyInventoryBagEntity()](Sandbox.Game.Entities.MyInventoryBagEntity@.ctor)||
...
|[GetObjectBuilder(bool)](Sandbox.Game.Entities.MyInventoryBagEntity@GetObjectBuilder)||
|[Init(MyObjectBuilder_EntityBase)](Sandbox.Game.Entities.MyInventoryBagEntity@Init)||
|[OnReplicationEnded()](Sandbox.Game.Entities.MyInventoryBagEntity@OnReplicationEnded)||
|[OnReplicationStarted()](Sandbox.Game.Entities.MyInventoryBagEntity@OnReplicationStarted)||
|[UpdateAfterSimulation()](Sandbox.Game.Entities.MyInventoryBagEntity@UpdateAfterSimulation)||
|[UpdateAfterSimulation100()](Sandbox.Game.Entities.MyInventoryBagEntity@UpdateAfterSimulation100)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyInventoryBagEntity@UpdateOnceBeforeFrame)||
