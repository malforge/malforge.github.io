...
```csharp
public interface IMyGyro: IMyGyro, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity
```
...
|Member|Description|
|---|---|
|[GyroStrengthMultiplier](Sandbox.ModAPI.IMyGyro@GyroStrengthMultiplier)|Gets or sets multiplier for max gyro strength|
|[PowerConsumptionMultiplier](Sandbox.ModAPI.IMyGyro@PowerConsumptionMultiplier)|Gets or sets multiplier gyro power consumption|
