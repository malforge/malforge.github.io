...
|[static m_emissiveNames](Sandbox.Game.Entities.MyCubeBlock@m_emissiveNames)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[static MAX_CUSTOM_NAME_LENGTH](Sandbox.Game.Entities.MyCubeBlock@MAX_CUSTOM_NAME_LENGTH)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[CurrentAttachedUpgradeModules](Sandbox.Game.Entities.MyCubeBlock@CurrentAttachedUpgradeModules)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[HandleEmissiveStateChange](Sandbox.Game.Entities.MyCubeBlock@HandleEmissiveStateChange)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[InitSkinUpdateHandled](Sandbox.Game.Entities.MyCubeBlock@InitSkinUpdateHandled)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[IsBeingRemoved](Sandbox.Game.Entities.MyCubeBlock@IsBeingRemoved)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[SilenceInChange](Sandbox.Game.Entities.MyCubeBlock@SilenceInChange)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[SlimBlock](Sandbox.Game.Entities.MyCubeBlock@SlimBlock)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[UsedUpdateEveryFrame](Sandbox.Game.Entities.MyCubeBlock@UsedUpdateEveryFrame)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[CanContinueBuildCheck](Sandbox.Game.Entities.MyCubeBlock@CanContinueBuildCheck)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[CheckConnectionChanged](Sandbox.Game.Entities.MyCubeBlock@CheckConnectionChanged)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[CubeGridChanged](Sandbox.Game.Entities.MyCubeBlock@CubeGridChanged)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[GetEmissiveStateHashFromComponent](Sandbox.Game.Entities.MyCubeBlock@GetEmissiveStateHashFromComponent)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[GetIsWorking](Sandbox.Game.Entities.MyCubeBlock@GetIsWorking)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[IsWorkingChanged](Sandbox.Game.Entities.MyCubeBlock@IsWorkingChanged)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[OnBlockDisableUpdates](Sandbox.Game.Entities.MyCubeBlock@OnBlockDisableUpdates)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[OnBlockModelChange](Sandbox.Game.Entities.MyCubeBlock@OnBlockModelChange)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[OnBlockRegisteredToGridSystems](Sandbox.Game.Entities.MyCubeBlock@OnBlockRegisteredToGridSystems)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[OnBlockUpdateVisual](Sandbox.Game.Entities.MyCubeBlock@OnBlockUpdateVisual)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnUpdateBeforenextFrame](Sandbox.Game.Entities.MyCubeBlock@OnUpdateBeforenextFrame)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnUpgradeValuesChanged](Sandbox.Game.Entities.MyCubeBlock@OnUpgradeValuesChanged)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|Member|Description|
|---|---|
|[ConveyorSegment](Sandbox.Game.Entities.MyConveyorConnector@ConveyorSegment)||
|[MaxGlassDistSq](Sandbox.Game.Entities.MyConveyorConnector@MaxGlassDistSq)||
...
|[BlockDefinition](Sandbox.Game.Entities.MyCubeBlock@BlockDefinition)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[BuiltBy](Sandbox.Game.Entities.MyCubeBlock@BuiltBy)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[CheckConnectionAllowed](Sandbox.Game.Entities.MyCubeBlock@CheckConnectionAllowed)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[CubeGrid](Sandbox.Game.Entities.MyCubeBlock@CubeGrid)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[DefinitionDisplayNameText](Sandbox.Game.Entities.MyCubeBlock@DefinitionDisplayNameText)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[DisassembleRatio](Sandbox.Game.Entities.MyCubeBlock@DisassembleRatio)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[ForceBlockDestructible](Sandbox.Game.Entities.MyCubeBlock@ForceBlockDestructible)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[HighlightMode](Sandbox.Game.Entities.MyCubeBlock@HighlightMode)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[IDModule](Sandbox.Game.Entities.MyCubeBlock@IDModule)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[IsBeingHacked](Sandbox.Game.Entities.MyCubeBlock@IsBeingHacked)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[IsBuilt](Sandbox.Game.Entities.MyCubeBlock@IsBuilt)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[IsFunctional](Sandbox.Game.Entities.MyCubeBlock@IsFunctional)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[IsSubBlock](Sandbox.Game.Entities.MyCubeBlock@IsSubBlock)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[IsTransparentForJumpDrive](Sandbox.Game.Entities.MyCubeBlock@IsTransparentForJumpDrive)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[IsWorking](Sandbox.Game.Entities.MyCubeBlock@IsWorking)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[Max](Sandbox.Game.Entities.MyCubeBlock@Max)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[Min](Sandbox.Game.Entities.MyCubeBlock@Min)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[NumberInGrid](Sandbox.Game.Entities.MyCubeBlock@NumberInGrid)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[Orientation](Sandbox.Game.Entities.MyCubeBlock@Orientation)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[OwnerBlock](Sandbox.Game.Entities.MyCubeBlock@OwnerBlock)|If the block is subblock then OwnerBlock is set to block which owns (spawns) subblocks (subgrids)<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OwnerId](Sandbox.Game.Entities.MyCubeBlock@OwnerId)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[Physics](Sandbox.Game.Entities.MyCubeBlock@Physics)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[Position](Sandbox.Game.Entities.MyCubeBlock@Position)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[ResourceSink](Sandbox.Game.Entities.MyCubeBlock@ResourceSink)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[SubBlockName](Sandbox.Game.Entities.MyCubeBlock@SubBlockName)|Name of subblock (key in the owner's subblocks map).<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[UpgradeValues](Sandbox.Game.Entities.MyCubeBlock@UpgradeValues)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[UseObjectsComponent](Sandbox.Game.Entities.MyCubeBlock@UseObjectsComponent)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[UsesEmissivePreset](Sandbox.Game.Entities.MyCubeBlock@UsesEmissivePreset)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|Member|Description|
|---|---|
|[MyConveyorConnector()](Sandbox.Game.Entities.MyConveyorConnector@.ctor)||
|[MyCubeBlock()](Sandbox.Game.Entities.MyCubeBlock@.ctor)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|Member|Description|
|---|---|
|[static GetBlockGridOffset(MyCubeBlockDefinition)](Sandbox.Game.Entities.MyCubeBlock@GetBlockGridOffset)|Returns block offset in spawned grid.<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyConveyorConnector@Init)||
|[InitializeConveyorSegment()](Sandbox.Game.Entities.MyConveyorConnector@InitializeConveyorSegment)||
|[OnLineWorkingStateUpdate(MyConveyorLine)](Sandbox.Game.Entities.MyConveyorConnector@OnLineWorkingStateUpdate)||
|[OnRemovedFromScene(object)](Sandbox.Game.Entities.MyConveyorConnector@OnRemovedFromScene)||
|[SetEmissiveStateDisabled()](Sandbox.Game.Entities.MyConveyorConnector@SetEmissiveStateDisabled)||
|[SetEmissiveStateWorking()](Sandbox.Game.Entities.MyConveyorConnector@SetEmissiveStateWorking)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyConveyorConnector@UpdateOnceBeforeFrame)||
...
|[AddUpgradeValue(string, float)](Sandbox.Game.Entities.MyCubeBlock@AddUpgradeValue)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[CalcLocalMatrix(out Matrix, out string)](Sandbox.Game.Entities.MyCubeBlock@CalcLocalMatrix)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[CalculateCurrentModel(out Matrix)](Sandbox.Game.Entities.MyCubeBlock@CalculateCurrentModel)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[CanContinueBuild()](Sandbox.Game.Entities.MyCubeBlock@CanContinueBuild)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[ChangeBlockOwnerRequest(long, MyOwnershipShareModeEnum)](Sandbox.Game.Entities.MyCubeBlock@ChangeBlockOwnerRequest)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[ChangeOwner(long, MyOwnershipShareModeEnum)](Sandbox.Game.Entities.MyCubeBlock@ChangeOwner)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[CheckEmissiveState(bool)](Sandbox.Game.Entities.MyCubeBlock@CheckEmissiveState)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[CommitUpgradeValues()](Sandbox.Game.Entities.MyCubeBlock@CommitUpgradeValues)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[ConnectionAllowed(ref Vector3I, ref Vector3I, MyCubeBlockDefinition)](Sandbox.Game.Entities.MyCubeBlock@ConnectionAllowed)|Returns true if this block can connect to another block (of the given type) in the given position. This is called only if CheckConnectionAllowed == true. If this method would return true for any position, set CheckConnectionAllowed to false to avoid unnecessary overhead. It is the block's responsibility to call CubeGrid.UpdateBlockNeighbors every time the conditions that are checked by this method change.<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[ConnectionAllowed(ref Vector3I, ref Vector3I, ref Vector3I, MyCubeBlockDefinition)](Sandbox.Game.Entities.MyCubeBlock@ConnectionAllowed)|Whether connection is allowed to any of the positions between otherBlockMinPos and otherBlockMaxPos (both inclusive). Default implementation calls ConnectionAllowed(ref Vector3I otherBlockPos, ref Vector3I faceNormal) in a for loop. Override this in a subclass if this is not needed (for example, because all calls would return the same value for the same face)<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[ContactPointCallback(ref MyGridContactInfo)](Sandbox.Game.Entities.MyCubeBlock@ContactPointCallback)|Return true when contact is valid<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[CreateRenderer(MyPersistentEntityFlags2, Vector3, object)](Sandbox.Game.Entities.MyCubeBlock@CreateRenderer)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[DisableUpdates()](Sandbox.Game.Entities.MyCubeBlock@DisableUpdates)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[FriendlyWithBlock(MyCubeBlock)](Sandbox.Game.Entities.MyCubeBlock@FriendlyWithBlock)|Whether the two blocks are friendly. This relation is base on their owners and is symmetrical<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[GetComponent()](Sandbox.Game.Entities.MyCubeBlock@GetComponent)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[GetGeometryLocalBox()](Sandbox.Game.Entities.MyCubeBlock@GetGeometryLocalBox)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[GetHudParams(bool)](VRage.Game.Entity.MyEntity@GetHudParams)|_Inherited from [MyEntity](VRage.Game.Entity.MyEntity)_|
|[GetInteractiveObject(uint)](Sandbox.Game.Entities.MyCubeBlock@GetInteractiveObject)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[GetIntersectionWithLine(ref LineD, out MyIntersectionResultLineTriangleEx?, IntersectionFlags)](Sandbox.Game.Entities.MyCubeBlock@GetIntersectionWithLine)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[GetLocalMatrix(out Matrix)](Sandbox.Game.Entities.MyCubeBlock@GetLocalMatrix)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[GetMass()](Sandbox.Game.Entities.MyCubeBlock@GetMass)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[GetObjectBuilder(bool)](Sandbox.Game.Entities.MyCubeBlock@GetObjectBuilder)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyCubeBlock@GetObjectBuilderCubeBlock)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[GetOwnerFactionTag()](Sandbox.Game.Entities.MyCubeBlock@GetOwnerFactionTag)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[GetPlayerRelationToOwner()](Sandbox.Game.Entities.MyCubeBlock@GetPlayerRelationToOwner)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[GetSubBlocks()](Sandbox.Game.Entities.MyCubeBlock@GetSubBlocks)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[GetUserRelationToOwner(long, MyRelationsBetweenPlayerAndBlock)](Sandbox.Game.Entities.MyCubeBlock@GetUserRelationToOwner)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[Init()](Sandbox.Game.Entities.MyCubeBlock@Init)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyCubeBlock@Init)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[Init(MyObjectBuilder_CubeBlock, IMyCubeGrid)](Sandbox.Game.Entities.MyCubeBlock@Init)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[InitComponents()](Sandbox.Game.Entities.MyCubeBlock@InitComponents)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyCubeBlock@OnAddedToScene)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnBuildSuccess(long, bool)](Sandbox.Game.Entities.MyCubeBlock@OnBuildSuccess)|Method called when a block has been built (after adding to the grid). This is called right after placing the block and it doesn't matter whether it is fully built (creative mode) or is only construction site. Note that it is not called for blocks which do not create FatBlock at that moment.<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[OnCubeGridChanged(MyCubeGrid)](Sandbox.Game.Entities.MyCubeBlock@OnCubeGridChanged)|Notifies about grid change with old grid in parameter (new grid is available in property).<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnDestroy()](Sandbox.Game.Entities.MyCubeBlock@OnDestroy)|Called when block is destroyed before being removed from grid<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnModelChange()](Sandbox.Game.Entities.MyCubeBlock@OnModelChange)|Called when the model referred by the block is changed<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnRegisteredToGridSystems()](Sandbox.Game.Entities.MyCubeBlock@OnRegisteredToGridSystems)|Called at the end of registration from grid systems (after block has been registered).<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnRemovedByCubeBuilder()](Sandbox.Game.Entities.MyCubeBlock@OnRemovedByCubeBuilder)|Method called when user removes a cube block from grid. Useful when block has to remove some other attached block (like motors).<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnRemovedFromScene(object)](Sandbox.Game.Entities.MyCubeBlock@OnRemovedFromScene)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnTeleport()](Sandbox.Game.Entities.MyCubeBlock@OnTeleport)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[OnUnregisteredFromGridSystems()](Sandbox.Game.Entities.MyCubeBlock@OnUnregisteredFromGridSystems)|Called at the end of unregistration from grid systems (after block has been unregistered).<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[ReceivedDamage(float, MyStringHash, long, long, bool, MyStringHash?)](Sandbox.Game.Entities.MyCubeBlock@ReceivedDamage)|Block received damage from any source.<br /><br />_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[RefreshModels(string, string)](Sandbox.Game.Entities.MyCubeBlock@RefreshModels)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[ReleaseInventory(MyInventory, bool)](Sandbox.Game.Entities.MyCubeBlock@ReleaseInventory)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[RemoveEffect(string, int)](Sandbox.Game.Entities.MyCubeBlock@RemoveEffect)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[SetDamageEffect(bool)](Sandbox.Game.Entities.MyCubeBlock@SetDamageEffect)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[SetDamageEffectDelayed(bool)](Sandbox.Game.Entities.MyCubeBlock@SetDamageEffectDelayed)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[SetEffect(string, bool)](Sandbox.Game.Entities.MyCubeBlock@SetEffect)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[SetEffect(string, float, bool, bool, bool)](Sandbox.Game.Entities.MyCubeBlock@SetEffect)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[SetEmissiveState(MyStringHash, uint, string)](Sandbox.Game.Entities.MyCubeBlock@SetEmissiveState)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[SetEmissiveStateDamaged()](Sandbox.Game.Entities.MyCubeBlock@SetEmissiveStateDamaged)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[SetEmissiveStateDisabled()](Sandbox.Game.Entities.MyCubeBlock@SetEmissiveStateDisabled)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[SetEmissiveStateWorking()](Sandbox.Game.Entities.MyCubeBlock@SetEmissiveStateWorking)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[StopDamageEffect(bool)](Sandbox.Game.Entities.MyCubeBlock@StopDamageEffect)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[TryGetSubBlock(string, out MySlimBlock)](Sandbox.Game.Entities.MyCubeBlock@TryGetSubBlock)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[UpdateBeforeSimulation()](Sandbox.Game.Entities.MyCubeBlock@UpdateBeforeSimulation)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[UpdateBeforeSimulation10()](Sandbox.Game.Entities.MyCubeBlock@UpdateBeforeSimulation10)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[UpdateEmissiveParts(uint, float, Color, Color)](Sandbox.Game.Entities.MyCubeBlock@UpdateEmissiveParts)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[UpdateIsWorking()](Sandbox.Game.Entities.MyCubeBlock@UpdateIsWorking)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyCubeBlock@UpdateOnceBeforeFrame)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[UpdateSkin(bool)](Sandbox.Game.Entities.MyCubeBlock@UpdateSkin)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
|[UpdateVisual()](Sandbox.Game.Entities.MyCubeBlock@UpdateVisual)|_Inherited from [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)_|
...
**Inheritance:**   [MyEntity](VRage.Game.Entity.MyEntity) ˃ [MyCubeBlock](Sandbox.Game.Entities.MyCubeBlock)

**Implements:**  
* [IMyComponentOwner<MyIDModule>](VRage.Game.Components.IMyComponentOwner{MyIDModule})  
* IMyConveyorSegmentBlock <sub>prohibited</sub>  
