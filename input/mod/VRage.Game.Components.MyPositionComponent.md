...
|Member|Description|
|---|---|
|[static SynchronizationEnabled](VRage.Game.Components.MyPositionComponent@SynchronizationEnabled)||
...
|[WorldPositionChanged](VRage.Game.Components.MyPositionComponent@WorldPositionChanged)||
...
|Member|Description|
|---|---|
|[LocalAABB](VRage.Game.Components.MyPositionComponent@LocalAABB)|Sets the local aabb.|
...
|Member|Description|
|---|---|
|[MyPositionComponent()](VRage.Game.Components.MyPositionComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[OnAddedToContainer()](VRage.Game.Components.MyPositionComponent@OnAddedToContainer)||
|[OnBeforeRemovedFromContainer()](VRage.Game.Components.MyPositionComponent@OnBeforeRemovedFromContainer)||
