...
|Member|Description|
|---|---|
|[BoulderItemId](VRage.Game.MyObjectBuilder_VoxelMap@BoulderItemId)||
|[BoulderPlanetId](VRage.Game.MyObjectBuilder_VoxelMap@BoulderPlanetId)||
|[BoulderSectorId](VRage.Game.MyObjectBuilder_VoxelMap@BoulderSectorId)||
|[ContentChanged](VRage.Game.MyObjectBuilder_VoxelMap@ContentChanged)||
|[CreatedByUser](VRage.Game.MyObjectBuilder_VoxelMap@CreatedByUser)||
|[Filename](VRage.Game.MyObjectBuilder_VoxelMap@Filename)||
|[IsGlobalEncounterAsteroid](VRage.Game.MyObjectBuilder_VoxelMap@IsGlobalEncounterAsteroid)||
|[MutableStorage](VRage.Game.MyObjectBuilder_VoxelMap@MutableStorage)||
...
|Member|Description|
|---|---|
|[StorageName](VRage.Game.MyObjectBuilder_VoxelMap@StorageName)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_VoxelMap()](VRage.Game.MyObjectBuilder_VoxelMap@.ctor)||
|[MyObjectBuilder_VoxelMap(Vector3, string)](VRage.Game.MyObjectBuilder_VoxelMap@.ctor)||
...
|Member|Description|
|---|---|
|[ShouldSerializeMutableStorage()](VRage.Game.MyObjectBuilder_VoxelMap@ShouldSerializeMutableStorage)||
