...
|Member|Description|
|---|---|
|[SurfaceCount](Sandbox.ModAPI.Ingame.IMyTextSurfaceProvider@SurfaceCount)|Get surfaces count|
|[UseGenericLcd](Sandbox.ModAPI.Ingame.IMyTextSurfaceProvider@UseGenericLcd)|Whether generic LCD terminal controls should be created|
