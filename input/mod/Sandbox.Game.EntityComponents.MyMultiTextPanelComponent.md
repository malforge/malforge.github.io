...
```csharp
public class MyMultiTextPanelComponent: MyUpdatingEntityComponent, IMyComponentBase, IMyEntityComponentBase, IMyEventProxy, IMyEventOwner, IMyUpdatingEntityComponent, IMyTextSurfaceProvider, IMyTextPanelProvider
```
...
|Member|Description|
|---|---|
|[AnyPanelNeedsUpdateByOwner](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@AnyPanelNeedsUpdateByOwner)||
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@ComponentTypeDebugString)||
|[PanelComponent](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@PanelComponent)||
|[Panels](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@Panels)||
|[PanelTexturesByteCount](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@PanelTexturesByteCount)||
|[RangeIndex](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@RangeIndex)||
|[SelectedPanelIndex](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@SelectedPanelIndex)||
|[SurfaceCount](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@SurfaceCount)||
|[UseGenericLcd](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@UseGenericLcd)||
|[WorldPosition](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@WorldPosition)||
...
|Member|Description|
|---|---|
|[MyMultiTextPanelComponent()](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@.ctor)||
|[MyMultiTextPanelComponent(List<MySerializedTextPanelData>, float)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@.ctor)||
...
|Member|Description|
|---|---|
|[static CreateTerminalControls<T>()](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@CreateTerminalControls{T})||
|[AddToScene(int?)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@AddToScene)||
|[ChangeText(int, string)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@ChangeText)||
|[Deserialize(MyObjectBuilder_ComponentBase)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@Deserialize)||
|[GetPanelComponent(int)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@GetPanelComponent)||
|[GetSurface(int)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@GetSurface)||
|[Init(MyComponentDefinitionBase)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@Init)||
|[IsSerialized()](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@IsSerialized)||
|[OnAddedToContainer()](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@OnAddedToContainer)||
|[OnSelectImageSuccess(int, Int32[])](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@OnSelectImageSuccess)||
|[RemoveItems(int, Int32[])](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@RemoveItems)||
|[Reset()](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@Reset)||
|[SelectItems(int, Int32[])](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@SelectItems)||
|[SelectPanel(int)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@SelectPanel)||
|[Serialize(bool)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@Serialize)||
|[Serialize()](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@Serialize)||
|[SerializePanel(int)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@SerializePanel)||
|[SetPanelData(MySerializedTextPanelData, int, bool)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@SetPanelData)||
|[SetRender(MyRenderComponentScreenAreas)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@SetRender)||
|[UpdateAfterSimulation10()](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@UpdateAfterSimulation10)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@UpdateOnceBeforeFrame)||
|[UpdateScreen(bool)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@UpdateScreen)||
|[UpdateSpriteCollection(int, MySerializableSpriteCollection)](Sandbox.Game.EntityComponents.MyMultiTextPanelComponent@UpdateSpriteCollection)||
...
* IMyTextPanelProvider <sub>prohibited</sub>  
