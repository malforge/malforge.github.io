...
|Member|Description|
|---|---|
|[OffText](Sandbox.ModAPI.Interfaces.Terminal.IMyTerminalControlCheckbox@OffText)|The "off" label text|
|[OnText](Sandbox.ModAPI.Interfaces.Terminal.IMyTerminalControlCheckbox@OnText)|The "on" label text|
