...
|Member|Description|
|---|---|
|[static MAX_RADIUS](Sandbox.Game.Entities.MySafeZone@MAX_RADIUS)||
|[static MIN_RADIUS](Sandbox.Game.Entities.MySafeZone@MIN_RADIUS)||
...
|[Entities](Sandbox.Game.Entities.MySafeZone@Entities)||
|[Factions](Sandbox.Game.Entities.MySafeZone@Factions)||
|[Players](Sandbox.Game.Entities.MySafeZone@Players)||
|[Radius](Sandbox.Game.Entities.MySafeZone@Radius)||
...
|Member|Description|
|---|---|
|[AccessTypeFactions](Sandbox.Game.Entities.MySafeZone@AccessTypeFactions)||
|[AccessTypeFloatingObjects](Sandbox.Game.Entities.MySafeZone@AccessTypeFloatingObjects)||
|[AccessTypeGrids](Sandbox.Game.Entities.MySafeZone@AccessTypeGrids)||
|[AccessTypePlayers](Sandbox.Game.Entities.MySafeZone@AccessTypePlayers)||
|[AllowedActions](Sandbox.Game.Entities.MySafeZone@AllowedActions)||
|[CurrentTexture](Sandbox.Game.Entities.MySafeZone@CurrentTexture)||
|[DetectorAABB](Sandbox.Game.Entities.MySafeZone@DetectorAABB)||
|[Enabled](Sandbox.Game.Entities.MySafeZone@Enabled)||
|[HitEntity](Sandbox.Game.Entities.MySafeZone@HitEntity)||
|[IsDetectorEnabled](Sandbox.Game.Entities.MySafeZone@IsDetectorEnabled)||
|[IsStatic](Sandbox.Game.Entities.MySafeZone@IsStatic)|Static safe zone is any which cannot move (for example for safe zone block).|
|[ModelColor](Sandbox.Game.Entities.MySafeZone@ModelColor)||
|[SafeZoneBlockId](Sandbox.Game.Entities.MySafeZone@SafeZoneBlockId)|Entity id of the safezone block associated with the safezone. If 0 than safezone is not associated to any block.|
|[Shape](Sandbox.Game.Entities.MySafeZone@Shape)||
|[Size](Sandbox.Game.Entities.MySafeZone@Size)||
...
|[DetectorAABB](Sandbox.ModAPI.IMyProjectileDetector@DetectorAABB)|Gets AABB of the detector<br /><br />_Inherited from [IMyProjectileDetector](Sandbox.ModAPI.IMyProjectileDetector)_|
...
|[HitEntity](Sandbox.ModAPI.IMyProjectileDetector@HitEntity)|Gets entity which was hit for this detector. It's not used for any logic with data, just for reporting to projectile system, which entity was hit by the projectile.<br /><br />_Inherited from [IMyProjectileDetector](Sandbox.ModAPI.IMyProjectileDetector)_|
...
|[IsDetectorEnabled](Sandbox.ModAPI.IMyProjectileDetector@IsDetectorEnabled)|Gets if detector is enabled<br /><br />_Inherited from [IMyProjectileDetector](Sandbox.ModAPI.IMyProjectileDetector)_|
...
|Member|Description|
|---|---|
|[MySafeZone()](Sandbox.Game.Entities.MySafeZone@.ctor)||
...
|Member|Description|
|---|---|
|[static CheckAdminIgnoreSafezones(ulong)](Sandbox.Game.Entities.MySafeZone@CheckAdminIgnoreSafezones)||
...
|[AddContainedToList()](Sandbox.Game.Entities.MySafeZone@AddContainedToList)||
|[AddShape(List<MyOrientedBoundingBoxD>, List<BoundingSphereD>)](Sandbox.Game.Entities.MySafeZone@AddShape)||
|[Containment(ref BoundingBoxD)](Sandbox.Game.Entities.MySafeZone@Containment)||
|[Contains(Vector3D)](Sandbox.Game.Entities.MySafeZone@Contains)||
...
|[IsActionAllowed(MySafeZoneAction, long, BoundingBoxD?, BoundingSphereD?, Vector3D?)](Sandbox.Game.Entities.MySafeZone@IsActionAllowed)||
|[IsActionAllowed(MyEntity, MySafeZoneAction, long)](Sandbox.Game.Entities.MySafeZone@IsActionAllowed)||
|[IsEmpty()](Sandbox.Game.Entities.MySafeZone@IsEmpty)||
|[IsEntityInsideAlone(long)](Sandbox.Game.Entities.MySafeZone@IsEntityInsideAlone)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MySafeZone@OnAddedToScene)||
|[OnRemovedFromScene(object)](Sandbox.Game.Entities.MySafeZone@OnRemovedFromScene)||
|[RecreatePhysics(bool, bool)](Sandbox.Game.Entities.MySafeZone@RecreatePhysics)|When physics are recreated (shape / size), this should be triggered so entities would be re-added|
|[RefreshGraphics()](Sandbox.Game.Entities.MySafeZone@RefreshGraphics)||
|[UpdateBeforeSimulation()](Sandbox.Game.Entities.MySafeZone@UpdateBeforeSimulation)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MySafeZone@UpdateOnceBeforeFrame)||
...
|[GetDetectorIntersectionWithLine(ref LineD, out Vector3D?)](Sandbox.ModAPI.IMyProjectileDetector@GetDetectorIntersectionWithLine)|Gets intersection between line and detector<br /><br />_Inherited from [IMyProjectileDetector](Sandbox.ModAPI.IMyProjectileDetector)_|
