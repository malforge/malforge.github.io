...
|Member|Description|
|---|---|
|[AmmoInventory](Sandbox.Game.Entities.IMyGunBaseUser@AmmoInventory)|The inventory in which the weapon searches for additional ammo<br /><br />_Inherited from [IMyGunBaseUser](Sandbox.Game.Entities.IMyGunBaseUser)_|
...
|[ConstraintDisplayName](Sandbox.Game.Entities.IMyGunBaseUser@ConstraintDisplayName)|_Inherited from [IMyGunBaseUser](Sandbox.Game.Entities.IMyGunBaseUser)_|
...
|[IgnoreEntities](Sandbox.Game.Entities.IMyGunBaseUser@IgnoreEntities)|_Inherited from [IMyGunBaseUser](Sandbox.Game.Entities.IMyGunBaseUser)_|
...
|[Launcher](Sandbox.Game.Entities.IMyGunBaseUser@Launcher)|_Inherited from [IMyGunBaseUser](Sandbox.Game.Entities.IMyGunBaseUser)_|
...
|[Owner](Sandbox.Game.Entities.IMyGunBaseUser@Owner)|_Inherited from [IMyGunBaseUser](Sandbox.Game.Entities.IMyGunBaseUser)_|
|[OwnerId](Sandbox.Game.Entities.IMyGunBaseUser@OwnerId)|_Inherited from [IMyGunBaseUser](Sandbox.Game.Entities.IMyGunBaseUser)_|
...
|[PhysicalItemId](Sandbox.Game.Entities.IMyGunBaseUser@PhysicalItemId)|The physical item that is being searched for in the weapon inventory. Can be ignored if WeaponInventory is null<br /><br />_Inherited from [IMyGunBaseUser](Sandbox.Game.Entities.IMyGunBaseUser)_|
...
|[Weapon](Sandbox.Game.Entities.IMyGunBaseUser@Weapon)|_Inherited from [IMyGunBaseUser](Sandbox.Game.Entities.IMyGunBaseUser)_|
|[WeaponInventory](Sandbox.Game.Entities.IMyGunBaseUser@WeaponInventory)|The inventory in which the weapon searches for it's object builder (e.g. an automatic rifle in character's inventory) Can be null if the object builder is not to be searched<br /><br />_Inherited from [IMyGunBaseUser](Sandbox.Game.Entities.IMyGunBaseUser)_|
