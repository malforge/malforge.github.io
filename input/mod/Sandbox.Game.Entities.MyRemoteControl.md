...
|Member|Description|
|---|---|
|[AutomaticallyProlongJourney](Sandbox.Game.Entities.MyRemoteControl@AutomaticallyProlongJourney)||
...
|Member|Description|
|---|---|
|[AutomaticBehaviour](Sandbox.Game.Entities.MyRemoteControl@AutomaticBehaviour)||
|[CanHavePreviousCameraEntity](Sandbox.Game.Entities.MyRemoteControl@CanHavePreviousCameraEntity)||
|[CanHavePreviousControlledEntity](Sandbox.Game.Entities.MyRemoteControl@CanHavePreviousControlledEntity)||
|[CurrentWaypoint](Sandbox.Game.Entities.MyRemoteControl@CurrentWaypoint)||
|[GetPreviousCameraEntity](Sandbox.Game.Entities.MyRemoteControl@GetPreviousCameraEntity)||
|[IsMainRemoteControl](Sandbox.Game.Entities.MyRemoteControl@IsMainRemoteControl)||
|[Pilot](Sandbox.Game.Entities.MyRemoteControl@Pilot)||
|[PreviousControlledEntity](Sandbox.Game.Entities.MyRemoteControl@PreviousControlledEntity)||
...
|[CurrentWaypoint](Sandbox.ModAPI.Ingame.IMyRemoteControl@CurrentWaypoint)|Gets the current target waypoint<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
|[Direction](Sandbox.ModAPI.Ingame.IMyRemoteControl@Direction)|Gets or sets the current flight direction<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
|[FlightMode](Sandbox.ModAPI.Ingame.IMyRemoteControl@FlightMode)|Gets or sets the current flight mode<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
|[IsAutoPilotEnabled](Sandbox.ModAPI.Ingame.IMyRemoteControl@IsAutoPilotEnabled)|Determines whether the autopilot is currently enabled.<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
|[SpeedLimit](Sandbox.ModAPI.Ingame.IMyRemoteControl@SpeedLimit)|Gets or sets the autopilot speed limit<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
|[WaitForFreeWay](Sandbox.ModAPI.Ingame.IMyRemoteControl@WaitForFreeWay)|if true, if collision avoidance is on, autopilot will wait until path is clear to move forward.<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
|Member|Description|
|---|---|
|[MyRemoteControl()](Sandbox.Game.Entities.MyRemoteControl@.ctor)||
...
|[AddWaypoint(Vector3D, string)](Sandbox.Game.Entities.MyRemoteControl@AddWaypoint)||
|[AddWaypoint(MyWaypointInfo)](Sandbox.Game.Entities.MyRemoteControl@AddWaypoint)||
|[AdvanceWaypoint()](Sandbox.Game.Entities.MyRemoteControl@AdvanceWaypoint)||
|[CanControl(IMyControllableEntity)](Sandbox.Game.Entities.MyRemoteControl@CanControl)||
|[CanUse(UseActionEnum, IMyControllableEntity)](Sandbox.Game.Entities.MyRemoteControl@CanUse)||
|[ChangeDirection(Direction)](Sandbox.Game.Entities.MyRemoteControl@ChangeDirection)||
|[ChangeFlightMode(FlightMode)](Sandbox.Game.Entities.MyRemoteControl@ChangeFlightMode)||
|[CleanControls()](Sandbox.Game.Entities.MyRemoteControl@CleanControls)||
|[ClearWaypoints()](Sandbox.Game.Entities.MyRemoteControl@ClearWaypoints)||
|[DisableUpdates()](Sandbox.Game.Entities.MyRemoteControl@DisableUpdates)||
|[ForceReleaseControl()](Sandbox.Game.Entities.MyRemoteControl@ForceReleaseControl)||
|[GetComponent(out MyAutopilotComponent)](Sandbox.Game.Entities.MyRemoteControl@GetComponent)||
|[GetHeadMatrix(bool, bool, bool, bool)](Sandbox.Game.Entities.MyRemoteControl@GetHeadMatrix)||
|[GetNearestPlayer(out MatrixD, Vector3)](Sandbox.Game.Entities.MyRemoteControl@GetNearestPlayer)||
|[GetNearestPlayer()](Sandbox.Game.Entities.MyRemoteControl@GetNearestPlayer)||
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyRemoteControl@GetObjectBuilderCubeBlock)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyRemoteControl@Init)||
|[IsAutopilotEnabled()](Sandbox.Game.Entities.MyRemoteControl@IsAutopilotEnabled)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyRemoteControl@OnAddedToScene)||
|[OnRegisteredToGridSystems()](Sandbox.Game.Entities.MyRemoteControl@OnRegisteredToGridSystems)||
|[OnUnregisteredFromGridSystems()](Sandbox.Game.Entities.MyRemoteControl@OnUnregisteredFromGridSystems)||
|[RequestControl()](Sandbox.Game.Entities.MyRemoteControl@RequestControl)||
|[RequestUse(UseActionEnum, IMyControllableEntity)](Sandbox.Game.Entities.MyRemoteControl@RequestUse)||
|[SetAutomaticBehaviour(IRemoteControlAutomaticBehaviour)](Sandbox.Game.Entities.MyRemoteControl@SetAutomaticBehaviour)||
|[SetAutoPilotEnabled(bool)](Sandbox.Game.Entities.MyRemoteControl@SetAutoPilotEnabled)||
|[SetAutoPilotSpeedLimit(float)](Sandbox.Game.Entities.MyRemoteControl@SetAutoPilotSpeedLimit)||
|[SetCollisionAvoidance(bool)](Sandbox.Game.Entities.MyRemoteControl@SetCollisionAvoidance)||
|[SetDockingMode(bool)](Sandbox.Game.Entities.MyRemoteControl@SetDockingMode)||
|[SetEmissiveStateWorking()](Sandbox.Game.Entities.MyRemoteControl@SetEmissiveStateWorking)||
|[SetWaitForFreeWay(bool)](Sandbox.Game.Entities.MyRemoteControl@SetWaitForFreeWay)||
|[SetWaypointThresholdDistance(float)](Sandbox.Game.Entities.MyRemoteControl@SetWaypointThresholdDistance)||
|[ShowInventory()](Sandbox.Game.Entities.MyRemoteControl@ShowInventory)||
|[ShowTerminal()](Sandbox.Game.Entities.MyRemoteControl@ShowTerminal)||
|[UpdateAfterSimulation10()](Sandbox.Game.Entities.MyRemoteControl@UpdateAfterSimulation10)||
|[UpdateAfterSimulationParallel()](Sandbox.Game.Entities.MyRemoteControl@UpdateAfterSimulationParallel)||
|[UpdateBeforeSimulation()](Sandbox.Game.Entities.MyRemoteControl@UpdateBeforeSimulation)||
|[UpdateBeforeSimulationParallel()](Sandbox.Game.Entities.MyRemoteControl@UpdateBeforeSimulationParallel)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyRemoteControl@UpdateOnceBeforeFrame)||
|[WasControllingCockpitWhenSaved()](Sandbox.Game.Entities.MyRemoteControl@WasControllingCockpitWhenSaved)||
...
|[AddWaypoint(Vector3D, string)](Sandbox.ModAPI.Ingame.IMyRemoteControl@AddWaypoint)|Adds a new waypoint.<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
|[AddWaypoint(MyWaypointInfo)](Sandbox.ModAPI.Ingame.IMyRemoteControl@AddWaypoint)|Adds a new waypoint.<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
|[ClearWaypoints()](Sandbox.ModAPI.Ingame.IMyRemoteControl@ClearWaypoints)|Removes all existing waypoints.<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
|[GetFreeDestination(Vector3D, float, float)](Sandbox.ModAPI.IMyRemoteControl@GetFreeDestination)|Gets a destination and tries to fix it so that it does not collide with anything<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.IMyRemoteControl)_|
...
|[GetNearestPlayer(out Vector3D)](Sandbox.ModAPI.Ingame.IMyRemoteControl@GetNearestPlayer)|Gets the nearest player's position. Will only work if the remote control belongs to an NPC<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
|[GetNearestPlayer(out Vector3D)](Sandbox.ModAPI.IMyRemoteControl@GetNearestPlayer)|Gets the nearest player's position.<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.IMyRemoteControl)_|
...
|[GetWaypointInfo(List<MyWaypointInfo>)](Sandbox.ModAPI.Ingame.IMyRemoteControl@GetWaypointInfo)|Gets basic information about the currently configured waypoints.<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
|[SetAutoPilotEnabled(bool)](Sandbox.ModAPI.Ingame.IMyRemoteControl@SetAutoPilotEnabled)|Enables or disables the autopilot.<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
|[SetCollisionAvoidance(bool)](Sandbox.ModAPI.Ingame.IMyRemoteControl@SetCollisionAvoidance)|Enables or disables collision avoidance.<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
|[SetDockingMode(bool)](Sandbox.ModAPI.Ingame.IMyRemoteControl@SetDockingMode)|Enables or disables docking mode.<br /><br />_Inherited from [IMyRemoteControl](Sandbox.ModAPI.Ingame.IMyRemoteControl)_|
...
**Implements:**  
* IMyAutopilotable <sub>prohibited</sub>  
* [IMyComponentOwner<MyAutopilotComponent>](VRage.Game.Components.IMyComponentOwner{MyAutopilotComponent})  
