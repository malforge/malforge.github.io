...
```csharp
public abstract class MyUseObjectsComponentBase: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](VRage.Game.Components.MyUseObjectsComponentBase@ComponentTypeDebugString)||
|[DetectorPhysics](VRage.Game.Components.MyUseObjectsComponentBase@DetectorPhysics)||
...
|Member|Description|
|---|---|
|[AddDetector(string, Matrix)](VRage.Game.Components.MyUseObjectsComponentBase@AddDetector)||
|[ClearPhysics()](VRage.Game.Components.MyUseObjectsComponentBase@ClearPhysics)||
|[GetDetectors(string)](VRage.Game.Components.MyUseObjectsComponentBase@GetDetectors)||
|[GetDetectorTransformation(IMyUseObject)](VRage.Game.Components.MyUseObjectsComponentBase@GetDetectorTransformation)||
|[GetInteractiveObject(uint)](VRage.Game.Components.MyUseObjectsComponentBase@GetInteractiveObject)||
|[GetInteractiveObject(string)](VRage.Game.Components.MyUseObjectsComponentBase@GetInteractiveObject)||
|[GetInteractiveObjects<T>(List<T>)](VRage.Game.Components.MyUseObjectsComponentBase@GetInteractiveObjects{T})||
|[LoadDetectorsFromModel()](VRage.Game.Components.MyUseObjectsComponentBase@LoadDetectorsFromModel)||
|[OnAddedToScene()](VRage.Game.Components.MyUseObjectsComponentBase@OnAddedToScene)||
|[OnBeforeRemovedFromContainer()](VRage.Game.Components.MyUseObjectsComponentBase@OnBeforeRemovedFromContainer)||
|[OnRemovedFromScene()](VRage.Game.Components.MyUseObjectsComponentBase@OnRemovedFromScene)||
|[PositionChanged(MyPositionComponentBase)](VRage.Game.Components.MyUseObjectsComponentBase@PositionChanged)||
|[ProcessComponentToUseObjectsAndDistances(ref Dictionary<IMyUseObject, Tuple`2>, Vector3D, Vector3, object)](VRage.Game.Components.MyUseObjectsComponentBase@ProcessComponentToUseObjectsAndDistances)||
|[RaycastDetector(IMyUseObject, Vector3D, Vector3D, out float)](VRage.Game.Components.MyUseObjectsComponentBase@RaycastDetector)||
|[RaycastDetectors(Vector3D, Vector3D)](VRage.Game.Components.MyUseObjectsComponentBase@RaycastDetectors)||
|[RaycastDetectors(Vector3D, Vector3D, out float)](VRage.Game.Components.MyUseObjectsComponentBase@RaycastDetectors)|Determine whether the given ray intersects any detector. If so, returns the parametric value of the point of first intersection. PARAMATER IS NOT DISTANCE!|
|[RecreatePhysics()](VRage.Game.Components.MyUseObjectsComponentBase@RecreatePhysics)||
|[RemoveDetector(uint)](VRage.Game.Components.MyUseObjectsComponentBase@RemoveDetector)||
