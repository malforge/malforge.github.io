...
|Member|Description|
|---|---|
|[ContainerBase](VRage.Game.Components.Interfaces.IMyComponentBase@ContainerBase)||
|[RemoveExistingComponentOnNewInsert](VRage.Game.Components.Interfaces.IMyComponentBase@RemoveExistingComponentOnNewInsert)||

## Methods

|Member|Description|
|---|---|
|[Deserialize(MyObjectBuilder_ComponentBase)](VRage.Game.Components.Interfaces.IMyComponentBase@Deserialize)||
|[GetAs<T>()](VRage.Game.Components.Interfaces.IMyComponentBase@GetAs{T})||
|[Init(MyComponentDefinitionBase)](VRage.Game.Components.Interfaces.IMyComponentBase@Init)||
|[IsSerialized()](VRage.Game.Components.Interfaces.IMyComponentBase@IsSerialized)||
|[OnAddedToContainer()](VRage.Game.Components.Interfaces.IMyComponentBase@OnAddedToContainer)||
|[OnAddedToScene()](VRage.Game.Components.Interfaces.IMyComponentBase@OnAddedToScene)||
|[OnBeforeRemovedFromContainer()](VRage.Game.Components.Interfaces.IMyComponentBase@OnBeforeRemovedFromContainer)||
|[OnRemovedFromScene()](VRage.Game.Components.Interfaces.IMyComponentBase@OnRemovedFromScene)||
|[Serialize(bool)](VRage.Game.Components.Interfaces.IMyComponentBase@Serialize)||
|[SetContainer(IMyComponentContainer)](VRage.Game.Components.Interfaces.IMyComponentBase@SetContainer)||
