...
|Member|Description|
|---|---|
|[CurrentAmmo](Sandbox.Common.ObjectBuilders.MyObjectBuilder_AutomaticRifle@CurrentAmmo)||
|[GunBase](Sandbox.Common.ObjectBuilders.MyObjectBuilder_AutomaticRifle@GunBase)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_AutomaticRifle()](Sandbox.Common.ObjectBuilders.MyObjectBuilder_AutomaticRifle@.ctor)||
...
|Member|Description|
|---|---|
|[CanStack(IMyStackableGunItem)](Sandbox.Common.ObjectBuilders.MyObjectBuilder_AutomaticRifle@CanStack)||
|[CanStackWithNullGun()](Sandbox.Common.ObjectBuilders.MyObjectBuilder_AutomaticRifle@CanStackWithNullGun)||
|[ShouldSerializeCurrentAmmo()](Sandbox.Common.ObjectBuilders.MyObjectBuilder_AutomaticRifle@ShouldSerializeCurrentAmmo)||
|[CanStack(IMyStackableGunItem)](VRage.Game.IMyStackableGunItem@CanStack)|When there is GunEntity (AutomaticRifle) in both items<br /><br />_Inherited from [IMyStackableGunItem](VRage.Game.IMyStackableGunItem)_|
|[CanStackWithNullGun()](VRage.Game.IMyStackableGunItem@CanStackWithNullGun)|When there is no GunEntity (AutomaticRifle) in other item<br /><br />_Inherited from [IMyStackableGunItem](VRage.Game.IMyStackableGunItem)_|
...
**Implements:**  
* [IMyObjectBuilder_GunObject<MyObjectBuilder_GunBase>](VRage.Game.ObjectBuilders.IMyObjectBuilder_GunObject{MyObjectBuilder_GunBase})  
