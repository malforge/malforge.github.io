...
|Member|Description|
|---|---|
|[IsRequiredByGame](Sandbox.Game.Entities.MyMeteorShower@IsRequiredByGame)||
...
|Member|Description|
|---|---|
|[MyMeteorShower()](Sandbox.Game.Entities.MyMeteorShower@.ctor)||
...
|Member|Description|
|---|---|
|[static CalculateShowerTime(MyEnvironmentHostilityEnum)](Sandbox.Game.Entities.MyMeteorShower@CalculateShowerTime)||
|[static GetActivationTime(MyEnvironmentHostilityEnum, double, double)](Sandbox.Game.Entities.MyMeteorShower@GetActivationTime)||
|[static GetInitialTime(MyEnvironmentHostilityEnum)](Sandbox.Game.Entities.MyMeteorShower@GetInitialTime)||
|[static MeteorWave(object)](Sandbox.Game.Entities.MyMeteorShower@MeteorWave)||
|[static StartDebugWave(Vector3D, int?, float)](Sandbox.Game.Entities.MyMeteorShower@StartDebugWave)||
|[static CalculateShowerTime(MyEnvironmentHostilityEnum, MyEnvironmentHostilityEnum, TimeSpan)](Sandbox.Game.Entities.MyMeteorShower@CalculateShowerTime)|_**Obsolete**_|
|[BeforeStart()](Sandbox.Game.Entities.MyMeteorShower@BeforeStart)||
|[Draw()](Sandbox.Game.Entities.MyMeteorShower@Draw)||
|[LoadData()](Sandbox.Game.Entities.MyMeteorShower@LoadData)||
