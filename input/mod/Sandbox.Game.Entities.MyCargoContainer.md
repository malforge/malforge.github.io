...
```csharp
public class MyCargoContainer: MyTerminalBlock, IMyEntity, IMyEntity, IMyComponentOwner<MyIDModule>, IMyCubeBlock, IMyCubeBlock, IMyUpgradableBlock, IMyUpgradableBlock, IMyEventProxy, IMyEventOwner, IMySyncedEntity, IMyTerminalBlock, IMyTerminalBlock, IMyConveyorEndpointBlock, IMyCargoContainer, IMyCargoContainer, IMyInventoryOwner
```
...
|Member|Description|
|---|---|
|[ContainerType](Sandbox.Game.Entities.MyCargoContainer@ContainerType)|Use this only for debugging/cheating purposes!|
|[ConveyorEndpoint](Sandbox.Game.Entities.MyCargoContainer@ConveyorEndpoint)||
...
|Member|Description|
|---|---|
|[MyCargoContainer()](Sandbox.Game.Entities.MyCargoContainer@.ctor)||

## Methods

|Member|Description|
|---|---|
|[AllowSelfPulling()](Sandbox.Game.Entities.MyCargoContainer@AllowSelfPulling)||
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyCargoContainer@GetObjectBuilderCubeBlock)||
|[GetPullInformation()](Sandbox.Game.Entities.MyCargoContainer@GetPullInformation)||
|[GetPushInformation()](Sandbox.Game.Entities.MyCargoContainer@GetPushInformation)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyCargoContainer@Init)||
|[InitializeConveyorEndpoint()](Sandbox.Game.Entities.MyCargoContainer@InitializeConveyorEndpoint)||
|[SpawnRandomCargo()](Sandbox.Game.Entities.MyCargoContainer@SpawnRandomCargo)||
|[UpdateBeforeSimulation100()](Sandbox.Game.Entities.MyCargoContainer@UpdateBeforeSimulation100)||
