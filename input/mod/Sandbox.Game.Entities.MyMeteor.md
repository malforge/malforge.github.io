...
```csharp
public class MyMeteor: MyEntity, IMyEntity, IMyEntity, IMyDestroyableObject, IMyDecalProxy, IMyMeteor, IMyEventProxy, IMyEventOwner
```
...
|Member|Description|
|---|---|
|[Integrity](Sandbox.Game.Entities.MyMeteor@Integrity)||
|[IsCCDForProjectiles](Sandbox.Game.Entities.MyMeteor@IsCCDForProjectiles)||
|[UseDamageSystem](Sandbox.Game.Entities.MyMeteor@UseDamageSystem)||
...
|Member|Description|
|---|---|
|[MyMeteor()](Sandbox.Game.Entities.MyMeteor@.ctor)||
...
|Member|Description|
|---|---|
|[static Spawn(ref MyPhysicalInventoryItem, Vector3D, Vector3)](Sandbox.Game.Entities.MyMeteor@Spawn)||
|[static SpawnRandom(Vector3D, Vector3)](Sandbox.Game.Entities.MyMeteor@SpawnRandom)||
...
|[DoDamage(float, MyStringHash, bool, MyHitInfo?, long, long, bool, MyStringHash?)](Sandbox.Game.Entities.MyMeteor@DoDamage)||
|[GetObjectBuilder(bool)](Sandbox.Game.Entities.MyMeteor@GetObjectBuilder)||
|[OnDestroy()](Sandbox.Game.Entities.MyMeteor@OnDestroy)||
