...
```csharp
public interface IMyReactor: IMyReactor, IMyPowerProducer, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyPowerProducer, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity
```
...
|Member|Description|
|---|---|
|[PowerOutputMultiplier](Sandbox.ModAPI.IMyReactor@PowerOutputMultiplier)|Gets or sets multiplier that increasing/decreasing amount of produced power keeping fuel consumption same. Default value = 1|
