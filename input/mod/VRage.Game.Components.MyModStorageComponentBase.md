...
```csharp
public abstract class MyModStorageComponentBase: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase, IDictionary<Guid, string>, ICollection<KeyValuePair<Guid, string>>, IEnumerable<KeyValuePair<Guid, string>>, IEnumerable
```
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](VRage.Game.Components.MyModStorageComponentBase@ComponentTypeDebugString)||
|[Count](VRage.Game.Components.MyModStorageComponentBase@Count)||
|[IsReadOnly](VRage.Game.Components.MyModStorageComponentBase@IsReadOnly)||
|[Item](VRage.Game.Components.MyModStorageComponentBase@Item)||
|[Keys](VRage.Game.Components.MyModStorageComponentBase@Keys)||
|[Values](VRage.Game.Components.MyModStorageComponentBase@Values)||
...
|Member|Description|
|---|---|
|[Add(KeyValuePair<Guid, string>)](VRage.Game.Components.MyModStorageComponentBase@Add)||
|[Add(Guid, string)](VRage.Game.Components.MyModStorageComponentBase@Add)||
|[Clear()](VRage.Game.Components.MyModStorageComponentBase@Clear)||
|[Contains(KeyValuePair<Guid, string>)](VRage.Game.Components.MyModStorageComponentBase@Contains)||
|[ContainsKey(Guid)](VRage.Game.Components.MyModStorageComponentBase@ContainsKey)||
|[CopyTo(KeyValuePair`2[], int)](VRage.Game.Components.MyModStorageComponentBase@CopyTo)||
|[GetEnumerator()](VRage.Game.Components.MyModStorageComponentBase@GetEnumerator)||
|[GetValue(Guid)](VRage.Game.Components.MyModStorageComponentBase@GetValue)|Gets a value from the Storage dictionary with the specified key.|
|[Remove(KeyValuePair<Guid, string>)](VRage.Game.Components.MyModStorageComponentBase@Remove)||
|[Remove(Guid)](VRage.Game.Components.MyModStorageComponentBase@Remove)||
|[RemoveValue(Guid)](VRage.Game.Components.MyModStorageComponentBase@RemoveValue)|Removes a value with the specified key from the Storage dictionary.|
|[Serialize(bool)](VRage.Game.Components.MyModStorageComponentBase@Serialize)||
|[SetValue(Guid, string)](VRage.Game.Components.MyModStorageComponentBase@SetValue)|Stores a value with the specified key into the Storage dictionary.|
|[TryGetValue(Guid, out string)](VRage.Game.Components.MyModStorageComponentBase@TryGetValue)|Tries to a value from the Storage dictionary with the specified key.|
