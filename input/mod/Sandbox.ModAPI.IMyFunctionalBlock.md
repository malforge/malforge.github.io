...
```csharp
public interface IMyFunctionalBlock: IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyTerminalBlock, IMyCubeBlock, IMyEntity
```
...
|Member|Description|
|---|---|
|[EnabledChanged](Sandbox.ModAPI.IMyFunctionalBlock@EnabledChanged)|Called when Enabled changed|
|[UpdateTimerTriggered](Sandbox.ModAPI.IMyFunctionalBlock@UpdateTimerTriggered)|Triggered when update timer ticks, event is fired after the block does all gameplay stuff|
...
|Member|Description|
|---|---|
|[IsUpdateTimerCreated](Sandbox.ModAPI.IMyFunctionalBlock@IsUpdateTimerCreated)|Returns true if timer was created. If the block does not use timer, this will be false.|
|[IsUpdateTimerEnabled](Sandbox.ModAPI.IMyFunctionalBlock@IsUpdateTimerEnabled)|Returns true if timer is enabled and ticking.|
...
|Member|Description|
|---|---|
|[GetFramesFromLastTrigger()](Sandbox.ModAPI.IMyFunctionalBlock@GetFramesFromLastTrigger)|Gets number of frames from the last trigger of the update timer|
