...
|Member|Description|
|---|---|
|[static FUEL_CONSUMPTION_MULTIPLIER](Sandbox.Game.Entities.MyFueledPowerProducer@FUEL_CONSUMPTION_MULTIPLIER)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[CurrentOutputRatioChanged](Sandbox.ModAPI.IMyPowerProducer@CurrentOutputRatioChanged)|Raised when Current Output Ration changed<br /><br />_Inherited from [IMyPowerProducer](Sandbox.ModAPI.IMyPowerProducer)_|
|[CurrentOutputRatioChanged](Sandbox.Game.Entities.MyFueledPowerProducer@CurrentOutputRatioChanged)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|Member|Description|
|---|---|
|[BlockDefinition](Sandbox.Game.Entities.MyReactor@BlockDefinition)||
|[IsTieredUpdateSupported](Sandbox.Game.Entities.MyReactor@IsTieredUpdateSupported)||
|[MaxOutput](Sandbox.Game.Entities.MyReactor@MaxOutput)||
|[UseConveyorSystem](Sandbox.Game.Entities.MyReactor@UseConveyorSystem)||
...
|[BlockDefinition](Sandbox.Game.Entities.MyFueledPowerProducer@BlockDefinition)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
|[Capacity](Sandbox.Game.Entities.MyFueledPowerProducer@Capacity)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[ConveyorEndpoint](Sandbox.Game.Entities.MyFueledPowerProducer@ConveyorEndpoint)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[CurrentOutput](Sandbox.ModAPI.Ingame.IMyPowerProducer@CurrentOutput)|Gets current output in Megawatts<br /><br />_Inherited from [IMyPowerProducer](Sandbox.ModAPI.Ingame.IMyPowerProducer)_|
|[CurrentOutput](Sandbox.Game.Entities.MyFueledPowerProducer@CurrentOutput)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
|[CurrentOutputRatio](Sandbox.ModAPI.Ingame.IMyPowerProducer@CurrentOutputRatio)|Gets ratio of current output<br /><br />_Inherited from [IMyPowerProducer](Sandbox.ModAPI.Ingame.IMyPowerProducer)_|
|[CurrentOutputRatio](Sandbox.Game.Entities.MyFueledPowerProducer@CurrentOutputRatio)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[EntityId](VRage.Game.ModAPI.Ingame.IMyInventoryOwner@EntityId)|Gets EntityId, which it belongs to<br /><br />_Inherited from [IMyInventoryOwner](VRage.Game.ModAPI.Ingame.IMyInventoryOwner)_|
...
|[HasInventory](VRage.Game.ModAPI.Ingame.IMyInventoryOwner@HasInventory)|Gets whether has inventory<br /><br />_Inherited from [IMyInventoryOwner](VRage.Game.ModAPI.Ingame.IMyInventoryOwner)_|
...
|[InventoryCount](VRage.Game.ModAPI.Ingame.IMyInventoryOwner@InventoryCount)|Gets amount of inventories<br /><br />_Inherited from [IMyInventoryOwner](VRage.Game.ModAPI.Ingame.IMyInventoryOwner)_|
...
|[IsSupplied](Sandbox.Game.Entities.MyFueledPowerProducer@IsSupplied)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[MaxOutput](Sandbox.ModAPI.Ingame.IMyPowerProducer@MaxOutput)|Gets maximum output in Megawatts<br /><br />_Inherited from [IMyPowerProducer](Sandbox.ModAPI.Ingame.IMyPowerProducer)_|
|[MaxOutput](Sandbox.Game.Entities.MyFueledPowerProducer@MaxOutput)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[PowerOutputMultiplier](Sandbox.ModAPI.IMyReactor@PowerOutputMultiplier)|Gets or sets multiplier that increasing/decreasing amount of produced power keeping fuel consumption same. Default value = 1<br /><br />_Inherited from [IMyReactor](Sandbox.ModAPI.IMyReactor)_|
...
|[SourceComp](Sandbox.Game.Entities.MyFueledPowerProducer@SourceComp)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[UseConveyorSystem](VRage.Game.ModAPI.Ingame.IMyInventoryOwner@UseConveyorSystem)|Gets or sets if that inventory can interact with<br /><br />_Inherited from [IMyInventoryOwner](VRage.Game.ModAPI.Ingame.IMyInventoryOwner)_|
|[UseConveyorSystem](Sandbox.ModAPI.Ingame.IMyReactor@UseConveyorSystem)|Gets or sets whether this reactor block should pull items from conveyor system<br /><br />_Inherited from [IMyReactor](Sandbox.ModAPI.Ingame.IMyReactor)_|
...
|Member|Description|
|---|---|
|[MyReactor()](Sandbox.Game.Entities.MyReactor@.ctor)||

## Methods

|Member|Description|
|---|---|
|[CheckEmissiveState(bool)](Sandbox.Game.Entities.MyReactor@CheckEmissiveState)||
|[DoUpdateTimerTick()](Sandbox.Game.Entities.MyReactor@DoUpdateTimerTick)||
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyReactor@GetObjectBuilderCubeBlock)||
|[GetPullInformation()](Sandbox.Game.Entities.MyReactor@GetPullInformation)||
|[GetTimerEnabledState()](Sandbox.Game.Entities.MyReactor@GetTimerEnabledState)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyReactor@Init)||
|[UpdateAfterSimulation100()](Sandbox.Game.Entities.MyReactor@UpdateAfterSimulation100)||
...
|[AllowSelfPulling()](Sandbox.Game.Entities.MyFueledPowerProducer@AllowSelfPulling)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[GetInventory(int)](VRage.Game.ModAPI.Ingame.IMyInventoryOwner@GetInventory)|Gets inventory by index<br /><br />_Inherited from [IMyInventoryOwner](VRage.Game.ModAPI.Ingame.IMyInventoryOwner)_|
...
|[GetMaxCapacity()](Sandbox.Game.Entities.MyFueledPowerProducer@GetMaxCapacity)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyFueledPowerProducer@GetObjectBuilderCubeBlock)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[GetPullInformation()](Sandbox.Game.Entities.MyFueledPowerProducer@GetPullInformation)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
|[GetPushInformation()](Sandbox.Game.Entities.MyFueledPowerProducer@GetPushInformation)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyFueledPowerProducer@Init)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
|[InitializeConveyorEndpoint()](Sandbox.Game.Entities.MyFueledPowerProducer@InitializeConveyorEndpoint)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyFueledPowerProducer@OnAddedToScene)|_Inherited from [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)_|
...
**Inheritance:**   MyFunctionalBlock <sub>prohibited</sub> ˃ [MyFueledPowerProducer](Sandbox.Game.Entities.MyFueledPowerProducer)
