...
```csharp
public class MyObjectBuilder_FactionStationAdvertDefinition: MyObjectBuilder_DefinitionBase
```
...
|Member|Description|
|---|---|
|[BackgroundSprite](VRage.Game.MyObjectBuilder_FactionStationAdvertDefinition@BackgroundSprite)||
|[ForegroundSprite](VRage.Game.MyObjectBuilder_FactionStationAdvertDefinition@ForegroundSprite)||
|[TextEntries](VRage.Game.MyObjectBuilder_FactionStationAdvertDefinition@TextEntries)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_FactionStationAdvertDefinition()](VRage.Game.MyObjectBuilder_FactionStationAdvertDefinition@.ctor)||
