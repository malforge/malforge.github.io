...
```csharp
public class MyCharacterRagdollComponent: MyUpdatingEntityComponent, IMyComponentBase, IMyEntityComponentBase, IMyEventProxy, IMyEventOwner, IMyUpdatingEntityComponent
```
...
|Member|Description|
|---|---|
|[Character](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@Character)||
|[ComponentTypeDebugString](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@ComponentTypeDebugString)||
|[Distance](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@Distance)||
|[IsRagdollActivated](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@IsRagdollActivated)||
|[IsRagdollMoving](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@IsRagdollMoving)||
|[RagdollMapper](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@RagdollMapper)||
...
|Member|Description|
|---|---|
|[MyCharacterRagdollComponent()](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@.ctor)||
...
|Member|Description|
|---|---|
|[InitRagdoll()](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@InitRagdoll)|Loads Ragdoll data|
|[OnAddedToContainer()](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@OnAddedToContainer)||
|[UpdateBeforeSimulation()](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@UpdateBeforeSimulation)||
|[UpdateBeforeSimulation100()](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@UpdateBeforeSimulation100)||
|[UpdateSimulate()](Sandbox.Game.Entities.Character.Components.MyCharacterRagdollComponent@UpdateSimulate)||
