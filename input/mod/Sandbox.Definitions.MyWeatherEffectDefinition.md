...
|Member|Description|
|---|---|
|[AmbientSound](Sandbox.Definitions.MyWeatherEffectDefinition@AmbientSound)||
|[AmbientVolume](Sandbox.Definitions.MyWeatherEffectDefinition@AmbientVolume)||
|[EffectName](Sandbox.Definitions.MyWeatherEffectDefinition@EffectName)||
|[FogProperties](Sandbox.Definitions.MyWeatherEffectDefinition@FogProperties)||
|[FoliageWindModifier](Sandbox.Definitions.MyWeatherEffectDefinition@FoliageWindModifier)||
|[HazardNotification](Sandbox.Definitions.MyWeatherEffectDefinition@HazardNotification)||
|[HealthHazard](Sandbox.Definitions.MyWeatherEffectDefinition@HealthHazard)||
|[Lightning](Sandbox.Definitions.MyWeatherEffectDefinition@Lightning)||
|[LightningCharacterHitIntervalMax](Sandbox.Definitions.MyWeatherEffectDefinition@LightningCharacterHitIntervalMax)||
|[LightningCharacterHitIntervalMin](Sandbox.Definitions.MyWeatherEffectDefinition@LightningCharacterHitIntervalMin)||
|[LightningGridHitIntervalMax](Sandbox.Definitions.MyWeatherEffectDefinition@LightningGridHitIntervalMax)||
|[LightningGridHitIntervalMin](Sandbox.Definitions.MyWeatherEffectDefinition@LightningGridHitIntervalMin)||
|[LightningIntervalMax](Sandbox.Definitions.MyWeatherEffectDefinition@LightningIntervalMax)||
|[LightningIntervalMin](Sandbox.Definitions.MyWeatherEffectDefinition@LightningIntervalMin)||
|[OxygenLevelModifier](Sandbox.Definitions.MyWeatherEffectDefinition@OxygenLevelModifier)||
|[ParticleAlphaMultiplier](Sandbox.Definitions.MyWeatherEffectDefinition@ParticleAlphaMultiplier)||
|[ParticleCount](Sandbox.Definitions.MyWeatherEffectDefinition@ParticleCount)||
|[ParticleRadius](Sandbox.Definitions.MyWeatherEffectDefinition@ParticleRadius)||
|[ParticleScale](Sandbox.Definitions.MyWeatherEffectDefinition@ParticleScale)||
|[RadiationHazard](Sandbox.Definitions.MyWeatherEffectDefinition@RadiationHazard)||
|[ShadowFadeout](Sandbox.Definitions.MyWeatherEffectDefinition@ShadowFadeout)||
|[SolarOutputModifier](Sandbox.Definitions.MyWeatherEffectDefinition@SolarOutputModifier)||
|[SunColor](Sandbox.Definitions.MyWeatherEffectDefinition@SunColor)||
|[SunIntensity](Sandbox.Definitions.MyWeatherEffectDefinition@SunIntensity)||
|[SunSpecularColor](Sandbox.Definitions.MyWeatherEffectDefinition@SunSpecularColor)||
|[TemperatureModifier](Sandbox.Definitions.MyWeatherEffectDefinition@TemperatureModifier)||
|[WindOutputModifier](Sandbox.Definitions.MyWeatherEffectDefinition@WindOutputModifier)||
...
|Member|Description|
|---|---|
|[MyWeatherEffectDefinition()](Sandbox.Definitions.MyWeatherEffectDefinition@.ctor)||
...
|Member|Description|
|---|---|
|[Lerp(MyWeatherEffectDefinition, MyWeatherEffectDefinition, float)](Sandbox.Definitions.MyWeatherEffectDefinition@Lerp)||
