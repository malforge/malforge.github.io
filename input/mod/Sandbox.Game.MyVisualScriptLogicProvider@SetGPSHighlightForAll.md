...
```csharp
public static void SetGPSHighlightForAll(string entityName, string GPSName, string GPSDescription, Color GPSColor, bool enabled, int thickness, int pulseTimeInFrames, Color color, string subPartNames)
```
