...
```csharp
public class MyObjectBuilder_EntityComponentUpdater: MyObjectBuilder_SessionComponent
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_EntityComponentUpdater()](VRage.Game.ObjectBuilders.Components.MyObjectBuilder_EntityComponentUpdater@.ctor)||
