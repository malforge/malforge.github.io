...
```csharp
public class MyCharacterJetpackComponent: MyUpdatingEntityComponent, IMyComponentBase, IMyEntityComponentBase, IMyEventProxy, IMyEventOwner, IMyUpdatingEntityComponent, IMyCharacterComponent
```
...
|Member|Description|
|---|---|
|[static FuelCriticalThresholdPlayer](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@FuelCriticalThresholdPlayer)||
|[static FuelLowThresholdPlayer](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@FuelLowThresholdPlayer)||
|[static MinimumInputRequirement](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@MinimumInputRequirement)||
|[static ROTATION_FACTOR](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@ROTATION_FACTOR)||
|[OnPoweredChanged](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@OnPoweredChanged)||
...
|Member|Description|
|---|---|
|[CanDrawThrusts](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@CanDrawThrusts)||
|[Character](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@Character)||
|[ComponentTypeDebugString](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@ComponentTypeDebugString)||
|[ConsumptionFactorPerG](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@ConsumptionFactorPerG)||
|[CurrentAutoEnableDelay](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@CurrentAutoEnableDelay)||
|[DampenersEnabled](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@DampenersEnabled)||
|[DampenersTurnedOn](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@DampenersTurnedOn)||
|[EffectivenessAtMaxInfluence](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@EffectivenessAtMaxInfluence)||
|[EffectivenessAtMinInfluence](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@EffectivenessAtMinInfluence)||
|[FinalThrust](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@FinalThrust)||
|[ForceMagnitude](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@ForceMagnitude)||
|[FuelConverterDefinition](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@FuelConverterDefinition)||
|[FuelDefinition](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@FuelDefinition)||
|[IsFlying](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@IsFlying)||
|[IsPowered](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@IsPowered)||
|[MaxPlanetaryInfluence](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@MaxPlanetaryInfluence)||
|[MaxPowerConsumption](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@MaxPowerConsumption)||
|[MinPlanetaryInfluence](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@MinPlanetaryInfluence)||
|[MinPowerConsumption](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@MinPowerConsumption)||
|[NeedsAtmosphereForInfluence](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@NeedsAtmosphereForInfluence)||
|[Running](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@Running)||
|[TurnedOn](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@TurnedOn)||
...
|Member|Description|
|---|---|
|[MyCharacterJetpackComponent()](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@.ctor)||
...
|Member|Description|
|---|---|
|[ClearMovement()](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@ClearMovement)||
|[EnableDampeners(bool)](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@EnableDampeners)||
|[GetObjectBuilder(MyObjectBuilder_Character)](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@GetObjectBuilder)||
|[Init(MyObjectBuilder_Character)](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@Init)||
|[MoveAndRotate(ref Vector3, ref Vector2, float, bool)](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@MoveAndRotate)||
|[OnBeforeRemovedFromContainer()](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@OnBeforeRemovedFromContainer)||
|[OnCharacterDead()](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@OnCharacterDead)||
|[SwitchDamping()](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@SwitchDamping)||
|[SwitchThrusts()](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@SwitchThrusts)||
|[TurnOnJetpack(bool, bool, bool)](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@TurnOnJetpack)||
|[UpdateFall()](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@UpdateFall)||
|[UpdatePhysicalMovement()](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@UpdatePhysicalMovement)||
|[UpdateSimulate()](Sandbox.Game.Entities.Character.Components.MyCharacterJetpackComponent@UpdateSimulate)||
