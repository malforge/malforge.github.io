...
```csharp
public interface IMyWheel: IMyMotorRotor, IMyAttachableTopBlock, IMyCubeBlock, IMyCubeBlock, IMyEntity, IMyEntity, IMyAttachableTopBlock, IMyMotorRotor, IMyWheel
```
