...
|Member|Description|
|---|---|
|[ChildId](VRage.Game.Components.MyHierarchyComponentBase@ChildId)||
...
|[OnChildRemoved](VRage.Game.Components.MyHierarchyComponentBase@OnChildRemoved)||
|[OnParentChanged](VRage.Game.Components.MyHierarchyComponentBase@OnParentChanged)||
...
|Member|Description|
|---|---|
|[Children](VRage.Game.Components.MyHierarchyComponentBase@Children)|Gets the children collection.|
|[ChildrenNeedingWorldMatrix](VRage.Game.Components.MyHierarchyComponentBase@ChildrenNeedingWorldMatrix)|Gets the children collection for spatial updates.|
|[ComponentTypeDebugString](VRage.Game.Components.MyHierarchyComponentBase@ComponentTypeDebugString)||
|[Parent](VRage.Game.Components.MyHierarchyComponentBase@Parent)||
...
|Member|Description|
|---|---|
|[MyHierarchyComponentBase()](VRage.Game.Components.MyHierarchyComponentBase@.ctor)||

## Methods

|Member|Description|
|---|---|
|[AddChild(IMyEntity, bool, bool)](VRage.Game.Components.MyHierarchyComponentBase@AddChild)|Adds the child.|
|[AddChildWithMatrix(IMyEntity, ref Matrix, bool)](VRage.Game.Components.MyHierarchyComponentBase@AddChildWithMatrix)||
|[Delete()](VRage.Game.Components.MyHierarchyComponentBase@Delete)||
|[Deserialize(MyObjectBuilder_ComponentBase)](VRage.Game.Components.MyHierarchyComponentBase@Deserialize)||
|[GetChildrenRecursive(HashSet<IMyEntity>)](VRage.Game.Components.MyHierarchyComponentBase@GetChildrenRecursive)||
|[GetTopMostParent(Type)](VRage.Game.Components.MyHierarchyComponentBase@GetTopMostParent)|Return top most parent of this entity|
|[IsSerialized()](VRage.Game.Components.MyHierarchyComponentBase@IsSerialized)||
|[OnAddedToScene()](VRage.Game.Components.MyHierarchyComponentBase@OnAddedToScene)||
|[OnBeforeRemovedFromContainer()](VRage.Game.Components.MyHierarchyComponentBase@OnBeforeRemovedFromContainer)||
|[RemoveByJN(MyHierarchyComponentBase)](VRage.Game.Components.MyHierarchyComponentBase@RemoveByJN)||
|[RemoveChild(IMyEntity, bool)](VRage.Game.Components.MyHierarchyComponentBase@RemoveChild)|Removes the child.|
|[Serialize(bool)](VRage.Game.Components.MyHierarchyComponentBase@Serialize)||
