...
```csharp
public class MyObjectBuilder_AnimationSpeedComponent: MyObjectBuilder_ComponentBase
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_AnimationSpeedComponent()](Sandbox.Common.ObjectBuilders.MyObjectBuilder_AnimationSpeedComponent@.ctor)||
