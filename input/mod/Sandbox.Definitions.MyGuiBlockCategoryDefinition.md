...
|Member|Description|
|---|---|
|[IsAnimationCategory](Sandbox.Definitions.MyGuiBlockCategoryDefinition@IsAnimationCategory)||
|[IsBlockCategory](Sandbox.Definitions.MyGuiBlockCategoryDefinition@IsBlockCategory)||
|[IsShipCategory](Sandbox.Definitions.MyGuiBlockCategoryDefinition@IsShipCategory)||
|[IsToolCategory](Sandbox.Definitions.MyGuiBlockCategoryDefinition@IsToolCategory)||
|[ItemIds](Sandbox.Definitions.MyGuiBlockCategoryDefinition@ItemIds)||
|[Name](Sandbox.Definitions.MyGuiBlockCategoryDefinition@Name)||
|[SearchBlocks](Sandbox.Definitions.MyGuiBlockCategoryDefinition@SearchBlocks)||
|[ShowAnimations](Sandbox.Definitions.MyGuiBlockCategoryDefinition@ShowAnimations)||
|[ShowInCreative](Sandbox.Definitions.MyGuiBlockCategoryDefinition@ShowInCreative)||
|[StrictSearch](Sandbox.Definitions.MyGuiBlockCategoryDefinition@StrictSearch)||
|[ValidItems](Sandbox.Definitions.MyGuiBlockCategoryDefinition@ValidItems)||
...
|Member|Description|
|---|---|
|[MyGuiBlockCategoryDefinition()](Sandbox.Definitions.MyGuiBlockCategoryDefinition@.ctor)||
...
|Member|Description|
|---|---|
|[CreateNewContentNotificator()](Sandbox.Definitions.MyGuiBlockCategoryDefinition@CreateNewContentNotificator)||
|[HasItem(string)](Sandbox.Definitions.MyGuiBlockCategoryDefinition@HasItem)||
