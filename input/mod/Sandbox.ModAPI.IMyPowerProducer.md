...
```csharp
public interface IMyPowerProducer: IMyFunctionalBlock, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyPowerProducer
```
...
|Member|Description|
|---|---|
|[CurrentOutputRatioChanged](Sandbox.ModAPI.IMyPowerProducer@CurrentOutputRatioChanged)|Raised when Current Output Ration changed|
