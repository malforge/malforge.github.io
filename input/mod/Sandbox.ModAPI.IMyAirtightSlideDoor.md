...
```csharp
public interface IMyAirtightSlideDoor: IMyAirtightDoorBase, IMyDoor, IMyFunctionalBlock, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyDoor, IMyAirtightDoorBase, IMyAirtightSlideDoor
```
