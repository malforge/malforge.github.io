...
```csharp
public class MyObjectBuilder_BlockPowerCheckComponentDefinition: MyObjectBuilder_ComponentDefinitionBase
```
...
|Member|Description|
|---|---|
|[PowerResourceId](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_BlockPowerCheckComponentDefinition@PowerResourceId)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_BlockPowerCheckComponentDefinition()](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_BlockPowerCheckComponentDefinition@.ctor)||
