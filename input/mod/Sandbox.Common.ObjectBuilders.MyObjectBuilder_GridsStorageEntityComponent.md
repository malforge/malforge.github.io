...
```csharp
public class MyObjectBuilder_GridsStorageEntityComponent: MyObjectBuilder_ComponentBase
```
...
|Member|Description|
|---|---|
|[Pivot](Sandbox.Common.ObjectBuilders.MyObjectBuilder_GridsStorageEntityComponent@Pivot)||
|[PrecisionMode](Sandbox.Common.ObjectBuilders.MyObjectBuilder_GridsStorageEntityComponent@PrecisionMode)||
|[ShowPivot](Sandbox.Common.ObjectBuilders.MyObjectBuilder_GridsStorageEntityComponent@ShowPivot)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_GridsStorageEntityComponent()](Sandbox.Common.ObjectBuilders.MyObjectBuilder_GridsStorageEntityComponent@.ctor)||
