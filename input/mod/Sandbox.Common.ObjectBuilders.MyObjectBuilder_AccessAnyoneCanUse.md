...
```csharp
public class MyObjectBuilder_AccessAnyoneCanUse: MyObjectBuilder_ComponentBase
```
...
|Member|Description|
|---|---|
|[AnyoneCanUse](Sandbox.Common.ObjectBuilders.MyObjectBuilder_AccessAnyoneCanUse@AnyoneCanUse)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_AccessAnyoneCanUse()](Sandbox.Common.ObjectBuilders.MyObjectBuilder_AccessAnyoneCanUse@.ctor)||
