...
```csharp
public abstract class MyGridOwnershipComponentBase: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyGridOwnershipComponentBase@ComponentTypeDebugString)||
...
|Member|Description|
|---|---|
|[GetBlockOwnerId(MySlimBlock)](Sandbox.Game.EntityComponents.MyGridOwnershipComponentBase@GetBlockOwnerId)|Returns the identity id of the block's owner|
