...
|Member|Description|
|---|---|
|[SearchRadius](VRage.Game.ModAPI.IMyContractSearch@SearchRadius)|Gets radius in which would be target grid|
|[TargetGridId](VRage.Game.ModAPI.IMyContractSearch@TargetGridId)|Gets grid that should be found|
