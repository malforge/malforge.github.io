...
|[DoorStateChanged](Sandbox.ModAPI.IMyDoor@DoorStateChanged)|Called when door changes state<br /><br />_Inherited from [IMyDoor](Sandbox.ModAPI.IMyDoor)_|
|[DoorStateChanged](Sandbox.Game.Entities.MyAirtightDoorGeneric@DoorStateChanged)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|[OnDoorClosed](Sandbox.ModAPI.IMyDoor@OnDoorClosed)|Called when door changes opened state to closed<br /><br />_Inherited from [IMyDoor](Sandbox.ModAPI.IMyDoor)_|
|[OnDoorClosed](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnDoorClosed)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
|[OnDoorOpened](Sandbox.ModAPI.IMyDoor@OnDoorOpened)|Called when door changes opened state to open<br /><br />_Inherited from [IMyDoor](Sandbox.ModAPI.IMyDoor)_|
|[OnDoorOpened](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnDoorOpened)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
|[OnDoorStateChanged](Sandbox.ModAPI.IMyDoor@OnDoorStateChanged)|Called when door changes opened state<br /><br />_Inherited from [IMyDoor](Sandbox.ModAPI.IMyDoor)_|
|[OnDoorStateChanged](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnDoorStateChanged)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|[OpenChanged](Sandbox.Game.Entities.MyDoorBase@OpenChanged)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|
...
|Member|Description|
|---|---|
|[AnyoneCanUse](Sandbox.Game.Entities.MyDoorBase@AnyoneCanUse)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|
...
|[HighlightMode](Sandbox.Game.Entities.MyDoorBase@HighlightMode)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|
...
|[IsFullyClosed](Sandbox.ModAPI.IMyDoor@IsFullyClosed)|Returns whether door is fully closed. (Animations are stopped)<br /><br />_Inherited from [IMyDoor](Sandbox.ModAPI.IMyDoor)_|
...
|[Open](Sandbox.Game.Entities.MyDoorBase@Open)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|
...
|[OpenRatio](Sandbox.Game.Entities.MyAirtightDoorGeneric@OpenRatio)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|[Status](Sandbox.Game.Entities.MyAirtightDoorGeneric@Status)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|Member|Description|
|---|---|
|[MyAirtightSlideDoor()](Sandbox.Game.Entities.MyAirtightSlideDoor@.ctor)||
|[MyAirtightDoorGeneric()](Sandbox.Game.Entities.MyAirtightDoorGeneric@.ctor)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
|[MyDoorBase()](Sandbox.Game.Entities.MyDoorBase@.ctor)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|

## Methods

|Member|Description|
|---|---|
|[ContactCallbackInternal()](Sandbox.Game.Entities.MyAirtightSlideDoor@ContactCallbackInternal)||
|[EnableContactCallbacks()](Sandbox.Game.Entities.MyAirtightSlideDoor@EnableContactCallbacks)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyAirtightSlideDoor@Init)||
|[IsClosing()](Sandbox.Game.Entities.MyAirtightSlideDoor@IsClosing)||
|[SetEmissiveStateDamaged()](Sandbox.Game.Entities.MyAirtightSlideDoor@SetEmissiveStateDamaged)||
|[SetEmissiveStateDisabled()](Sandbox.Game.Entities.MyAirtightSlideDoor@SetEmissiveStateDisabled)||
|[SetEmissiveStateWorking()](Sandbox.Game.Entities.MyAirtightSlideDoor@SetEmissiveStateWorking)||
...
|[ChangeOpenClose(bool)](Sandbox.Game.Entities.MyAirtightDoorGeneric@ChangeOpenClose)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|[ContactCallbackInternal()](Sandbox.Game.Entities.MyDoorBase@ContactCallbackInternal)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|
...
|[EnableContactCallbacks()](Sandbox.Game.Entities.MyDoorBase@EnableContactCallbacks)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|
...
|[GetIntersectionWithAABB(ref BoundingBoxD)](Sandbox.Game.Entities.MyAirtightDoorGeneric@GetIntersectionWithAABB)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyAirtightDoorGeneric@GetObjectBuilderCubeBlock)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyDoorBase@GetObjectBuilderCubeBlock)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|
...
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyAirtightDoorGeneric@Init)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyDoorBase@Init)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|
|[IsClosing()](Sandbox.Game.Entities.MyDoorBase@IsClosing)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|
...
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnAddedToScene)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|[OnBuildSuccess(long, bool)](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnBuildSuccess)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
|[OnCubeGridChanged(MyCubeGrid)](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnCubeGridChanged)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|[OnModelChange()](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnModelChange)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|[OnRemovedFromScene(object)](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnRemovedFromScene)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|[SetOpenRequest(bool, long)](Sandbox.Game.Entities.MyDoorBase@SetOpenRequest)|_Inherited from [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)_|
...
|[UpdateAfterSimulation()](Sandbox.Game.Entities.MyAirtightDoorGeneric@UpdateAfterSimulation)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
|[UpdateBeforeSimulation()](Sandbox.Game.Entities.MyAirtightDoorGeneric@UpdateBeforeSimulation)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyAirtightDoorGeneric@UpdateOnceBeforeFrame)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
|[UpdateVisual()](Sandbox.Game.Entities.MyAirtightDoorGeneric@UpdateVisual)|_Inherited from [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)_|
...
**Inheritance:**   MyFunctionalBlock <sub>prohibited</sub> ˃ [MyDoorBase](Sandbox.Game.Entities.MyDoorBase) ˃ [MyAirtightDoorGeneric](Sandbox.Game.Entities.MyAirtightDoorGeneric)
...
* IMyTieredUpdateBlock <sub>prohibited</sub>  
* IMyUpdateTimer <sub>prohibited</sub>  
