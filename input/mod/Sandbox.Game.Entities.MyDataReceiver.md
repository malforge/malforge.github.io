...
```csharp
public abstract class MyDataReceiver: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|[OnBroadcasterFound](Sandbox.Game.Entities.MyDataReceiver@OnBroadcasterFound)||
|[OnBroadcasterLost](Sandbox.Game.Entities.MyDataReceiver@OnBroadcasterLost)||
...
|Member|Description|
|---|---|
|[Broadcaster](Sandbox.Game.Entities.MyDataReceiver@Broadcaster)||
|[BroadcastersInRange](Sandbox.Game.Entities.MyDataReceiver@BroadcastersInRange)||
|[ComponentTypeDebugString](Sandbox.Game.Entities.MyDataReceiver@ComponentTypeDebugString)||
|[Enabled](Sandbox.Game.Entities.MyDataReceiver@Enabled)||
...
|Member|Description|
|---|---|
|[CanBeUsedByPlayer(long)](Sandbox.Game.Entities.MyDataReceiver@CanBeUsedByPlayer)||
|[Clear()](Sandbox.Game.Entities.MyDataReceiver@Clear)||
|[HasAccessToLogicalGroup(MyGridLogicalGroupData)](Sandbox.Game.Entities.MyDataReceiver@HasAccessToLogicalGroup)||
|[UpdateBroadcastersInRange()](Sandbox.Game.Entities.MyDataReceiver@UpdateBroadcastersInRange)||
|[UpdateHud(bool)](Sandbox.Game.Entities.MyDataReceiver@UpdateHud)||
