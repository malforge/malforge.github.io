...
```csharp
public class MyAmmoBase: MyEntity, IMyEntity, IMyEntity
```
...
|Member|Description|
|---|---|
|[Physics](Sandbox.Game.Weapons.MyAmmoBase@Physics)||
...
|[MarkForDestroy()](Sandbox.Game.Weapons.MyAmmoBase@MarkForDestroy)||
