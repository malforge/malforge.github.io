...
|Member|Description|
|---|---|
|[DoorStateChanged](Sandbox.Game.Entities.MyAirtightDoorGeneric@DoorStateChanged)||
|[OnDoorClosed](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnDoorClosed)||
|[OnDoorOpened](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnDoorOpened)||
|[OnDoorStateChanged](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnDoorStateChanged)||
...
|Member|Description|
|---|---|
|[OpenRatio](Sandbox.Game.Entities.MyAirtightDoorGeneric@OpenRatio)||
|[Status](Sandbox.Game.Entities.MyAirtightDoorGeneric@Status)||
...
|Member|Description|
|---|---|
|[MyAirtightDoorGeneric()](Sandbox.Game.Entities.MyAirtightDoorGeneric@.ctor)||
...
|Member|Description|
|---|---|
|[ChangeOpenClose(bool)](Sandbox.Game.Entities.MyAirtightDoorGeneric@ChangeOpenClose)||
|[GetIntersectionWithAABB(ref BoundingBoxD)](Sandbox.Game.Entities.MyAirtightDoorGeneric@GetIntersectionWithAABB)||
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyAirtightDoorGeneric@GetObjectBuilderCubeBlock)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyAirtightDoorGeneric@Init)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnAddedToScene)||
|[OnBuildSuccess(long, bool)](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnBuildSuccess)||
|[OnCubeGridChanged(MyCubeGrid)](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnCubeGridChanged)||
|[OnModelChange()](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnModelChange)||
|[OnRemovedFromScene(object)](Sandbox.Game.Entities.MyAirtightDoorGeneric@OnRemovedFromScene)||
|[UpdateAfterSimulation()](Sandbox.Game.Entities.MyAirtightDoorGeneric@UpdateAfterSimulation)||
|[UpdateBeforeSimulation()](Sandbox.Game.Entities.MyAirtightDoorGeneric@UpdateBeforeSimulation)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.Entities.MyAirtightDoorGeneric@UpdateOnceBeforeFrame)||
|[UpdateVisual()](Sandbox.Game.Entities.MyAirtightDoorGeneric@UpdateVisual)||
...
**Inheritance:**   MyFunctionalBlock <sub>prohibited</sub> ˃ [MyDoorBase](Sandbox.Game.Entities.MyDoorBase)
