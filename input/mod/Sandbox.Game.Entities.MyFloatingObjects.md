...
|Member|Description|
|---|---|
|[static FloatingBagsCount](Sandbox.Game.Entities.MyFloatingObjects@FloatingBagsCount)||
|[static FloatingItemCount](Sandbox.Game.Entities.MyFloatingObjects@FloatingItemCount)||
|[static FloatingOreCount](Sandbox.Game.Entities.MyFloatingObjects@FloatingOreCount)||
|[Dependencies](Sandbox.Game.Entities.MyFloatingObjects@Dependencies)||
...
|Member|Description|
|---|---|
|[MyFloatingObjects()](Sandbox.Game.Entities.MyFloatingObjects@.ctor)||
...
|Member|Description|
|---|---|
|[static AddFloatingObjectAmount(MyFloatingObject, MyFixedPoint)](Sandbox.Game.Entities.MyFloatingObjects@AddFloatingObjectAmount)||
|[static ChangeObjectBuilder(MyComponentDefinition, MyObjectBuilder_EntityBase)](Sandbox.Game.Entities.MyFloatingObjects@ChangeObjectBuilder)|This is used mainly for compactibility issues, it takes the builder of an entity of old object representation and creates a floating object builder for it|
|[static EnqueueCargoContainerBagSpawn(Action)](Sandbox.Game.Entities.MyFloatingObjects@EnqueueCargoContainerBagSpawn)||
|[static EnqueueInventoryItemSpawn(MyPhysicalInventoryItem, BoundingBoxD, Vector3D)](Sandbox.Game.Entities.MyFloatingObjects@EnqueueInventoryItemSpawn)||
|[static ReduceCargoBags()](Sandbox.Game.Entities.MyFloatingObjects@ReduceCargoBags)||
|[static ReduceFloatingObjects()](Sandbox.Game.Entities.MyFloatingObjects@ReduceFloatingObjects)||
|[static RemoveFloatingObject(MyFloatingObject, bool)](Sandbox.Game.Entities.MyFloatingObjects@RemoveFloatingObject)||
|[static RemoveFloatingObject(MyFloatingObject)](Sandbox.Game.Entities.MyFloatingObjects@RemoveFloatingObject)||
|[static RemoveInventoryBag(MyCargoContainerInventoryBagEntity)](Sandbox.Game.Entities.MyFloatingObjects@RemoveInventoryBag)||
|[static RemoveInventoryBag(MyCargoContainerInventoryBagEntity, bool)](Sandbox.Game.Entities.MyFloatingObjects@RemoveInventoryBag)||
|[static RequestSpawnCreative(MyObjectBuilder_FloatingObject)](Sandbox.Game.Entities.MyFloatingObjects@RequestSpawnCreative)|Players are allowed to spawn any object in creative|
|[static Spawn(MyPhysicalInventoryItem, Vector3D, Vector3D, Vector3D, MyPhysicsComponentBase, Action<MyEntity>)](Sandbox.Game.Entities.MyFloatingObjects@Spawn)||
|[static Spawn(MyPhysicalInventoryItem, MatrixD, MyPhysicsComponentBase, Action<MyEntity>)](Sandbox.Game.Entities.MyFloatingObjects@Spawn)||
|[static Spawn(MyPhysicalInventoryItem, BoundingSphereD, MyPhysicsComponentBase, MyVoxelMaterialDefinition, Action<MyEntity>)](Sandbox.Game.Entities.MyFloatingObjects@Spawn)||
|[static Spawn(MyPhysicalItemDefinition, Vector3D, Vector3D, Vector3D, int, float)](Sandbox.Game.Entities.MyFloatingObjects@Spawn)||
|[LoadData()](Sandbox.Game.Entities.MyFloatingObjects@LoadData)||
|[UpdateAfterSimulation()](Sandbox.Game.Entities.MyFloatingObjects@UpdateAfterSimulation)||
