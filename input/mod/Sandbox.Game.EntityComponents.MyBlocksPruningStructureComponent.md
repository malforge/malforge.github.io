...
```csharp
public class MyBlocksPruningStructureComponent: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyBlocksPruningStructureComponent@ComponentTypeDebugString)||
...
|Member|Description|
|---|---|
|[MyBlocksPruningStructureComponent()](Sandbox.Game.EntityComponents.MyBlocksPruningStructureComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[OnAddedToContainer()](Sandbox.Game.EntityComponents.MyBlocksPruningStructureComponent@OnAddedToContainer)||
|[OnBeforeRemovedFromContainer()](Sandbox.Game.EntityComponents.MyBlocksPruningStructureComponent@OnBeforeRemovedFromContainer)||
|[OnBlockAdded(MyCubeBlock)](Sandbox.Game.EntityComponents.MyBlocksPruningStructureComponent@OnBlockAdded)||
|[OnBlockRemoved(MyCubeBlock)](Sandbox.Game.EntityComponents.MyBlocksPruningStructureComponent@OnBlockRemoved)||
|[Query<T>(BoundingSphereD, List<T>)](Sandbox.Game.EntityComponents.MyBlocksPruningStructureComponent@Query{T})||
|[RegisterComponentTypeOwner<T>()](Sandbox.Game.EntityComponents.MyBlocksPruningStructureComponent@RegisterComponentTypeOwner{T})||
|[RegisterType<T>()](Sandbox.Game.EntityComponents.MyBlocksPruningStructureComponent@RegisterType{T})||
