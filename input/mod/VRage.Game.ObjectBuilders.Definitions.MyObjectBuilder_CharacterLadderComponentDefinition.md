...
```csharp
public class MyObjectBuilder_CharacterLadderComponentDefinition: MyObjectBuilder_ComponentDefinitionBase
```
...
|Member|Description|
|---|---|
|[ConstraintBreakThreshold](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_CharacterLadderComponentDefinition@ConstraintBreakThreshold)||
|[GetOffLadderAnimation](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_CharacterLadderComponentDefinition@GetOffLadderAnimation)||
|[GetOnLadderAnimation](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_CharacterLadderComponentDefinition@GetOnLadderAnimation)||
|[LadderDownAnimation](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_CharacterLadderComponentDefinition@LadderDownAnimation)||
|[LadderOutAnimation](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_CharacterLadderComponentDefinition@LadderOutAnimation)||
|[LadderUpAnimation](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_CharacterLadderComponentDefinition@LadderUpAnimation)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_CharacterLadderComponentDefinition()](VRage.Game.ObjectBuilders.Definitions.MyObjectBuilder_CharacterLadderComponentDefinition@.ctor)||
