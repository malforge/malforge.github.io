...
```csharp
public class MyObjectBuilder_RepairServiceComponent: MyObjectBuilder_ComponentBase
```
...
|Member|Description|
|---|---|
|[ServiceRange](Sandbox.Common.ObjectBuilders.MyObjectBuilder_RepairServiceComponent@ServiceRange)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_RepairServiceComponent()](Sandbox.Common.ObjectBuilders.MyObjectBuilder_RepairServiceComponent@.ctor)||
