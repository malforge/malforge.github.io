...
```csharp
public class MyFloatingObject: MyEntity, IMyEntity, IMyEntity, IMyUseObject, IMyUsableEntity, IMyDestroyableObject, IMyFloatingObject, IMyEventProxy, IMyEventOwner, IMySyncedEntity, IMyParallelUpdateable
```
...
|Member|Description|
|---|---|
|[static InventoryFullVoice](Sandbox.Game.Entities.MyFloatingObject@InventoryFullVoice)||
|[static NUMBER_OF_FRAMES_INSIDE_VOXEL_TO_REMOVE](Sandbox.Game.Entities.MyFloatingObject@NUMBER_OF_FRAMES_INSIDE_VOXEL_TO_REMOVE)||
|[static ScrapBuilder](Sandbox.Game.Entities.MyFloatingObject@ScrapBuilder)||
|[static TakeItemVoice](Sandbox.Game.Entities.MyFloatingObject@TakeItemVoice)||
...
|[Amount](Sandbox.Game.Entities.MyFloatingObject@Amount)||
...
|[VoxelMaterial](Sandbox.Game.Entities.MyFloatingObject@VoxelMaterial)||
...
|Member|Description|
|---|---|
|[GeneratedGravity](Sandbox.Game.Entities.MyFloatingObject@GeneratedGravity)||
|[Integrity](Sandbox.Game.Entities.MyFloatingObject@Integrity)||
|[ItemDefinition](Sandbox.Game.Entities.MyFloatingObject@ItemDefinition)||
|[Physics](Sandbox.Game.Entities.MyFloatingObject@Physics)||
|[ShouldUpdateTooltips](Sandbox.Game.Entities.MyFloatingObject@ShouldUpdateTooltips)||
|[SyncType](Sandbox.Game.Entities.MyFloatingObject@SyncType)||
|[UpdateFlags](Sandbox.Game.Entities.MyFloatingObject@UpdateFlags)||
|[UseDamageSystem](Sandbox.Game.Entities.MyFloatingObject@UseDamageSystem)||
|[WasRemovedFromWorld](Sandbox.Game.Entities.MyFloatingObject@WasRemovedFromWorld)||
...
|Member|Description|
|---|---|
|[MyFloatingObject()](Sandbox.Game.Entities.MyFloatingObject@.ctor)||
...
|[OnReplicationStarted()](Sandbox.Game.Entities.MyFloatingObject@OnReplicationStarted)||
|[RefreshDisplayName()](Sandbox.Game.Entities.MyFloatingObject@RefreshDisplayName)||
|[RemoveUsers(bool)](Sandbox.Game.Entities.MyFloatingObject@RemoveUsers)||
|[SendCloseRequest()](Sandbox.Game.Entities.MyFloatingObject@SendCloseRequest)||
