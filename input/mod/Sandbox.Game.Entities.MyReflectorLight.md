...
```csharp
public class MyReflectorLight: MyLightingBlock, IMyEntity, IMyEntity, IMyComponentOwner<MyIDModule>, IMyCubeBlock, IMyCubeBlock, IMyUpgradableBlock, IMyUpgradableBlock, IMyEventProxy, IMyEventOwner, IMySyncedEntity, IMyTerminalBlock, IMyTerminalBlock, IMyTieredUpdateBlock, IMyUpdateTimer, IMyTextSurfaceProvider, IMyTextSurfaceProvider, IMyMultiTextPanelComponentOwner, IMyTextPanelComponentOwner, IMyFunctionalBlock, IMyFunctionalBlock, IMyLightingBlock, IMyLightingBlock, IMyParallelUpdateable, IMyLightingLogicSync, IMyReflectorLight, IMyReflectorLight
```
...
|Member|Description|
|---|---|
|[BlockDefinition](Sandbox.Game.Entities.MyReflectorLight@BlockDefinition)||
|[IsReflectorEnabled](Sandbox.Game.Entities.MyReflectorLight@IsReflectorEnabled)||
|[ReflectorConeMaterial](Sandbox.Game.Entities.MyReflectorLight@ReflectorConeMaterial)||
...
|[BlinkLenght](Sandbox.ModAPI.Ingame.IMyLightingBlock@BlinkLenght)|_**Obsolete:** Use BlinkLength instead._<br /><br />Obsolete<br /><br />_Inherited from [IMyLightingBlock](Sandbox.ModAPI.Ingame.IMyLightingBlock)_|
...
|[ReflectorRadius](Sandbox.ModAPI.Ingame.IMyLightingBlock@ReflectorRadius)|_**Obsolete:** Use Radius_<br /><br />Obsolete<br /><br />_Inherited from [IMyLightingBlock](Sandbox.ModAPI.Ingame.IMyLightingBlock)_|

## Constructors

|Member|Description|
|---|---|
|[MyReflectorLight()](Sandbox.Game.Entities.MyReflectorLight@.ctor)||

## Methods

|Member|Description|
|---|---|
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyReflectorLight@GetObjectBuilderCubeBlock)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyReflectorLight@Init)||
|[OnModelChange()](Sandbox.Game.Entities.MyReflectorLight@OnModelChange)||
|[UpdateAfterSimulationParallel()](Sandbox.Game.Entities.MyReflectorLight@UpdateAfterSimulationParallel)||
|[UpdateVisual()](Sandbox.Game.Entities.MyReflectorLight@UpdateVisual)||
...
**Inheritance:**   MyLightingBlock <sub>prohibited</sub>
...
* IMyLightingLogicSync <sub>prohibited</sub>  
