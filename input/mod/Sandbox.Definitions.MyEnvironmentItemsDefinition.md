...
|Member|Description|
|---|---|
|[Channel](Sandbox.Definitions.MyEnvironmentItemsDefinition@Channel)||
|[ItemDefinitionCount](Sandbox.Definitions.MyEnvironmentItemsDefinition@ItemDefinitionCount)||
|[ItemDefinitionType](Sandbox.Definitions.MyEnvironmentItemsDefinition@ItemDefinitionType)||
|[ItemSize](Sandbox.Definitions.MyEnvironmentItemsDefinition@ItemSize)||
|[Material](Sandbox.Definitions.MyEnvironmentItemsDefinition@Material)||
|[MaxViewDistance](Sandbox.Definitions.MyEnvironmentItemsDefinition@MaxViewDistance)||
|[SectorSize](Sandbox.Definitions.MyEnvironmentItemsDefinition@SectorSize)||
...
|Member|Description|
|---|---|
|[MyEnvironmentItemsDefinition()](Sandbox.Definitions.MyEnvironmentItemsDefinition@.ctor)||
...
|Member|Description|
|---|---|
|[AddItemDefinition(MyStringHash, float, bool)](Sandbox.Definitions.MyEnvironmentItemsDefinition@AddItemDefinition)||
|[ContainsItemDefinition(MyStringHash)](Sandbox.Definitions.MyEnvironmentItemsDefinition@ContainsItemDefinition)||
|[ContainsItemDefinition(MyDefinitionId)](Sandbox.Definitions.MyEnvironmentItemsDefinition@ContainsItemDefinition)||
|[ContainsItemDefinition(MyEnvironmentItemDefinition)](Sandbox.Definitions.MyEnvironmentItemsDefinition@ContainsItemDefinition)||
|[GetItemDefinition(MyStringHash)](Sandbox.Definitions.MyEnvironmentItemsDefinition@GetItemDefinition)||
|[GetItemDefinition(int)](Sandbox.Definitions.MyEnvironmentItemsDefinition@GetItemDefinition)||
|[GetRandomItemDefinition()](Sandbox.Definitions.MyEnvironmentItemsDefinition@GetRandomItemDefinition)||
|[GetRandomItemDefinition(MyRandom)](Sandbox.Definitions.MyEnvironmentItemsDefinition@GetRandomItemDefinition)||
|[RecomputeFrequencies()](Sandbox.Definitions.MyEnvironmentItemsDefinition@RecomputeFrequencies)||
