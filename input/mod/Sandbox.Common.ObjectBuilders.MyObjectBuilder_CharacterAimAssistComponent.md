...
```csharp
public class MyObjectBuilder_CharacterAimAssistComponent: MyObjectBuilder_ComponentBase
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_CharacterAimAssistComponent()](Sandbox.Common.ObjectBuilders.MyObjectBuilder_CharacterAimAssistComponent@.ctor)||
