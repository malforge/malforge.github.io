...
```csharp
public abstract class MySyncComponentBase: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](VRage.Game.Components.MySyncComponentBase@ComponentTypeDebugString)||
