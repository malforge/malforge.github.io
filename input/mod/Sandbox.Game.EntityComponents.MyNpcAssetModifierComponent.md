...
```csharp
public class MyNpcAssetModifierComponent: MyUpdatingEntityComponent, IMyComponentBase, IMyEntityComponentBase, IMyEventProxy, IMyEventOwner, IMyUpdatingEntityComponent
```
...
|Member|Description|
|---|---|
|[AssetModifiers](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@AssetModifiers)||
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@ComponentTypeDebugString)||
...
|Member|Description|
|---|---|
|[MyNpcAssetModifierComponent()](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@.ctor)||
...
|Member|Description|
|---|---|
|[Deserialize(MyObjectBuilder_ComponentBase)](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@Deserialize)||
|[IsSerialized()](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@IsSerialized)||
|[OnAddedToContainer()](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@OnAddedToContainer)||
|[OnAddedToScene()](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@OnAddedToScene)||
|[Serialize(bool)](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@Serialize)||
|[TryAddAssetModifier(string)](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@TryAddAssetModifier)||
|[TryAddAssetModifier(MyDefinitionId)](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@TryAddAssetModifier)||
|[UpdateOnceBeforeFrame()](Sandbox.Game.EntityComponents.MyNpcAssetModifierComponent@UpdateOnceBeforeFrame)||
