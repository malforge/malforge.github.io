...
```csharp
public abstract class MyEventProxyEntityComponent: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase, IMyEventProxy, IMyEventOwner
```
...
|Member|Description|
|---|---|
|[SyncType](Sandbox.Game.EntityComponents.MyEventProxyEntityComponent@SyncType)||
...
|Member|Description|
|---|---|
|[AttachSyncToEntity](Sandbox.Game.EntityComponents.MyEventProxyEntityComponent@AttachSyncToEntity)||
...
|Member|Description|
|---|---|
|[MyEventProxyEntityComponent()](Sandbox.Game.EntityComponents.MyEventProxyEntityComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[OnBeforeRemovedFromContainer()](Sandbox.Game.EntityComponents.MyEventProxyEntityComponent@OnBeforeRemovedFromContainer)||
