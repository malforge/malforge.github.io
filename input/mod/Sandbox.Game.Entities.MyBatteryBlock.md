...
|Member|Description|
|---|---|
|[CurrentOutputRatioChanged](Sandbox.Game.Entities.MyBatteryBlock@CurrentOutputRatioChanged)||
...
|[StoredPowerRatioChanged](Sandbox.ModAPI.IMyStoredPowerRatio@StoredPowerRatioChanged)|Event when stored power ratio is changed (block, old value, new value)<br /><br />_Inherited from [IMyStoredPowerRatio](Sandbox.ModAPI.IMyStoredPowerRatio)_|
...
|Member|Description|
|---|---|
|[BlockDefinition](Sandbox.Game.Entities.MyBatteryBlock@BlockDefinition)||
|[ChargeMode](Sandbox.Game.Entities.MyBatteryBlock@ChargeMode)||
|[CurrentInput](Sandbox.Game.Entities.MyBatteryBlock@CurrentInput)||
|[CurrentOutput](Sandbox.Game.Entities.MyBatteryBlock@CurrentOutput)||
|[CurrentOutputRatio](Sandbox.Game.Entities.MyBatteryBlock@CurrentOutputRatio)||
|[CurrentStoredPower](Sandbox.Game.Entities.MyBatteryBlock@CurrentStoredPower)||
|[HasCapacityRemaining](Sandbox.Game.Entities.MyBatteryBlock@HasCapacityRemaining)||
|[IsCharging](Sandbox.Game.Entities.MyBatteryBlock@IsCharging)||
|[MaxInput](Sandbox.Game.Entities.MyBatteryBlock@MaxInput)||
|[MaxOutput](Sandbox.Game.Entities.MyBatteryBlock@MaxOutput)||
|[MaxStoredPower](Sandbox.Game.Entities.MyBatteryBlock@MaxStoredPower)||
|[OnlyDischarge](Sandbox.Game.Entities.MyBatteryBlock@OnlyDischarge)||
|[OnlyRecharge](Sandbox.Game.Entities.MyBatteryBlock@OnlyRecharge)||
|[SemiautoEnabled](Sandbox.Game.Entities.MyBatteryBlock@SemiautoEnabled)||
|[SourceComp](Sandbox.Game.Entities.MyBatteryBlock@SourceComp)||
|[StoredPowerRatio](Sandbox.Game.Entities.MyBatteryBlock@StoredPowerRatio)||
|[TimeRemaining](Sandbox.Game.Entities.MyBatteryBlock@TimeRemaining)||
...
|[ChargeMode](Sandbox.ModAPI.Ingame.IMyBatteryBlock@ChargeMode)|Gets or sets charge mode<br /><br />_Inherited from [IMyBatteryBlock](Sandbox.ModAPI.Ingame.IMyBatteryBlock)_|
...
|[CurrentInput](Sandbox.ModAPI.Ingame.IMyBatteryBlock@CurrentInput)|Gets current power input<br /><br />_Inherited from [IMyBatteryBlock](Sandbox.ModAPI.Ingame.IMyBatteryBlock)_|
...
|[CurrentStoredPower](Sandbox.ModAPI.Ingame.IMyBatteryBlock@CurrentStoredPower)|Gets current stored power<br /><br />_Inherited from [IMyBatteryBlock](Sandbox.ModAPI.Ingame.IMyBatteryBlock)_|
...
|[HasCapacityRemaining](Sandbox.ModAPI.Ingame.IMyBatteryBlock@HasCapacityRemaining)|Gets whether this battery block has any remaining capacity<br /><br />_Inherited from [IMyBatteryBlock](Sandbox.ModAPI.Ingame.IMyBatteryBlock)_|
...
|[IsCharging](Sandbox.ModAPI.Ingame.IMyBatteryBlock@IsCharging)|Gets whether this battery block is charging<br /><br />_Inherited from [IMyBatteryBlock](Sandbox.ModAPI.Ingame.IMyBatteryBlock)_|
...
|[MaxInput](Sandbox.ModAPI.Ingame.IMyBatteryBlock@MaxInput)|Gets current maximum power input<br /><br />_Inherited from [IMyBatteryBlock](Sandbox.ModAPI.Ingame.IMyBatteryBlock)_|
...
|[MaxStoredPower](Sandbox.ModAPI.Ingame.IMyBatteryBlock@MaxStoredPower)|Gets maximum stored power<br /><br />_Inherited from [IMyBatteryBlock](Sandbox.ModAPI.Ingame.IMyBatteryBlock)_|
...
|[StoredPowerRatio](Sandbox.ModAPI.IMyStoredPowerRatio@StoredPowerRatio)|Gets stored power ration (current / max)<br /><br />_Inherited from [IMyStoredPowerRatio](Sandbox.ModAPI.IMyStoredPowerRatio)_|
...
|[OnlyDischarge](Sandbox.ModAPI.Ingame.IMyBatteryBlock@OnlyDischarge)|_**Obsolete:** Use ChargeMode instead_<br /><br />Obsolete<br /><br />_Inherited from [IMyBatteryBlock](Sandbox.ModAPI.Ingame.IMyBatteryBlock)_|
|[OnlyRecharge](Sandbox.ModAPI.Ingame.IMyBatteryBlock@OnlyRecharge)|_**Obsolete:** Use ChargeMode instead_<br /><br />Obsolete<br /><br />_Inherited from [IMyBatteryBlock](Sandbox.ModAPI.Ingame.IMyBatteryBlock)_|
|[SemiautoEnabled](Sandbox.ModAPI.Ingame.IMyBatteryBlock@SemiautoEnabled)|_**Obsolete:** Semi-auto is no longer a valid mode, if you want to check for Auto instead, use ChargeMode_<br /><br />Obsolete<br /><br />_Inherited from [IMyBatteryBlock](Sandbox.ModAPI.Ingame.IMyBatteryBlock)_|

## Constructors

|Member|Description|
|---|---|
|[MyBatteryBlock()](Sandbox.Game.Entities.MyBatteryBlock@.ctor)||

## Methods

|Member|Description|
|---|---|
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyBatteryBlock@GetObjectBuilderCubeBlock)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyBatteryBlock@Init)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyBatteryBlock@OnAddedToScene)||
|[OnModelChange()](Sandbox.Game.Entities.MyBatteryBlock@OnModelChange)||
|[SetEmissiveStateDamaged()](Sandbox.Game.Entities.MyBatteryBlock@SetEmissiveStateDamaged)||
|[SetEmissiveStateDisabled()](Sandbox.Game.Entities.MyBatteryBlock@SetEmissiveStateDisabled)||
|[SetEmissiveStateWorking()](Sandbox.Game.Entities.MyBatteryBlock@SetEmissiveStateWorking)||
|[UpdateAfterSimulation100()](Sandbox.Game.Entities.MyBatteryBlock@UpdateAfterSimulation100)||
|[UpdateVisual()](Sandbox.Game.Entities.MyBatteryBlock@UpdateVisual)||
