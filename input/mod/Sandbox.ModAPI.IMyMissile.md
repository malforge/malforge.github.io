...
|Member|Description|
|---|---|
|[AmmoDefinition](Sandbox.ModAPI.IMyMissile@AmmoDefinition)|Gets MyAmmoDefinition of missile|
|[AmmoMagazineDefinition](Sandbox.ModAPI.IMyMissile@AmmoMagazineDefinition)|Gets MyAmmoMagazineDefinition of missile|
|[CollidedEntity](Sandbox.ModAPI.IMyMissile@CollidedEntity)|Gets collided entity, on missile hit. You should get this value only on [OnMissileCollided](Sandbox.ModAPI.IMyMissiles@OnMissileCollided) event|
|[CollisionNormal](Sandbox.ModAPI.IMyMissile@CollisionNormal)|Gets collision normal, on missile hit. You should get this value only on [OnMissileCollided](Sandbox.ModAPI.IMyMissiles@OnMissileCollided) event|
|[CollisionPoint](Sandbox.ModAPI.IMyMissile@CollisionPoint)|Gets collision point, on missile hit. You should get this value only on [OnMissileCollided](Sandbox.ModAPI.IMyMissiles@OnMissileCollided) event|
|[ExplosionDamage](Sandbox.ModAPI.IMyMissile@ExplosionDamage)|Gets or sets explosion damage for missile|
|[ExplosionType](Sandbox.ModAPI.IMyMissile@ExplosionType)|Gets or sets explosion type of missile (changes effect of explosion)|
|[HealthPool](Sandbox.ModAPI.IMyMissile@HealthPool)|Gets or sets health of missile. While it is more than 0, it is damaging blocks that it collide with, each time subtracting amount of damage dealt. When left health is less or equal 0, missile explodes (if it hitted anything and [ShouldExplode](Sandbox.ModAPI.IMyMissile@ShouldExplode) is true).|
|[LauncherId](Sandbox.ModAPI.IMyMissile@LauncherId)|Character EntityId or block EntityId that shoots|
|[LinearVelocity](Sandbox.ModAPI.IMyMissile@LinearVelocity)|Gets or sets velocity of missile|
|[MaxTrajectory](Sandbox.ModAPI.IMyMissile@MaxTrajectory)|Gets or sets max travel trajectory|
|[Origin](Sandbox.ModAPI.IMyMissile@Origin)|Get or sets initial position of missile|
|[Owner](Sandbox.ModAPI.IMyMissile@Owner)|Character EntityId or block EntityId that shoots|
|[ParticleEffect](Sandbox.ModAPI.IMyMissile@ParticleEffect)|Gets or sets missile trail particle effect|
|[ShouldExplode](Sandbox.ModAPI.IMyMissile@ShouldExplode)|Gets or sets if missile should explode on hit|
|[WeaponDefinition](Sandbox.ModAPI.IMyMissile@WeaponDefinition)|Gets MyWeaponDefinition of missile|
...
|Member|Description|
|---|---|
|[Destroy()](Sandbox.ModAPI.IMyMissile@Destroy)|Can't be called in Missiles.OnMissileMoved, MissileCollided|
|[IsCharacterIdFriendly(long)](Sandbox.ModAPI.IMyMissile@IsCharacterIdFriendly)|Returns whether player is friendly to missile|
