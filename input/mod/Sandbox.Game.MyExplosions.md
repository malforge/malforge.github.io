...
|Member|Description|
|---|---|
|[static OnExplosion](Sandbox.Game.MyExplosions@OnExplosion)||

## Properties

|Member|Description|
|---|---|
|[Dependencies](Sandbox.Game.MyExplosions@Dependencies)||
...
|Member|Description|
|---|---|
|[MyExplosions()](Sandbox.Game.MyExplosions@.ctor)||
...
|Member|Description|
|---|---|
|[static AddExplosion(ref MyExplosionInfo, bool)](Sandbox.Game.MyExplosions@AddExplosion)|Add new explosion to the list, but caller needs to start it using Start() method|
|[static ShouldUseMassScaleForEntity(MyEntity)](Sandbox.Game.MyExplosions@ShouldUseMassScaleForEntity)||
|[Draw()](Sandbox.Game.MyExplosions@Draw)||
|[LoadData()](Sandbox.Game.MyExplosions@LoadData)||
|[UpdateBeforeSimulation()](Sandbox.Game.MyExplosions@UpdateBeforeSimulation)||
