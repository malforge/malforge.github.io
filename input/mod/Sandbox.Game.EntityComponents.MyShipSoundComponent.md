...
```csharp
public class MyShipSoundComponent: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[ShipHasChanged](Sandbox.Game.EntityComponents.MyShipSoundComponent@ShipHasChanged)||
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyShipSoundComponent@ComponentTypeDebugString)||
...
|Member|Description|
|---|---|
|[MyShipSoundComponent()](Sandbox.Game.EntityComponents.MyShipSoundComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[static ActualizeGroups()](Sandbox.Game.EntityComponents.MyShipSoundComponent@ActualizeGroups)||
|[static AddShipSounds(MyShipSoundsDefinition)](Sandbox.Game.EntityComponents.MyShipSoundComponent@AddShipSounds)||
|[static ClearShipSounds()](Sandbox.Game.EntityComponents.MyShipSoundComponent@ClearShipSounds)||
|[static SetDefinition(MyShipSoundSystemDefinition)](Sandbox.Game.EntityComponents.MyShipSoundComponent@SetDefinition)||
|[DestroyComponent()](Sandbox.Game.EntityComponents.MyShipSoundComponent@DestroyComponent)||
|[InitComponent(MyCubeGrid)](Sandbox.Game.EntityComponents.MyShipSoundComponent@InitComponent)||
|[Update()](Sandbox.Game.EntityComponents.MyShipSoundComponent@Update)||
|[Update100()](Sandbox.Game.EntityComponents.MyShipSoundComponent@Update100)||
