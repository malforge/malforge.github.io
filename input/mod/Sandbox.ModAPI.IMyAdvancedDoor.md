...
```csharp
public interface IMyAdvancedDoor: IMyDoor, IMyFunctionalBlock, IMyFunctionalBlock, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyTerminalBlock, IMyCubeBlock, IMyEntity, IMyDoor, IMyAdvancedDoor
```
