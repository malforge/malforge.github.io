...
```csharp
public class MyObjectBuilder_SalvageServiceComponent: MyObjectBuilder_ComponentBase
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_SalvageServiceComponent()](Sandbox.Common.ObjectBuilders.MyObjectBuilder_SalvageServiceComponent@.ctor)||
