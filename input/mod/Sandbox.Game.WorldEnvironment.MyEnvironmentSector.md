...
|Member|Description|
|---|---|
|[OnContactPoint](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@OnContactPoint)||
|[OnLodCommit](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@OnLodCommit)||
|[OnPhysicsClose](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@OnPhysicsClose)||
|[OnPhysicsCommit](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@OnPhysicsCommit)||
...
|Member|Description|
|---|---|
|[Bounds](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@Bounds)||
|[DataView](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@DataView)||
|[EnvironmentDefinition](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@EnvironmentDefinition)||
|[HasParallelWorkInProgress](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@HasParallelWorkInProgress)||
|[HasParallelWorkPending](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@HasParallelWorkPending)||
|[HasPhysics](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@HasPhysics)||
|[HasSerialWorkPending](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@HasSerialWorkPending)||
|[IsClosed](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@IsClosed)||
|[IsLoaded](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@IsLoaded)||
|[IsPendingLodSwitch](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@IsPendingLodSwitch)||
|[IsPendingPhysicsToggle](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@IsPendingPhysicsToggle)||
|[IsPinned](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@IsPinned)||
|[LodLevel](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@LodLevel)||
|[Owner](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@Owner)||
|[SectorCenter](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@SectorCenter)||
|[SectorId](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@SectorId)||
...
|Member|Description|
|---|---|
|[MyEnvironmentSector()](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@.ctor)||
...
|[BuildInstanceBuffers(int)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@BuildInstanceBuffers)||
|[CancelParallel()](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@CancelParallel)||
|[Close()](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@Close)||
|[DebugDraw()](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@DebugDraw)||
|[DoParallelWork()](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@DoParallelWork)||
|[DoSerialWork()](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@DoSerialWork)||
|[EnableItem(int, bool)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@EnableItem)||
|[EnablePhysics(bool)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@EnablePhysics)||
|[ForceLoadDataView()](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@ForceLoadDataView)||
|[GetDefinition(int)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@GetDefinition)||
|[GetEnvironmentalItemDefinitionId(int)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@GetEnvironmentalItemDefinitionId)||
|[GetHashCode()](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@GetHashCode)||
|[GetItemDefinitionId(int)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@GetItemDefinitionId)||
|[GetItemFromShapeKey(uint)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@GetItemFromShapeKey)||
|[GetItemInfo(int, out uint, out int)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@GetItemInfo)||
|[GetModelIndex(int)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@GetModelIndex)||
|[GetModule<T>()](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@GetModule{T})||
|[GetModule(Type)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@GetModule)||
|[GetModuleForDefinition<T>(MyRuntimeEnvironmentItemInfo)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@GetModuleForDefinition{T})||
|[Init(IMyEnvironmentOwner, ref MyEnvironmentSectorParameters)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@Init)||
|[OnItemChange(int, short)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@OnItemChange)||
|[OnItemsChange(int, List<int>, short)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@OnItemsChange)||
|[RaiseItemEvent<TModule>(TModule, int, bool)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@RaiseItemEvent{TModule})||
|[RaiseItemEvent<TModule, TArgument>(TModule, int, TArgument, bool)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@RaiseItemEvent{TModule,TArgument})||
|[RaiseOnLodCommitEvent(int)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@RaiseOnLodCommitEvent)||
|[RaiseOnPhysicsCommitEvent(bool)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@RaiseOnPhysicsCommitEvent)||
|[ReEnableSectorItem(int)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@ReEnableSectorItem)||
|[SetLod(int)](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@SetLod)||
|[ToString()](Sandbox.Game.WorldEnvironment.MyEnvironmentSector@ToString)||
