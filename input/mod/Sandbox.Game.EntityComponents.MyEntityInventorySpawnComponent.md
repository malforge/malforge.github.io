...
```csharp
public class MyEntityInventorySpawnComponent: MyEntityComponentBase, IMyComponentBase, IMyEntityComponentBase
```
...
|Member|Description|
|---|---|
|[ComponentTypeDebugString](Sandbox.Game.EntityComponents.MyEntityInventorySpawnComponent@ComponentTypeDebugString)||
...
|Member|Description|
|---|---|
|[MyEntityInventorySpawnComponent()](Sandbox.Game.EntityComponents.MyEntityInventorySpawnComponent@.ctor)||

## Methods

|Member|Description|
|---|---|
|[Init(MyComponentDefinitionBase)](Sandbox.Game.EntityComponents.MyEntityInventorySpawnComponent@Init)||
|[IsSerialized()](Sandbox.Game.EntityComponents.MyEntityInventorySpawnComponent@IsSerialized)||
|[OnAddedToContainer()](Sandbox.Game.EntityComponents.MyEntityInventorySpawnComponent@OnAddedToContainer)||
|[OnBeforeRemovedFromContainer()](Sandbox.Game.EntityComponents.MyEntityInventorySpawnComponent@OnBeforeRemovedFromContainer)||
|[SpawnInventoryContainer(bool)](Sandbox.Game.EntityComponents.MyEntityInventorySpawnComponent@SpawnInventoryContainer)||
