...
|Member|Description|
|---|---|
|[BlockDefinition](Sandbox.Game.Entities.MyConveyorSorter@BlockDefinition)||
|[ConveyorEndpoint](Sandbox.Game.Entities.MyConveyorSorter@ConveyorEndpoint)||
|[DrainAll](Sandbox.Game.Entities.MyConveyorSorter@DrainAll)||
|[IsWhitelist](Sandbox.Game.Entities.MyConveyorSorter@IsWhitelist)||
...
|[DrainAll](Sandbox.ModAPI.Ingame.IMyConveyorSorter@DrainAll)|Determines whether the sorter should drain any inventories connected to it and push them to the other side - as long as the items passes the filtering as defined by the filter list ( [GetFilterList(List<MyInventoryItemFilter>)](Sandbox.ModAPI.Ingame.IMyConveyorSorter@GetFilterList) ) and [Mode](Sandbox.ModAPI.Ingame.IMyConveyorSorter@Mode) .<br /><br />_Inherited from [IMyConveyorSorter](Sandbox.ModAPI.Ingame.IMyConveyorSorter)_|
...
|[Mode](Sandbox.ModAPI.Ingame.IMyConveyorSorter@Mode)|Determines the current mode of this sorter.<br /><br />_Inherited from [IMyConveyorSorter](Sandbox.ModAPI.Ingame.IMyConveyorSorter)_|
...
|Member|Description|
|---|---|
|[MyConveyorSorter()](Sandbox.Game.Entities.MyConveyorSorter@.ctor)||

## Methods

|Member|Description|
|---|---|
|[AllowSelfPulling()](Sandbox.Game.Entities.MyConveyorSorter@AllowSelfPulling)||
|[ChangeBlWl(bool)](Sandbox.Game.Entities.MyConveyorSorter@ChangeBlWl)||
|[GetObjectBuilderCubeBlock(bool)](Sandbox.Game.Entities.MyConveyorSorter@GetObjectBuilderCubeBlock)||
|[GetPullInformation()](Sandbox.Game.Entities.MyConveyorSorter@GetPullInformation)||
|[GetPushInformation()](Sandbox.Game.Entities.MyConveyorSorter@GetPushInformation)||
|[Init(MyObjectBuilder_CubeBlock, MyCubeGrid)](Sandbox.Game.Entities.MyConveyorSorter@Init)||
|[InitializeConveyorEndpoint()](Sandbox.Game.Entities.MyConveyorSorter@InitializeConveyorEndpoint)||
|[IsAllowed(MyDefinitionId)](Sandbox.Game.Entities.MyConveyorSorter@IsAllowed)||
|[OnAddedToScene(object)](Sandbox.Game.Entities.MyConveyorSorter@OnAddedToScene)||
|[UpdateAfterSimulation10()](Sandbox.Game.Entities.MyConveyorSorter@UpdateAfterSimulation10)||
|[AddItem(MyInventoryItemFilter)](Sandbox.ModAPI.Ingame.IMyConveyorSorter@AddItem)|Adds a single item to the filter list. See [SetFilter(MyConveyorSorterMode, List<MyInventoryItemFilter>)](Sandbox.ModAPI.Ingame.IMyConveyorSorter@SetFilter) to change the filter mode and/or fill the entire list in one go.<br /><br />_Inherited from [IMyConveyorSorter](Sandbox.ModAPI.Ingame.IMyConveyorSorter)_|
...
|[GetFilterList(List<MyInventoryItemFilter>)](Sandbox.ModAPI.Ingame.IMyConveyorSorter@GetFilterList)|Gets the items currently being allowed through or rejected, depending on the [Mode](Sandbox.ModAPI.Ingame.IMyConveyorSorter@Mode) .<br /><br />_Inherited from [IMyConveyorSorter](Sandbox.ModAPI.Ingame.IMyConveyorSorter)_|
...
|[IsAllowed(MyDefinitionId)](Sandbox.ModAPI.Ingame.IMyConveyorSorter@IsAllowed)|Determines whether a given item type is allowed go through the sorter, depending on the filter list ( [GetFilterList(List<MyInventoryItemFilter>)](Sandbox.ModAPI.Ingame.IMyConveyorSorter@GetFilterList) ) and [Mode](Sandbox.ModAPI.Ingame.IMyConveyorSorter@Mode) .<br /><br />_Inherited from [IMyConveyorSorter](Sandbox.ModAPI.Ingame.IMyConveyorSorter)_|
...
|[SetFilter(MyConveyorSorterMode, List<MyInventoryItemFilter>)](Sandbox.ModAPI.Ingame.IMyConveyorSorter@SetFilter)|Changes the sorter to desired mode and filters the provided items. You can pass in`null`to empty the list.<br /><br />_Inherited from [IMyConveyorSorter](Sandbox.ModAPI.Ingame.IMyConveyorSorter)_|
