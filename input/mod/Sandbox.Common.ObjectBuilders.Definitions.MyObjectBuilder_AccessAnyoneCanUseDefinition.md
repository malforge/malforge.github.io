...
```csharp
public class MyObjectBuilder_AccessAnyoneCanUseDefinition: MyObjectBuilder_ComponentDefinitionBase
```
...
|Member|Description|
|---|---|
|[MyObjectBuilder_AccessAnyoneCanUseDefinition()](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_AccessAnyoneCanUseDefinition@.ctor)||
