...
|Member|Description|
|---|---|
|[Connections](Sandbox.ModAPI.Ingame.IMyUpgradeModule@Connections)|Gets number of blocks this block is connected to|
|[UpgradeCount](Sandbox.ModAPI.Ingame.IMyUpgradeModule@UpgradeCount)|Gets number of upgrade effects this block has|
...
|Member|Description|
|---|---|
|[FillUpgradeList(List<MyUpgradeModuleInfo>)](Sandbox.ModAPI.Ingame.IMyUpgradeModule@FillUpgradeList)|Gets list of upgrades from this block, see [MyUpgradeModuleInfo](VRage.Game.ObjectBuilders.Definitions.MyUpgradeModuleInfo) for details|
...
|[GetUpgradeList(out List<MyUpgradeModuleInfo>)](Sandbox.ModAPI.Ingame.IMyUpgradeModule@GetUpgradeList)|_**Obsolete:** Use FillUpgradeList without the out parameter instead._<br /><br />Obsolete|
