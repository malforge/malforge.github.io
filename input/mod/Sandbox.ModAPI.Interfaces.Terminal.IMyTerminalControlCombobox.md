...
|Member|Description|
|---|---|
|[ComboBoxContent](Sandbox.ModAPI.Interfaces.Terminal.IMyTerminalControlCombobox@ComboBoxContent)|This allows you to set the content of the combo box itself.|
...
* [IMyTerminalValueControl<long>](Sandbox.ModAPI.Interfaces.Terminal.IMyTerminalValueControl{Int64})  
