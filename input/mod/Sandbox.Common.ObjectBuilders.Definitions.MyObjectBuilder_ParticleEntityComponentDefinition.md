...
|Member|Description|
|---|---|
|[DummyName](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ParticleEntityComponentDefinition@DummyName)||
|[ParticleEffectName](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ParticleEntityComponentDefinition@ParticleEffectName)||
|[RemoveExistingComponentOnNewInsert](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ParticleEntityComponentDefinition@RemoveExistingComponentOnNewInsert)||
|[ShowParticleEffectInPreview](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ParticleEntityComponentDefinition@ShowParticleEffectInPreview)||
|[ShowWhenBlockNotFunctional](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ParticleEntityComponentDefinition@ShowWhenBlockNotFunctional)||
|[ShowWhenBlockNotPowered](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ParticleEntityComponentDefinition@ShowWhenBlockNotPowered)||
|[ShowWhenBlockNotWorking](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ParticleEntityComponentDefinition@ShowWhenBlockNotWorking)||
...
|Member|Description|
|---|---|
|[MyObjectBuilder_ParticleEntityComponentDefinition()](Sandbox.Common.ObjectBuilders.Definitions.MyObjectBuilder_ParticleEntityComponentDefinition@.ctor)||
