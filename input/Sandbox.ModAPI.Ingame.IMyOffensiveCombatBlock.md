...
|Member|Description|
|---|---|
|[LastScan](Sandbox.ModAPI.Ingame.IMyOffensiveCombatBlock@LastScan)|Gets how many milliseconds was from last scan, or -1 if block hasn't scanned yet|
|[SearchEnemyComponent](Sandbox.ModAPI.Ingame.IMyOffensiveCombatBlock@SearchEnemyComponent)|Gets SearchEnemyComponent|
|[SelectedAttackPattern](Sandbox.ModAPI.Ingame.IMyOffensiveCombatBlock@SelectedAttackPattern)|Gets or sets current attack pattern|
|[TargetPriority](Sandbox.ModAPI.Ingame.IMyOffensiveCombatBlock@TargetPriority)|Gets or sets current target priority|
|[UpdateTargetInterval](Sandbox.ModAPI.Ingame.IMyOffensiveCombatBlock@UpdateTargetInterval)|Gets or sets scan interval in seconds|
...
|Member|Description|
|---|---|
|[GetAttackPatternIds<T>(T)](Sandbox.ModAPI.Ingame.IMyOffensiveCombatBlock@GetAttackPatternIds{T})||
|[TryGetSelectedAttackPattern(out IMyAttackPatternComponent)](Sandbox.ModAPI.Ingame.IMyOffensiveCombatBlock@TryGetSelectedAttackPattern)|Gets current attack pattern|
|[TryGetSelectedAttackPattern(long, out IMyAttackPatternComponent)](Sandbox.ModAPI.Ingame.IMyOffensiveCombatBlock@TryGetSelectedAttackPattern)|Gets current attack pattern|
...
**Type Definitions:**  
* MyObjectBuilder_OffensiveCombatBlock/LargeOffensiveCombat  
* MyObjectBuilder_OffensiveCombatBlock/SmallOffensiveCombat
