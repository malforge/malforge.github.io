...
namespace DocGen.Services
{
    public class Sprites
    {
        ...
        static void Load(string fileName, List<SpriteDef> icons, string path)
        {
        ...
        static void LoadIconFromPhysicalItem(XElement definition, List<SpriteDef> icons, string path)
        {
        ...
        static void LoadIconsFromLCDTextureDefinition(XElement definition, List<SpriteDef> icons, string path)
        {
            var idElement = definition.Element("Id");
            if (idElement == null)
                return;
        ...
        static void LoadIconsFromDefinition(XElement definition, List<SpriteDef> icons, string path)
        {
        ...
        static bool IsGZipFile(FileStream stream)
        {
        ...
        static bool IsXmlTypeAttribute(XAttribute arg)
        {
            return arg.Name.NamespaceName == "http://www.w3.org/2001/XMLSchema-instance" && arg.Name.LocalName == "type";
        }

        async Task GenerateAsync(string path, string output)
        {
