...
{
    internal class XmlDocWriteContext
    {
        ...
        public KeyValuePair<string, string> ResolveReference(string uri)
        {
            return _resolveReferenceFunc?.Invoke(uri) ?? new KeyValuePair<string, string>();
        }
    }
}