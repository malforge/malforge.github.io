...
{
    [Flags]
    internal enum ApiEntryStringFlags : long
    {
        None = 0,
        ...
        DefaultValues =     0x0001000000000000,

        Default = ReturnValue | Namespaces | DeclaringTypes | ParameterNames | GenericParameters | Instantiation | DefaultValues,
