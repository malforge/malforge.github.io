...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function performSearch(query) {
        ...
        if (!searchQuery) {
            resultsDiv.innerHTML = '<div class="search-results-container"><div class="search-no-results">Enter search term after prefix</div></div><div class="search-feedback">SEARCH_FEEDBACK_PLACEHOLDER</div>';
            resultsDiv.style.display = 'grid';
            return;
        }
    ...
    function displayResults() {
        if (currentMatches.length === 0) {
            resultsDiv.innerHTML = '<div class="search-results-container"><div class="search-no-results">No results found</div></div><div class="search-feedback">SEARCH_FEEDBACK_PLACEHOLDER</div>';
            resultsDiv.style.display = 'grid';
            return;
        }
        ...
        html += `<div class="search-feedback">SEARCH_FEEDBACK_PLACEHOLDER</div>`;
